...
public final class IsoWater {
   ...
   public void waterProjection() {
      ...
      GL11.glOrtho((double)var2.getOffX(), (double)(var2.getOffX() + (float)var2.OffscreenWidth), (double)(var2.getOffY() + (float)var2.OffscreenHeight), (double)var2.getOffY(), -1.0, 1.0);
   }
