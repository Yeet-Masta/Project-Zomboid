...
public class IsoRegionsLogger {
   ...
   private IsoRegionLog getLog() {
      IsoRegionLog var1 = (IsoRegionLog)this.pool.poll();
      if (var1 == null) {
   ...
   protected void update() {
      if (Core.bDebug) {
         for(IsoRegionLog var1 = (IsoRegionLog)this.loggerQueue.poll(); var1 != null; var1 = (IsoRegionLog)this.loggerQueue.poll()) {
            if (this.logs.size() >= 100) {
               IsoRegionLog var2 = (IsoRegionLog)this.logs.remove(0);
               var2.col = null;
