...
public final class WorldStreamer {
   ...
   private void sendRequests() throws IOException {
      if (!this.chunkRequests1.isEmpty() && (!this.requestingLargeArea || this.pendingRequests1.size() <= 20)) {
         ...
         for(int var5 = this.chunkRequests1.size() - 1; var5 >= 0; --var5) {
            ...
            ChunkRequest var7 = WorldStreamer.ChunkRequest.alloc();
            var7.chunk = var6;
   ...
   public void updateMain() {
      ...
      ChunkRequest var2;
      ChunkRequest var3;
      for(var2 = (ChunkRequest)this.waitingToSendQ.poll(); var2 != null; var2 = (ChunkRequest)this.waitingToSendQ.poll()) {
      ...
      if (!this.tempRequests.isEmpty()) {
         ...
         var5.putInt(this.tempRequests.size());

         for(var6 = 0; var6 < this.tempRequests.size(); ++var6) {
            var4 = (ChunkRequest)this.tempRequests.get(var6);
            var5.putInt(var4.requestNumber);
            var5.putInt(var4.chunk.wx);
            var5.putInt(var4.chunk.wy);
            var5.putLong(var4.crc);
      ...
      for(var2 = (ChunkRequest)this.waitingToCancelQ.poll(); var2 != null; var2 = (ChunkRequest)this.waitingToCancelQ.poll()) {
         this.tempRequests.add(var2);
      }
   ...
   private void loadReceivedChunks() throws DataFormatException, IOException {
      ...
      for(int var4 = 0; var4 < this.pendingRequests1.size(); ++var4) {
         ChunkRequest var5 = (ChunkRequest)this.pendingRequests1.get(var4);
   ...
   private void cancelOutOfBoundsRequests() {
      if (!this.requestingLargeArea) {
         for(int var1 = 0; var1 < this.pendingRequests1.size(); ++var1) {
            ChunkRequest var2 = (ChunkRequest)this.pendingRequests1.get(var1);
   ...
   public void receiveChunkPart(ByteBuffer var1) {
      for(ChunkRequest var2 = (ChunkRequest)this.sentRequests.poll(); var2 != null; var2 = (ChunkRequest)this.sentRequests.poll()) {
      ...
      for(int var8 = 0; var8 < this.pendingRequests.size(); ++var8) {
         ChunkRequest var9 = (ChunkRequest)this.pendingRequests.get(var8);
         if ((var9.flagsWS & 1) != 0) {
   ...
   public void receiveNotRequired(ByteBuffer var1) {
      ...
      for(int var3 = 0; var3 < var8; ++var3) {
         ...
         for(int var6 = 0; var6 < this.pendingRequests.size(); ++var6) {
            ChunkRequest var7 = (ChunkRequest)this.pendingRequests.get(var6);
            if ((var7.flagsWS & 1) != 0) {
   ...
   private void compare(ChunkRequest var1, ByteBuffer var2, File var3) throws IOException {
      ...
      long var7 = this.crc32.getValue();
      DebugLog.log("downloaded crc=" + var7 + " on-disk crc=" + ChunkChecksum.getChecksumIfExists(var1.chunk.wx, var1.chunk.wy));
      var5.LoadFromDisk();
   ...
   private void compareErosion(IsoChunk var1, IsoChunk var2) {
      if (var1.getErosionData().init != var2.getErosionData().init) {
         boolean var3 = var1.getErosionData().init;
         DebugLog.log("init " + var3 + " != " + var2.getErosionData().init);
      }

      int var5;
      if (var1.getErosionData().eTickStamp != var2.getErosionData().eTickStamp) {
         var5 = var1.getErosionData().eTickStamp;
         DebugLog.log("eTickStamp " + var5 + " != " + var2.getErosionData().eTickStamp);
      }
      ...
      if (var1.getErosionData().epoch != var2.getErosionData().epoch) {
         var5 = var1.getErosionData().epoch;
         DebugLog.log("epoch " + var5 + " != " + var2.getErosionData().epoch);
      }

      if (var1.getErosionData().soil != var2.getErosionData().soil) {
         var5 = var1.getErosionData().soil;
         DebugLog.log("soil " + var5 + " != " + var2.getErosionData().soil);
      }
            ...
            if (this.bb1.compareTo(this.bb2) != 0) {
               ...
               if (this.bb1.limit() == this.bb2.limit()) {
                  ...
                  for(var5 = 0; var5 < var1.getErosionData().regions.size(); ++var5) {
                     if (((ErosionCategory.Data)var1.getErosionData().regions.get(var5)).dispSeason != ((ErosionCategory.Data)var2.getErosionData().regions.get(var5)).dispSeason) {
                        int var6 = ((ErosionCategory.Data)var1.getErosionData().regions.get(var5)).dispSeason;
                        DebugLog.log("season1=" + var6 + " season2=" + ((ErosionCategory.Data)var2.getErosionData().regions.get(var5)).dispSeason);
                        var3 = false;
                     }
                  }
               }
               ...
               if (var1.getObjects().size() == var2.getObjects().size()) {
                  for(var5 = 0; var5 < var1.getObjects().size(); ++var5) {
                     var10 = (IsoObject)var1.getObjects().get(var5);
                     IsoObject var8 = (IsoObject)var2.getObjects().get(var5);
                     this.bb1.clear();
                     var10.save(this.bb1);
                     this.bb1.flip();
                     this.bb2.clear();
                     ...
                     if (this.bb1.compareTo(this.bb2) != 0) {
                        ...
                        DebugLog.log("  1: " + var7 + " " + var10.getName() + " " + (var10.sprite == null ? "no sprite" : var10.sprite.name));
                        var7 = var8.getClass().getName();
                        DebugLog.log("  2: " + var7 + " " + var8.getName() + " " + (var8.sprite == null ? "no sprite" : var8.sprite.name));
                     }
                  }
               } else {
                  for(var5 = 0; var5 < var1.getObjects().size(); ++var5) {
                     var10 = (IsoObject)var1.getObjects().get(var5);
                     var7 = var10.getClass().getName();
                     DebugLog.log("  " + var7 + " " + var10.getName() + " " + (var10.sprite == null ? "no sprite" : var10.sprite.name));
                  }
               }
            }
   ...
   private static final class ChunkRequest {
      ...
      static ChunkRequest alloc() {
         return pool.isEmpty() ? new ChunkRequest() : (ChunkRequest)pool.pop();
      }

      static void release(ChunkRequest var0) {
         var0.chunk = null;
   ...
   private static class ChunkComparator implements Comparator {
      ...
      public int compare(IsoChunk var1, IsoChunk var2) {
         ...
         return Float.compare(var4, var3);
      }
   }
}
