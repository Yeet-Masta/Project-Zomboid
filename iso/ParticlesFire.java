...
public final class ParticlesFire extends Particles {
   ...
   public ParticlesFire() {
      ...
      this.zones.add(new Zone(10, var1 - 30.0F, var2 - 10.0F, var1 + 30.0F, var2 + 10.0F));
      this.zones.add(new Zone(10, var1 - 200.0F, var2, 50.0F));
      this.zones.add(new Zone(40, var1 + 200.0F, var2, 100.0F));
      this.zones.add(new Zone(60, var1 - 150.0F, var2 - 300.0F, var1 + 250.0F, var2 - 300.0F, 10.0F));
      this.zones.add(new Zone(10, var1 - 350.0F, var2 - 200.0F, var1 - 350.0F, var2 - 300.0F, 10.0F));
   }

   private void ParticlesProcess() {
      for(int var1 = 0; var1 < this.zones.size(); ++var1) {
         Zone var2 = (Zone)this.zones.get(var1);
   ...
   public class Zone {
      ...
      Zone(int var2, float var3, float var4, float var5) {
         ...
         this.y0 = var4;
         this.r = var5;
         this.area = (float)(Math.PI * (double)var5 * (double)var5);
      ...
      Zone(int var2, float var3, float var4, float var5, float var6, float var7) {
         ...
         this.r = var7;
         this.area = (float)((double)this.r * Math.sqrt(Math.pow((double)(var3 - var5), 2.0) + Math.pow((double)(var4 - var6), 2.0)));
         this.vortices = (float)this.intensity * 0.3F;
         this.vorticeSpeed = 0.5F;
         this.temperature = 2000.0F;
         this.centerX = (this.x0 + this.x1) * 0.5F;
   ...
   static enum ZoneType {
      ...
      // $FF: synthetic method
      private static ZoneType[] $values() {
         return new ZoneType[]{Rectangle, Circle, Line};
      }
   }
