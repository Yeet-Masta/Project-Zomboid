...
public class IsoGridOcclusionData {
   ...
   public ArrayList getBuildingsCouldBeOccluders(OcclusionFilter var1) {
      if (this._objectEpoch != _ObjectEpoch) {
         if (this._bSoftInitialized) {
            this.Reset();
         }
   ...
   public static enum OcclusionFilter {
      ...
      // $FF: synthetic method
      private static OcclusionFilter[] $values() {
         return new OcclusionFilter[]{Left, Right, All};
      }
   }
   ...
   public static enum OccluderType {
      ...
      // $FF: synthetic method
      private static OccluderType[] $values() {
         return new OccluderType[]{Unknown, NotFull, Full};
      }
   }
}
