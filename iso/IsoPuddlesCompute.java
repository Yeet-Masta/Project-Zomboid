...
public final class IsoPuddlesCompute {
   ...
   private static float FuncHash(Vector3f var0) {
      ...
      return fract((float)(Math.sin((double)var1.x * 2.1 + 1.1) + Math.sin((double)var1.y * 2.5 + 1.5)));
   }
   ...
   private static float PerlinNoise(Vector3f var0) {
      if (hd_quality) {
         ...
         var0.mul(3.0F);
         var1 = (float)((double)var1 + 0.25 * (double)FuncNoise(var0));
         var0.mul(3.0F);
         var1 = (float)((double)var1 + 0.125 * (double)FuncNoise(var0));
         var1 = (float)((double)var1 * Math.min(1.0, 2.0 * (double)FuncNoise(allocVector3f(var0).mul(0.02F)) * Math.min(1.0, 1.0 * (double)FuncNoise(allocVector3f(var0).mul(0.1F)))));
         return var1;
      } else {
   ...
   private static float getPuddles(Vector2f var0) {
      ...
      var4 = (float)((double)var4 + (double)var1 * Math.sin(((double)var0.x * 1.0 + (double)var0.y * 2.0) * 3.1414999961853027 * 1.0) * Math.cos(((double)var0.x * 1.0 + (double)var0.y * 2.0) * 3.1414999961853027 * 1.0) * 2.0);
      var4 = (float)((double)var4 + (double)var2 * Math.sin(((double)var0.x * 1.0 - (double)var0.y * 2.0) * 3.1414999961853027 * 1.0) * Math.cos(((double)var0.x * 1.0 - (double)var0.y * 2.0) * 3.1414999961853027 * 1.0) * 2.0);
      var4 = (float)((double)var4 + (double)var3 * 0.3);
      ...
      if (!Core.getInstance().getUseShaders()) {
         ...
         if (Core.getInstance().getPerfPuddles() > 0 && var0.z > 0) {
            ...
            if (puddlesSize <= 0.0F) {
               ...
               float var10 = (float)Math.pow((double)getPuddles(var9), 2.0);
               float var11 = (float)Math.min(Math.pow((double)var10, 0.3), 1.0) + var10;
