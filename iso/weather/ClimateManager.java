...
public class ClimateManager {
   ...
   private void setup() {
      ...
      for(var1 = 0; var1 < this.climateColors.length; ++var1) {
         this.climateColors[var1] = new ClimateColor();
      }

      for(var1 = 0; var1 < this.climateBooleans.length; ++var1) {
         this.climateBooleans[var1] = new ClimateBool();
      }
   ...
   public float getWindForceMovement(IsoGameCharacter var1, float var2) {
      if (var1.square != null && !var1.square.isInARoom()) {
         ...
         if ((double)var3 > 6.283185307179586) {
         ...
         if ((double)var3 > Math.PI) {
            var3 = (float)(Math.PI - ((double)var3 - Math.PI));
         }

         var3 = (float)((double)var3 / Math.PI);
         return var3;
      } else {
         return 0.0F;
      }
   ...
   private void updateWindTick() {
      if (!GameServer.bServer) {
         ...
         windNoiseOffset += (4.0E-4 + 6.0E-4 * (double)var1) * (double)GameTime.getInstance().getMultiplier();
         windNoiseBase = SimplexNoise.noise(0.0, windNoiseOffset);
         windNoiseFinal = windNoiseBase;
         if (windNoiseFinal > 0.0) {
            windNoiseFinal *= 0.04 + 0.1 * (double)var1;
         } else {
            windNoiseFinal *= 0.04 + 0.1 * (double)var1 + (double)(0.05F * var1 * var1);
         }
   ...
   private void updateValues() {
      ...
      if (!THE_DESCENDING_FOG) {
         ...
         if (PerformanceSettings.FogQuality == 2) {
            ClimateFloat var10000 = this.fogIntensity;
   ...
   public static float clerp(float var0, float var1, float var2) {
      float var3 = (float)(1.0 - Math.cos((double)var0 * Math.PI)) / 2.0F;
   ...
   public static class AirFront {
      ...
      public void copyFrom(AirFront var1) {
         this.days = var1.days;
   ...
   public static class ClimateFloat {
      ...
      public ClimateFloat init(int var1, String var2) {
         this.ID = var1;
         this.name = var2;
         return this;
      }
   ...
   public static class ClimateColor {
      ...
      public ClimateColor init(int var1, String var2) {
         this.ID = var1;
         this.name = var2;
         return this;
      }
   ...
   public static class ClimateBool {
      ...
      public ClimateBool init(int var1, String var2) {
         this.ID = var1;
         this.name = var2;
         return this;
      }
   ...
   public static enum ClimateNetAuth {
      ...
      // $FF: synthetic method
      private static ClimateNetAuth[] $values() {
         return new ClimateNetAuth[]{Denied, ClientOnly, ServerOnly, ClientAndServer};
      }
   }
