...
public class ClimMngrDebug extends ClimateManager {
   ...
   private RunInfo calculateTotal() {
      ...
      while(var9.hasNext()) {
         RunInfo var10 = (RunInfo)var9.next();
   ...
   private void saveData() {
      if (this.runs.size() > 0) {
         try {
            ...
            while(var1.hasNext()) {
               RunInfo var2 = (RunInfo)var1.next();
               var2.calculate();
            }
   ...
   private double round(double var1) {
      return (double)Math.round(var1 * 100.0) / 100.0;
   }
   ...
   private void writeData() throws Exception {
      ...
      while(var2.hasNext()) {
         RunInfo var3 = (RunInfo)var2.next();
         ++var1;
   ...
   private void writePatterns() throws Exception {
      ...
      while(var9.hasNext()) {
         ...
         for(Iterator var11 = var10.records.iterator(); var11.hasNext(); ++var14) {
            RecordInfo var12 = (RecordInfo)var11.next();
            int var13 = (int)Math.ceil(var12.durationHours / 24.0);
            String var6;
   ...
   private class RunInfo {
      ...
      public RecordInfo addRecord(double var1) {
         RecordInfo var3 = ClimMngrDebug.this.new RecordInfo();
      ...
      public RecordInfo addRecord(int var1, double var2, float var4, boolean var5, boolean var6, boolean var7) {
         RecordInfo var8 = ClimMngrDebug.this.new RecordInfo();
      ...
      public void calculate() {
         ...
         while(var10.hasNext()) {
            RecordInfo var11 = (RecordInfo)var10.next();
