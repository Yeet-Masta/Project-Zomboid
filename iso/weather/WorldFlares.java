...
public class WorldFlares {
   ...
   public static Flare getFlare(int var0) {
      return (Flare)flares.get(var0);
   }

   public static Flare getFlareID(int var0) {
      for(int var1 = 0; var1 < flares.size(); ++var1) {
         if (((Flare)flares.get(var1)).id == var0) {
            return (Flare)flares.get(var1);
         }
      }
   ...
   public static void update() {
      for(int var0 = flares.size() - 1; var0 >= 0; --var0) {
         ((Flare)flares.get(var0)).update();
         if (!((Flare)flares.get(var0)).hasLaunched) {
            flares.remove(var0);
         }
      }
   ...
   public static void applyFlaresForPlayer(RenderSettings.PlayerRenderSettings var0, int var1, IsoPlayer var2) {
      for(int var3 = flares.size() - 1; var3 >= 0; --var3) {
         if (((Flare)flares.get(var3)).hasLaunched) {
            ((Flare)flares.get(var3)).applyFlare(var0, var1, var2);
         }
      }
   ...
   public static void debugRender() {
      if (DEBUG_DRAW) {
         ...
         for(int var1 = flares.size() - 1; var1 >= 0; --var1) {
            Flare var2 = (Flare)flares.get(var1);
            float var3 = 0.5F;

            for(double var4 = 0.0; var4 < 6.283185307179586; var4 += 0.15707963267948966) {
               DrawIsoLine(var2.x + (float)var2.range * (float)Math.cos(var4), var2.y + (float)var2.range * (float)Math.sin(var4), var2.x + (float)var2.range * (float)Math.cos(var4 + 0.15707963267948966), var2.y + (float)var2.range * (float)Math.sin(var4 + 0.15707963267948966), var0, 1.0F, 1.0F, 1.0F, 0.25F, 1);
               DrawIsoLine(var2.x + var3 * (float)Math.cos(var4), var2.y + var3 * (float)Math.sin(var4), var2.x + var3 * (float)Math.cos(var4 + 0.15707963267948966), var2.y + var3 * (float)Math.sin(var4 + 0.15707963267948966), var0, 1.0F, 1.0F, 1.0F, 0.25F, 1);
            }
         }
