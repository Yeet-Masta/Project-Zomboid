...
public class ThunderStorm {
   ...
   public ThunderStorm(ClimateManager var1) {
      ...
      for(var2 = 0; var2 < this.clouds.length; ++var2) {
         this.clouds[var2] = new ThunderCloud();
      }

      for(var2 = 0; var2 < 4; ++var2) {
         this.lightningInfos[var2] = new PlayerLightningInfo();
      }
   ...
   public static int getMapDiagonal() {
      ...
      int var2 = (int)Math.sqrt(Math.pow((double)var0, 2.0) + Math.pow((double)var1, 2.0));
      var2 /= 2;
      return var2;
   }
   ...
   public void update(double var1) {
      ...
      if (GameClient.bClient || !GameServer.bServer) {
         for(var3 = 0; var3 < 4; ++var3) {
            PlayerLightningInfo var16 = this.lightningInfos[var3];
         ...
         for(int var20 = 0; var20 < this.events.length; ++var20) {
            ThunderEvent var21 = this.events[var20];
            if (var21.isRunning) {
   ...
   private static enum LightningState {
      ...
      // $FF: synthetic method
      private static LightningState[] $values() {
         return new LightningState[]{Idle, ApplyLightning};
      }
   }
}
