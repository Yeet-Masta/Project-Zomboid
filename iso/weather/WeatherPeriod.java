...
public class WeatherPeriod {
   ...
   public boolean hasTropical() {
      for(int var1 = 0; var1 < this.weatherStages.size(); ++var1) {
         if (((WeatherStage)this.weatherStages.get(var1)).getStageID() == 8) {
            return true;
         }
      }
   ...
   public boolean hasStorm() {
      for(int var1 = 0; var1 < this.weatherStages.size(); ++var1) {
         if (((WeatherStage)this.weatherStages.get(var1)).getStageID() == 3) {
            return true;
         }
      }
   ...
   public boolean hasBlizzard() {
      for(int var1 = 0; var1 < this.weatherStages.size(); ++var1) {
         if (((WeatherStage)this.weatherStages.get(var1)).getStageID() == 7) {
            return true;
         }
      }
   ...
   public boolean hasHeavyRain() {
      for(int var1 = 0; var1 < this.weatherStages.size(); ++var1) {
         if (((WeatherStage)this.weatherStages.get(var1)).getStageID() == 2) {
            return true;
         }
      }
   ...
   public WeatherStage getStageForWorldAge(double var1) {
      for(int var3 = 0; var3 < this.weatherStages.size(); ++var3) {
         if (var1 >= ((WeatherStage)this.weatherStages.get(var3)).getStageStart() && var1 < ((WeatherStage)this.weatherStages.get(var3)).getStageEnd()) {
            return (WeatherStage)this.weatherStages.get(var3);
         }
      }
   ...
   public boolean endCreateModdedPeriod() {
      if (!this.endInit()) {
         ...
         for(int var1 = 0; var1 < this.weatherStages.size(); ++var1) {
            this.duration += ((WeatherStage)this.weatherStages.get(var1)).stageDuration;
         }

         this.print("WeatherPeriod: Duration = " + this.duration + ".");
         this.weatherStageIndex = 0;
         this.currentStage = ((WeatherStage)this.weatherStages.get(this.weatherStageIndex)).startStage(this.startTime);
   ...
   private void linkWeatherStages() {
      ...
      WeatherStage var2 = null;
      WeatherStage var3 = null;

      for(int var4 = 0; var4 < this.weatherStages.size(); ++var4) {
         var3 = (WeatherStage)this.weatherStages.get(var4);
         var2 = null;
         if (var4 + 1 < this.weatherStages.size()) {
            var2 = (WeatherStage)this.weatherStages.get(var4 + 1);
         }
   ...
   private void clearCurrentWeatherStages() {
      ...
      while(var1.hasNext()) {
         WeatherStage var2 = (WeatherStage)var1.next();
         var2.reset();
   ...
   private void createSingleStage(int var1, float var2) {
      ...
      for(int var3 = 0; var3 < this.weatherStages.size(); ++var3) {
         this.duration += ((WeatherStage)this.weatherStages.get(var3)).stageDuration;
      }
   ...
   private void createWeatherPattern() {
      ...
      if (this.frontCache.getType() == 1) {
         ...
         for(int var17 = 0; var17 < var10.size(); ++var17) {
            var16 = (float)((double)var16 + ((WeatherStage)var10.get(var17)).getStageDuration());
         }
      ...
      for(var20 = 0; var20 < var10.size(); ++var20) {
         this.weatherStages.add((WeatherStage)var10.get(var20));
      ...
      if (((WeatherStage)this.weatherStages.get(this.weatherStages.size() - 1)).getStageID() != 9) {
      ...
      for(var20 = 0; var20 < this.weatherStages.size(); ++var20) {
         WeatherStage var10000 = (WeatherStage)this.weatherStages.get(var20);
      ...
      for(var20 = 0; var20 < this.weatherStages.size(); ++var20) {
         this.duration += ((WeatherStage)this.weatherStages.get(var20)).stageDuration;
      }
      ...
      for(int var21 = 0; var21 < this.weatherStages.size(); ++var21) {
         var22 = ((WeatherStage)this.weatherStages.get(var21)).setStageStart(var22);
      }
   ...
   public WeatherStage createAndAddModdedStage(String var1, double var2) {
      WeatherStage var4 = this.createAndAddStage(10, var2, var1);
      return var4;
   }
   ...
   private WeatherStage createStage(int var1, double var2, String var4) {
      ...
      if (!this.stagesPool.isEmpty()) {
         var5 = (WeatherStage)this.stagesPool.pop();
      } else {
         ...
         switch (this.currentStage.stageID) {
            ...
            case 2:
               ...
               if (this.currentStage.linearT < 0.1F) {
                  var1 = ClimateManager.clerp((float)((this.currentTime - this.currentStage.stageStart) / (this.currentStage.stageDuration * 0.1)), 0.0F, this.frontCache.getStrength() * 0.5F);
               } else if (this.currentStage.linearT > 0.9F) {
                  var1 = ClimateManager.clerp(1.0F - (float)((this.currentStage.stageEnd - this.currentTime) / (this.currentStage.stageDuration * 0.1)), this.frontCache.getStrength() * 0.5F, 0.0F);
               }
      ...
      if (!GameClient.bClient && !this.isDummy) {
         if (this.isRunning && this.currentStage != null && this.weatherStageIndex >= 0 && this.weatherStages.size() != 0) {
            if (this.currentTime > this.currentStage.stageEnd) {
               ...
               this.currentStage = (WeatherStage)this.weatherStages.get(this.weatherStageIndex);
            ...
            this.totalProgress = (float)(this.currentTime - ((WeatherStage)this.weatherStages.get(0)).stageStart) / (float)this.duration;
      ...
      if (GameClient.bClient && !GameServer.bServer) {
         ...
         if (this.isRunning) {
            ...
            for(int var2 = 0; var2 < this.weatherStages.size(); ++var2) {
               WeatherStage var3 = (WeatherStage)this.weatherStages.get(var2);
      ...
      if (var3 == 1) {
         ...
         if (this.isRunning) {
            ...
            for(var5 = 0; var5 < var4; ++var5) {
               ...
               WeatherStage var9 = !this.stagesPool.isEmpty() ? (WeatherStage)this.stagesPool.pop() : new WeatherStage();
               var9.stageID = var6;
            ...
            for(var5 = 0; var5 < this.weatherStages.size(); ++var5) {
               this.duration += ((WeatherStage)this.weatherStages.get(var5)).stageDuration;
            }
   ...
   public static class WeatherStage {
      ...
      protected WeatherStage startStage(double var1) {
      ...
      protected WeatherStage setStageDuration(double var1) {
      ...
      protected WeatherStage overrideStageDuration(double var1) {
         this.stageDuration = var1;
         return this;
      }
      ...
      private WeatherStage updateT(double var1) {
   ...
   public static enum StrLerpVal {
      ...
      public static StrLerpVal fromValue(int var0) {
         if (WeatherPeriod.cache.containsKey(var0)) {
            return (StrLerpVal)WeatherPeriod.cache.get(var0);
         } else {
      ...
      // $FF: synthetic method
      private static StrLerpVal[] $values() {
         return new StrLerpVal[]{Entry, Target, NextTarget, None};
      }
   }
}
