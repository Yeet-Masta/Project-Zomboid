...
public final class WorldMarkers {
   ...
   public void init() {
      if (!GameServer.bServer) {
         ...
         for(var1 = 0; var1 < this.homingPoints.length; ++var1) {
            this.homingPoints[var1] = new PlayerHomingPointList();
         }

         for(var1 = 0; var1 < this.directionArrows.length; ++var1) {
            this.directionArrows[var1] = new DirectionArrowList();
         }
   ...
   public PlayerHomingPoint addPlayerHomingPoint(IsoPlayer var1, int var2, int var3, String var4, float var5, float var6, float var7, float var8, boolean var9, int var10) {
      if (GameServer.bServer) {
         return null;
      } else {
   ...
   public DirectionArrow addDirectionArrow(IsoPlayer var1, int var2, int var3, int var4, String var5, float var6, float var7, float var8, float var9) {
      if (GameServer.bServer) {
         ...
         DirectionArrow var10 = new DirectionArrow(var1.PlayerIndex);
      ...
      for(int var2 = 0; var2 < this.directionArrows.length; ++var2) {
         if (var2 == var1 && this.directionArrows[var2].size() != 0) {
            ...
            for(var3 = 0; var3 < this.directionArrows[var2].size(); ++var3) {
               DirectionArrow var4 = (DirectionArrow)this.directionArrows[var2].get(var3);
      ...
      if (IsoCamera.frameState.playerIndex == 0) {
         if (this.gridSquareMarkers.size() != 0) {
            ...
            for(var1 = this.gridSquareMarkers.size() - 1; var1 >= 0; --var1) {
               if (((GridSquareMarker)this.gridSquareMarkers.get(var1)).isRemoved()) {
                  this.gridSquareMarkers.remove(var1);
               }
            }

            for(var1 = 0; var1 < this.gridSquareMarkers.size(); ++var1) {
               GridSquareMarker var2 = (GridSquareMarker)this.gridSquareMarkers.get(var1);
               if (var2.alphaInc) {
   ...
   public boolean removeGridSquareMarker(int var1) {
      for(int var2 = this.gridSquareMarkers.size() - 1; var2 >= 0; --var2) {
         if (((GridSquareMarker)this.gridSquareMarkers.get(var2)).getID() == var1) {
            ((GridSquareMarker)this.gridSquareMarkers.get(var2)).remove();
   ...
   public GridSquareMarker getGridSquareMarker(int var1) {
      for(int var2 = 0; var2 < this.gridSquareMarkers.size(); ++var2) {
         if (((GridSquareMarker)this.gridSquareMarkers.get(var2)).getID() == var1) {
            return (GridSquareMarker)this.gridSquareMarkers.get(var2);
         }
      }
   ...
   public GridSquareMarker addGridSquareMarker(String var1, String var2, IsoGridSquare var3, float var4, float var5, float var6, boolean var7, float var8, float var9, float var10, float var11) {
      if (GameServer.bServer) {
         return null;
      } else {
      ...
      if (!GameServer.bServer && this.gridSquareMarkers.size() != 0) {
         ...
         if (var4 != null) {
            for(int var5 = 0; var5 < this.gridSquareMarkers.size(); ++var5) {
               GridSquareMarker var6 = (GridSquareMarker)this.gridSquareMarkers.get(var5);
   ...
   private static class Point {
      ...
      public Point set(float var1, float var2) {
         this.x = var1;
         this.y = var2;
         return this;
      }
