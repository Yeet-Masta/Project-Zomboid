...
public final class MapCollisionData {
   ...
   public void updateMain() {
      if (!this.bClient) {
         for(PathTask var1 = (PathTask)this.pathResultQueue.poll(); var1 != null; var1 = (PathTask)this.pathResultQueue.poll()) {
   ...
   private final class MCDThread extends Thread {
      ...
      private void runInner() {
         ...
         synchronized(MapCollisionData.this.renderLock) {
            PathTask var2 = (PathTask)MapCollisionData.this.pathTaskQueue.poll();
            ...
            while(true) {
               ...
               var2.execute();
               var2.release();
               var2 = (PathTask)MapCollisionData.this.pathTaskQueue.poll();
            }
         }
