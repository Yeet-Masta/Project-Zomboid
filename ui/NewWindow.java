...
public class NewWindow extends UIElement {
   ...
   public void render() {
      ...
      this.DrawTextureScaled(this.dialogRight, this.getWidth() - (double)this.dialogRight.getWidth(), (double)var3, (double)this.dialogLeft.getWidth(), this.getHeight() - (double)this.titleLeft.getHeight() - (double)this.dialogBottomLeft.getHeight(), (double)var1);
      var3 = (int)((double)var3 + (this.getHeight() - (double)this.titleLeft.getHeight() - (double)this.dialogBottomLeft.getHeight()));
      this.DrawTextureScaled(this.dialogBottomMiddle, (double)this.dialogBottomLeft.getWidth(), (double)var3, this.getWidth() - (double)(this.dialogBottomLeft.getWidth() * 2), (double)this.dialogBottomMiddle.getHeight(), (double)var1);
      this.DrawTexture(this.dialogBottomLeft, (double)var2, (double)var3, (double)var1);
      this.DrawTexture(this.dialogBottomRight, this.getWidth() - (double)this.dialogBottomRight.getWidth(), (double)var3, (double)var1);
      super.render();
   }
