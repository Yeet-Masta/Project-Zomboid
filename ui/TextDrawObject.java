...
public final class TextDrawObject {
   ...
   public String getUnformatted() {
      if (!(this.scrambleVal > 0.0F)) {
         ...
         while(var2.hasNext()) {
            DrawLine var3 = (DrawLine)var2.next();
            Iterator var4 = var3.elements.iterator();

            while(var4.hasNext()) {
               DrawElement var5 = (DrawElement)var4.next();
               if (!var5.isImage) {
   ...
   private void addText(String var1) {
      ...
      DrawLine var10000 = this.currentLine;
   ...
   public void calculateDimensions() {
      ...
      for(var2 = 0; var2 < this.lines.size(); ++var2) {
         var3 = (DrawLine)this.lines.get(var2);
         var3.h = 0;
         var3.w = 0;
   ...
   public void AddBatchedDraw(TextDrawHorizontal var1, double var2, double var4, double var6, double var8, double var10, double var12, boolean var14) {
      if (!GameServer.bServer) {
         RenderBatch var15 = renderBatchPool.isEmpty() ? new RenderBatch() : (RenderBatch)renderBatchPool.pop();
   ...
   public static void RenderBatch(int var0) {
      if (renderBatch.size() > 0) {
         for(int var1 = 0; var1 < renderBatch.size(); ++var1) {
            RenderBatch var2 = (RenderBatch)renderBatch.get(var1);
   ...
   public void DrawRaw(TextDrawHorizontal var1, double var2, double var4, float var6, float var7, float var8, float var9, boolean var10) {
      ...
      if (!(var11 - (double)var19 >= (double)var17) && !(var11 + (double)this.getWidth() + (double)var19 <= 0.0) && !(var4 - (double)var19 >= (double)var18) && !(var4 + (double)this.getHeight() + (double)var19 <= 0.0)) {
         ...
         for(int var21 = 0; var21 < this.lines.size(); ++var21) {
            DrawLine var22 = (DrawLine)this.lines.get(var21);
            var11 = var2;
            if (var1 == TextDrawHorizontal.Center) {
            ...
            for(int var23 = 0; var23 < var22.elements.size(); ++var23) {
               ...
               if (var24.isImage && var24.tex != null) {
                  if (var10 && var24.isTextImage) {
                     SpriteRenderer.instance.renderi(var24.tex, (int)(var11 - 1.0), (int)(var13 + var15 - 1.0), var24.w, var24.h, this.outlineR, this.outlineG, this.outlineB, var20, (Consumer)null);
                     SpriteRenderer.instance.renderi(var24.tex, (int)(var11 + 1.0), (int)(var13 + var15 + 1.0), var24.w, var24.h, this.outlineR, this.outlineG, this.outlineB, var20, (Consumer)null);
                     SpriteRenderer.instance.renderi(var24.tex, (int)(var11 - 1.0), (int)(var13 + var15 + 1.0), var24.w, var24.h, this.outlineR, this.outlineG, this.outlineB, var20, (Consumer)null);
                     SpriteRenderer.instance.renderi(var24.tex, (int)(var11 + 1.0), (int)(var13 + var15 - 1.0), var24.w, var24.h, this.outlineR, this.outlineG, this.outlineB, var20, (Consumer)null);
                  }
                  ...
                  if (var10) {
                     var24.font.drawString((float)(var11 - 1.0), (float)(var13 + var15 - 1.0), this.elemText, this.outlineR, this.outlineG, this.outlineB, var20);
                     var24.font.drawString((float)(var11 + 1.0), (float)(var13 + var15 + 1.0), this.elemText, this.outlineR, this.outlineG, this.outlineB, var20);
                     var24.font.drawString((float)(var11 - 1.0), (float)(var13 + var15 + 1.0), this.elemText, this.outlineR, this.outlineG, this.outlineB, var20);
                     var24.font.drawString((float)(var11 + 1.0), (float)(var13 + var15 - 1.0), this.elemText, this.outlineR, this.outlineG, this.outlineB, var20);
                  }
                  ...
                  if (var10) {
                     this.defaultFont.drawString((float)(var11 - 1.0), (float)(var13 + var15 - 1.0), this.elemText, this.outlineR, this.outlineG, this.outlineB, var20);
                     this.defaultFont.drawString((float)(var11 + 1.0), (float)(var13 + var15 + 1.0), this.elemText, this.outlineR, this.outlineG, this.outlineB, var20);
                     this.defaultFont.drawString((float)(var11 - 1.0), (float)(var13 + var15 + 1.0), this.elemText, this.outlineR, this.outlineG, this.outlineB, var20);
                     this.defaultFont.drawString((float)(var11 + 1.0), (float)(var13 + var15 - 1.0), this.elemText, this.outlineR, this.outlineG, this.outlineB, var20);
                  }
   ...
   private static final class DrawElement {
      ...
      private DrawElement softclone() {
         DrawElement var1 = new DrawElement();
         if (this.useColor) {
            var1.R = this.R;
            var1.G = this.G;
            var1.B = this.B;
