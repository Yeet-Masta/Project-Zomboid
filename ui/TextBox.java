   ...
   public void render() {
      if (this.isVisible()) {
         ...
         for(Iterator var2 = this.Lines.iterator(); var2.hasNext(); var1 += TextManager.instance.MeasureStringY(this.font, (String)this.Lines.get(0))) {
            ...
            if (this.Centred) {
               TextManager.instance.DrawStringCentre(this.font, (double)this.getAbsoluteX().intValue() + this.getWidth() / 2.0, (double)(this.getAbsoluteY().intValue() + var1), var3, 1.0, 1.0, 1.0, 1.0);
            } else {
               TextManager.instance.DrawString(this.font, (double)this.getAbsoluteX().intValue(), (double)(this.getAbsoluteY().intValue() + var1), var3, 1.0, 1.0, 1.0, 1.0);
            }
         }
