         ...
         if (this.Parent == null || this.Parent.maxDrawHeight == -1 || !((double)this.Parent.maxDrawHeight <= this.y)) {
            ...
            if (this.Lines.size() > 0) {
               ...
               for(var9 = this.TopLineIndex; var9 < this.TopLineIndex + this.NumVisibleLines && var9 < this.Lines.size(); ++var9) {
                  if (this.Lines.get(var9) != null) {
                     ...
                     if (this.Centred) {
                        TextManager.instance.DrawStringCentre(this.font, (double)this.getAbsoluteX().intValue() + this.getWidth() / 2.0 + (double)var2, (double)(this.getAbsoluteY().intValue() + var8), var10, (double)this.textColor.r, (double)this.textColor.g, (double)this.textColor.b, 1.0);
                     } else {
                        TextManager.instance.DrawString(this.font, (double)(-this.XOffset + this.getAbsoluteX().intValue() + var2), (double)(this.getAbsoluteY().intValue() + var8), var10, (double)this.textColor.r, (double)this.textColor.g, (double)this.textColor.b, 1.0);
                     }
            ...
            if (this.DoingTextEntry) {
               ...
               if (this.BlinkState) {
                  ...
                  this.DrawTextureScaledCol(Texture.getWhite(), (double)(-this.XOffset + var2 + var9), (double)(var2 + this.CursorLine * var1), 1.0, (double)var1, this.TextEntryCursorColour);
               }
