...
public class UIElement {
   ...
   public void DrawTextureScaledCol(Texture var1, double var2, double var4, double var6, double var8, double var10, double var12, double var14, double var16) {
      ...
      if (this.isVisible()) {
         ...
         if (!((double)var22 + var8 < 0.0) && var22 <= 4096) {
   ...
   public void DrawUVSliceTexture(Texture var1, double var2, double var4, double var6, double var8, Color var10, double var11, double var13, double var15, double var17) {
      if (this.isVisible()) {
         ...
         var23 = (double)((float)((int)(var23 * 1000.0)) / 1000.0F);
         var27 = (double)((float)((int)(var27 * 1000.0)) / 1000.0F);
         var25 = (double)((float)((int)(var25 * 1000.0)) / 1000.0F);
         var29 = (double)((float)((int)(var29 * 1000.0)) / 1000.0F);
   ...
   public Boolean isPointOver(double var1, double var3) {
      if (!this.isVisible()) {
         ...
         if (!(var6 < 0.0) && !(var6 >= this.getWidth()) && !(var8 < 0.0) && !(var8 >= (double)var5)) {
            if (this.Parent == null) {
               ...
               for(int var10 = this.Parent.Controls.size() - 1; var10 >= 0; --var10) {
                  ...
                  if (var11.isVisible()) {
                     ...
                     if (var6 >= 0.0 && var6 < var11.getWidth() && var8 >= 0.0 && var8 < (double)var5) {
                        return Boolean.FALSE;
                     }
                  }
               }
