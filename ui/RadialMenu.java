...
public final class RadialMenu extends UIElement {
   ...
   public void render() {
      if (this.isVisible()) {
         ...
         if (!this.slices.isEmpty()) {
            ...
            Slice var7 = this.getSlice(var41);
            ...
            for(int var9 = 0; var9 < this.slices.size(); ++var9) {
               ...
               for(int var11 = 0; var11 < var43; ++var11) {
                  ...
                  var18 = Math.toRadians((double)(var42 + (float)var9 * var40 + (float)(var11 + 1) * var40 / (float)var43) - (var11 == var43 - 1 ? (double)var5 / 1.5 : 0.0));
               ...
               Texture var44 = ((Slice)this.slices.get(var9)).texture;
               if (var44 != null) {
   ...
   private void formatTextInsideCircle(String var1) {
      ...
      if (var5 > 1) {
         ...
         this.DrawTextCentre(var2, var1, (double)(this.width / 2.0F), (double)(this.height / 2.0F - (float)(var4 / 2)), 1.0, 1.0, 1.0, 1.0);
      }
   ...
   private Slice getSlice(int var1) {
      return var1 >= 0 && var1 < this.slices.size() ? (Slice)this.slices.get(var1) : null;
   }
   ...
   public int getSliceIndexFromMouse(int var1, int var2) {
      ...
      double var5 = Math.sqrt(Math.pow((double)((float)var1 - var3), 2.0) + Math.pow((double)((float)var2 - var4), 2.0));
      if (!(var5 > (double)this.outerRadius) && !(var5 < (double)this.innerRadius)) {
         double var7 = Math.atan2((double)((float)var2 - var4), (double)((float)var1 - var3)) + Math.PI;
         double var9 = Math.toDegrees(var7);
         float var11 = 360.0F / (float)Math.max(this.slices.size(), 2);
         return var9 < (double)this.getStartAngle() ? (int)((var9 + 360.0 - (double)this.getStartAngle()) / (double)var11) : (int)((var9 - (double)this.getStartAngle()) / (double)var11);
      } else {
         return -1;
      }
   }
   ...
   public int getSliceIndexFromJoypad(int var1) {
      ...
      if (!(Math.abs(var2) > 0.3F) && !(Math.abs(var3) > 0.3F)) {
         ...
         return var6 < (double)this.getStartAngle() ? (int)((var6 + 360.0 - (double)this.getStartAngle()) / (double)var8) : (int)((var6 - (double)this.getStartAngle()) / (double)var8);
      }
   }
