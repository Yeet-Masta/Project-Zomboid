...
public class VehicleStorySpawner {
   ...
   private static final ObjectPool s_elementPool = new ObjectPool(Element::new);
   ...
   public void spawn(float var1, float var2, float var3, float var4, IElementSpawner var5) {
      for(int var6 = 0; var6 < this.m_elements.size(); ++var6) {
         Element var7 = (Element)this.m_elements.get(var6);
   ...
   public static final class Element {
      ...
      Element init(String var1, float var2, float var3, float var4, float var5, float var6) {
         this.id = var1;
