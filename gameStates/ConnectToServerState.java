...
public final class ConnectToServerState extends GameState {
   ...
   private static enum State {
      ...
      private static State[] $values() {
         return new State[]{Start, TestTCP, WorkshopInit, WorkshopQuery, WorkshopConfirm, ServerWorkshopItemScreen, WorkshopUpdate, CheckMods, Finish, Exit};
      }
   }
   ...
   private static enum WorkshopItemState {
      ...
      // $FF: synthetic method
      private static WorkshopItemState[] $values() {
         return new WorkshopItemState[]{CheckItemState, SubscribePending, DownloadPending, Ready, Fail};
      }
   }
}
