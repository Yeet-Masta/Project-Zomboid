...
public final class ServerDisconnectState extends GameState {
   ...
   public void render() {
      ...
      if (Core.getInstance().StartFrameUI()) {
         ...
         TextManager.instance.DrawStringCentre(UIFont.Medium, (double)(Core.getInstance().getScreenWidth() / 2), (double)(Core.getInstance().getScreenHeight() / 2), var5, 1.0, 1.0, 1.0, 1.0);
      }
