...
public final class MapObjects {
   ...
   private static Callback getOnNew(String var0) {
      Callback var1 = (Callback)onNew.get(var0);
      if (var1 == null) {
         ...
         for(var1 = 0; var1 < tempObjects.size(); ++var1) {
            ...
            if (var0.getObjects().contains(var2) && !(var2 instanceof IsoWorldInventoryObject) && var2 != null && var2.sprite != null) {
               ...
               if (var3 != null && !var3.isEmpty()) {
                  Callback var4 = (Callback)onNew.get(var3);
                  if (var4 != null) {
                     params[0] = var2;
   ...
   private static Callback getOnLoad(String var0) {
      Callback var1 = (Callback)onLoad.get(var0);
      if (var1 == null) {
         var1 = new Callback(var0);
      ...
      if (var0 != null && !var0.getObjects().isEmpty()) {
         ...
         for(var1 = 0; var1 < tempObjects.size(); ++var1) {
            ...
            if (var0.getObjects().contains(var2) && !(var2 instanceof IsoWorldInventoryObject) && var2 != null && var2.sprite != null) {
               String var3 = var2.sprite.name == null ? var2.spriteName : var2.sprite.name;
               if (var3 != null && !var3.isEmpty()) {
                  Callback var4 = (Callback)onLoad.get(var3);
                  if (var4 != null) {
                     params[0] = var2;
   ...
   public static void reroute(Prototype var0, LuaClosure var1) {
      ...
      while(var2.hasNext()) {
         Callback var3 = (Callback)var2.next();
