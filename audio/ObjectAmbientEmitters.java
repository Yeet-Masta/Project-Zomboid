...
public final class ObjectAmbientEmitters {
   ...
   private final ObjectPool m_objectPool = new ObjectPool(ObjectWithDistance::new);
   ...
   static enum PowerPolicy {
      ...
      // $FF: synthetic method
      private static PowerPolicy[] $values() {
         return new PowerPolicy[]{NotRequired, InteriorHydro, ExteriorOK};
      }
   }
