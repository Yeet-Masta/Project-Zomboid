...
public class ParameterVehicleHitLocation extends FMODLocalParameter {
   ...
   public static HitLocation calculateLocation(BaseVehicle var0, float var1, float var2, float var3) {
   ...
   public void setLocation(HitLocation var1) {
      this.location = var1;
   }
   ...
   public static enum HitLocation {
      ...
      // $FF: synthetic method
      private static HitLocation[] $values() {
         return new HitLocation[]{Front, Rear, Side};
      }
   }
}
