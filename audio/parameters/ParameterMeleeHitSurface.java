...
public final class ParameterMeleeHitSurface extends FMODLocalParameter {
   ...
   public static enum Material {
      ...
      private static Material[] $values() {
         return new Material[]{Default, Body, Fabric, Glass, Head, Metal, Plastic, Stone, Wood, GarageDoor, MetalDoor, MetalGate, PrisonMetalDoor, SlidingGlassDoor, WoodDoor, WoodGate, Tree};
      }
   }
}
