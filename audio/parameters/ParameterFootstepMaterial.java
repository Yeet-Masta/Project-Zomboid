...
public final class ParameterFootstepMaterial extends FMODLocalParameter {
   ...
   static enum FootstepMaterial {
      ...
      // $FF: synthetic method
      private static FootstepMaterial[] $values() {
         return new FootstepMaterial[]{Upstairs, BrokenGlass, Concrete, Grass, Gravel, Puddle, Snow, Wood, Carpet, Dirt, Sand, Ceramic, Metal};
      }
   }
}
