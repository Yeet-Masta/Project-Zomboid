...
public class VoiceDebug extends JPanel {
   ...
   protected void paintComponent(Graphics var1) {
      ...
      double var3 = ((double)this.getWidth() - 60.0) / (double)(this.scores.size() - 1);
      double var5 = ((double)this.getHeight() - 60.0) / (double)(this.scores_max - 1);
      int var7 = (int)(((double)this.getHeight() - 60.0) / 2.0);
      ...
      for(var10 = 0; var10 < this.scores.size(); var10 += var8) {
         var11 = (int)((double)var10 * var3 + 30.0);
         var12 = (int)((double)(this.scores_max - (Integer)this.scores.get(var10)) * var5 + 30.0 - (double)var7);
      ...
      double var19 = ((double)this.getWidth() - 60.0) / (double)(this.psize - 1);
      var2.setColor(LINE_CURRENT_COLOR);
      var13 = (int)((double)this.current * var19 + 30.0);
      ...
      var14 = (int)((double)this.last * var19 + 30.0);
