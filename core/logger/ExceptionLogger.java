   ...
   public static void render() {
      if (!UIManager.useUIFBO || Core.getInstance().UIRenderThisFrame) {
         ...
         if (popupFrameMS > 0L) {
            ...
            TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)(var4 + var2 / 2), (double)var5, "ERROR", 1.0, 0.0, 0.0, 1.0);
            TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)(var4 + var2 / 2), (double)(var5 + var1), var0 ? "999" : Integer.toString(exceptionCount), 0.0, 0.0, 0.0, 1.0);
