...
public class OutfitManager {
   ...
   private void unload() {
      ...
      while(var1.hasNext()) {
         ClothingItemEntry var2 = (ClothingItemEntry)var1.next();
   ...
   public ClothingItem getClothingItem(String var1) {
      ...
      if (var2 == null) {
         ...
         ClothingItemEntry var3 = (ClothingItemEntry)this.m_cachedClothingItems.get(var1);
         if (var3 == null) {
            var3 = new ClothingItemEntry();
   ...
   private void onClothingItemFileChanged(ClothingItemEntry var1) {
   ...
   public boolean isLoadingClothingItems() {
      ...
      ClothingItemEntry var2;
      do {
         if (!var1.hasNext()) {
            return false;
         }

         var2 = (ClothingItemEntry)var1.next();
