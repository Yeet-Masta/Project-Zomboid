...
public final class VertexBufferObject {
   ...
   public static enum VertexType {
      ...
      // $FF: synthetic method
      private static VertexType[] $values() {
         return new VertexType[]{VertexArray, NormalArray, ColorArray, IndexArray, TextureCoordArray, TangentArray, BlendWeightArray, BlendIndexArray};
      }
   }
   ...
   public static enum BeginMode {
      ...
      // $FF: synthetic method
      private static BeginMode[] $values() {
         return new BeginMode[]{Triangles};
      }
   }
