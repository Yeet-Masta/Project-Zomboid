...
public final class WorldItemAtlas {
   ...
   private final ObjectPool itemTextureDrawerPool = new ObjectPool(ItemTextureDrawer::new);
   private final ObjectPool weaponPartParamPool = new ObjectPool(WeaponPartParams::new);
   ...
   private static final class ItemParams {
      ...
      static enum FoodState {
         ...
         // $FF: synthetic method
         private static FoodState[] $values() {
            return new FoodState[]{Normal, Cooked, Burnt, Rotten};
         }
      }
   }
