...
public class ModelInstance {
   ...
   public static final class PlayerData {
      ...
      private static final ObjectPool pool = new ObjectPool(PlayerData::new);
   ...
   public static enum FrameLightBlendStatus {
      ...
      // $FF: synthetic method
      private static FrameLightBlendStatus[] $values() {
         return new FrameLightBlendStatus[]{In, During, Out};
      }
   }
