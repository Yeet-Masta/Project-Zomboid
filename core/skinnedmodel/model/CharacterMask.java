...
public final class CharacterMask {
   ...
   public boolean isBloodBodyPartVisible(BloodBodyPartType var1) {
      Part[] var2 = var1.getCharacterMaskParts();
   ...
   public void setPartVisible(Part var1, boolean var2) {
      if (var1.hasSubdivisions()) {
         Part[] var3 = var1.subDivisions();
   ...
   public void setPartsVisible(ArrayList var1, boolean var2) {
      for(int var3 = 0; var3 < var1.size(); ++var3) {
         ...
         Part var5 = CharacterMask.Part.fromInt(var4);
         if (var5 == null) {
   ...
   public boolean isPartVisible(Part var1) {
      if (var1 == null) {
         return false;
   ...
   public String contentsToString() {
      if (this.isAllVisible()) {
         ...
         for(int var3 = 0; var2 < CharacterMask.Part.s_leaves.length; ++var2) {
            Part var4 = CharacterMask.Part.s_leaves[var2];
   ...
   private boolean isAll(boolean var1) {
      ...
      for(int var4 = CharacterMask.Part.s_leaves.length; var2 && var3 < var4; ++var3) {
         Part var5 = CharacterMask.Part.s_leaves[var3];
   ...
   public void forEachVisible(Consumer var1) {
      try {
         for(int var2 = 0; var2 < CharacterMask.Part.s_leaves.length; ++var2) {
            Part var3 = CharacterMask.Part.s_leaves[var2];
   ...
   public static enum Part {
      ...
      private Part(int var3, Part var4) {
         this.value = var3;
         this.parent = var4;
         this.isSubdivided = false;
      }
      ...
      public static Part fromInt(int var0) {
      ...
      public Part[] subDivisions() {
         if (this.subDivisions != null) {
            ...
            this.subDivisions = (Part[])var1.toArray(new Part[0]);
            return this.subDivisions;
         }
      }
      ...
      private static Part[] leavesInternal() {
         ...
         return (Part[])var0.toArray(new Part[0]);
      }
      ...
      private static Part[] $values() {
         return new Part[]{Head, Torso, Pelvis, LeftArm, LeftHand, RightArm, RightHand, LeftLeg, LeftFoot, RightLeg, RightFoot, Dress, Chest, Waist, Belt, Crotch};
      }
   }
}
