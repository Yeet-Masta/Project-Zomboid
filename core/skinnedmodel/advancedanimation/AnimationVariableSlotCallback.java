...
public abstract class AnimationVariableSlotCallback extends AnimationVariableSlot {
   private final CallbackGet m_callbackGet;
   private final CallbackSet m_callbackSet;

   protected AnimationVariableSlotCallback(String var1, CallbackGet var2) {
      this(var1, var2, (CallbackSet)null);
   }

   protected AnimationVariableSlotCallback(String var1, CallbackGet var2, CallbackSet var3) {
      super(var1);
