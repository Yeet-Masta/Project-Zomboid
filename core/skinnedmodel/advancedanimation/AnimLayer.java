...
public final class AnimLayer implements IAnimListener {
         ...
         if (var4.isNew() && var4.wasActivated()) {
            ...
            if (var5 != null) {
               ...
               if (!StringUtils.isNullOrWhitespace(var6.m_AnimName)) {
                  StartAnimTrackParameters var9 = AnimLayer.StartAnimTrackParameters.alloc();
   ...
   private AnimationTrack startAnimTrack(String var1, StartAnimTrackParameters var2) {
   ...
   private static class StartAnimTrackParameters extends PooledObject {
      ...
      private static final Pool s_pool = new Pool(StartAnimTrackParameters::new);
