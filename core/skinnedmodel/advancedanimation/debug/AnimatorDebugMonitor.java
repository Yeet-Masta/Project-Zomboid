...
public final class AnimatorDebugMonitor {
   ...
   private void addLogLine(LogType var1, String var2, Color var3, boolean var4) {
      MonitorLogLine var5 = new MonitorLogLine();
      var5.line = var2;
      var5.color = var3;
      var5.type = var1;
   ...
   private void processQueue() {
      while(this.logLineQueue.size() > 0) {
         MonitorLogLine var1 = (MonitorLogLine)this.logLineQueue.poll();
         this.log(var1);
      }
   ...
   private void preUpdate() {
      Map.Entry var2;
      for(Iterator var1 = this.monitoredVariables.entrySet().iterator(); var1.hasNext(); ((MonitoredVar)var2.getValue()).updated = false) {
      ...
      for(int var5 = 0; var5 < this.monitoredLayers.length; ++var5) {
         ...
         Iterator var3;
         Map.Entry var4;
         for(var3 = var6.activeNodes.entrySet().iterator(); var3.hasNext(); ((MonitoredNode)var4.getValue()).updated = false) {
            var4 = (Map.Entry)var3.next();
         }

         for(var3 = var6.animTracks.entrySet().iterator(); var3.hasNext(); ((MonitoredTrack)var4.getValue()).updated = false) {
            var4 = (Map.Entry)var3.next();
         }
      }
   ...
   private void postUpdate() {
      ...
      while(var1.hasNext()) {
         ...
         if (((MonitoredVar)var2.getValue()).active && !((MonitoredVar)var2.getValue()).updated) {
            this.addLogLine(AnimatorDebugMonitor.LogType.VAR, "[variable] : removed -> '" + (String)var2.getKey() + "', last value: '" + ((MonitoredVar)var2.getValue()).value + "'.", col_var_deactivated);
      ...
      for(int var5 = 0; var5 < this.monitoredLayers.length; ++var5) {
         ...
         while(var3.hasNext()) {
            ...
            if (((MonitoredNode)var4.getValue()).active && !((MonitoredNode)var4.getValue()).updated) {
               this.addLogLine(AnimatorDebugMonitor.LogType.NODE, "[layer][" + var6.index + "] [active_nodes] : deactivated -> '" + ((MonitoredNode)var4.getValue()).name + "'.", col_node_deactivated);
         ...
         while(var3.hasNext()) {
            var4 = (Map.Entry)var3.next();
            if (((MonitoredTrack)var4.getValue()).active && !((MonitoredTrack)var4.getValue()).updated) {
               this.addLogLine(AnimatorDebugMonitor.LogType.TRACK, "[layer][" + var6.index + "] [anim_tracks] : deactivated -> '" + ((MonitoredTrack)var4.getValue()).name + "'.", col_track_deactivated);
               ((MonitoredTrack)var4.getValue()).active = false;
            }
         }
   ...
   private void updateVariable(String var1, String var2) {
      MonitoredVar var3 = (MonitoredVar)this.monitoredVariables.get(var1);
      boolean var4 = false;
      if (var3 == null) {
         var3 = new MonitoredVar();
   ...
   public void setSelectedVariable(String var1) {
      if (var1 == null) {
         ...
         this.selectedVariable = (MonitoredVar)this.monitoredVariables.get(var1);
      }
   ...
   private void ensureLayers(AnimLayer[] var1) {
      ...
      if (this.monitoredLayers == null || this.monitoredLayers.length != var2) {
         ...
         for(int var3 = 0; var3 < var2; ++var3) {
            this.monitoredLayers[var3] = new MonitoredLayer(var3);
         }
      }
   ...
   private static enum LogType {
      ...
      private static LogType[] $values() {
         return new LogType[]{DEFAULT, LAYER, NODE, TRACK, VAR, MAX};
      }
   }
