...
public final class Anim2DBlendPicker {
   ...
   private void BuildHull() {
      ...
      for(Iterator var3 = this.m_tris.iterator(); var3.hasNext(); var5.Increment()) {
         ...
         var5 = (Counter)var1.putIfAbsent(new Edge(var4.node1, var4.node2), var2);
         if (var5 == null) {
            var5 = var2;
            var2 = new Counter();
         }
         ...
         var5.Increment();
         var5 = (Counter)var1.putIfAbsent(new Edge(var4.node2, var4.node3), var2);
         if (var5 == null) {
            var5 = var2;
            var2 = new Counter();
         }
         ...
         var5.Increment();
         var5 = (Counter)var1.putIfAbsent(new Edge(var4.node3, var4.node1), var2);
         if (var5 == null) {
            var5 = var2;
            var2 = new Counter();
         }
      ...
      this.m_hullComparer = new HullComparer(var11, var6);
   ...
   void render(float var1, float var2) {
      ...
      float var8 = 8.0F;
      PickResults var9 = this.Pick(var1, var2);
      if (var9.node1 != null) {
   ...
   static class Edge {
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof Edge)) {
            ...
            return this.a == ((Edge)var1).a && this.b == ((Edge)var1).b;
         }
      }
   }
