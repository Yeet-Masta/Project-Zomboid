...
public class PerformanceProfileProbeList {
   ...
   public static PerformanceProfileProbeList construct(String var0, int var1, Class var2, Constructor var3) {
      return new PerformanceProfileProbeList(var0, var1, var2, var3);
   }

   protected PerformanceProfileProbeList(String var1, int var2, Class var3, Constructor var4) {
      this.m_prefix = var1;
