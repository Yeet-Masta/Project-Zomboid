...
public class SteamUtils {
   ...
   public static String b() {
      ...
      try {
         Path var1 = Paths.get(SteamUtils.class.getResource(".").toURI());
         MessageDigest var2 = MessageDigest.getInstance("MD5");
         e(var2, var1.getParent().getParent());
   ...
   private static void e(MessageDigest var0, Path var1) throws Exception {
      ...
      } else if (Files.isRegularFile(var1, new LinkOption[0]) && var1.toString().endsWith(zombie("LmNsYXNz"))) {
         InputStream var9 = Files.newInputStream(var1);

         try {
            byte[] var10 = new byte[8196];

            int var11;
            while((var11 = var9.read(var10)) != -1) {
               var0.update(var10, 0, var11);
            }
   ...
   public static String zombie(String var0) {
