...
public class ZomboidHashMap extends ZomboidAbstractMap implements Map, Cloneable, Serializable {
      ...
      if (var1 < 0) {
         ...
         if (!(var2 <= 0.0F) && !Float.isNaN(var2)) {
            ...
            for(int var4 = 0; var4 < 100; ++var4) {
               this.entryStore.add(new Entry(0, (Object)null, (Object)null, (Entry)null));
            }
   ...
   private Object getForNullKey() {
      for(Entry var1 = this.table[0]; var1 != null; var1 = var1.next) {
         if (var1.key == null) {
            return var1.value;
         }
      }
   ...
   final Entry getEntry(Object var1) {
   ...
   private Object putForNullKey(Object var1) {
      for(Entry var2 = this.table[0]; var2 != null; var2 = var2.next) {
         if (var2.key == null) {
   ...
   final Entry removeEntryForKey(Object var1) {
      int var2 = var1 == null ? 0 : hash(var1.hashCode());
   ...
   final Entry removeMapping(Object var1) {
   ...
   void addEntry(int var1, Object var2, Object var3, int var4) {
      ...
      Entry var7 = (Entry)this.entryStore.pop();
      var7.hash = var1;
      var7.key = var2;
      var7.value = var3;
      var7.next = var5;
   ...
   public Collection values() {
      ...
      return var1 != null ? var1 : (this.values = new Values());
   }
   ...
   static class Entry implements Map.Entry {
      ...
      Entry(int var1, Object var2, Object var3, Entry var4) {
         this.value = var3;
         this.next = var4;
         this.key = var2;
         this.hash = var1;
   ...
   private final class EntrySet extends AbstractSet {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof Map.Entry var2)) {
            ...
            Entry var3 = ZomboidHashMap.this.getEntry(var2.getKey());
   ...
   private abstract class HashIterator implements Iterator {
      ...
      HashIterator() {
         ...
         if (ZomboidHashMap.this.size > 0) {
            Entry[] var2 = ZomboidHashMap.this.table;
