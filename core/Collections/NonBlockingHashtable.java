...
public class NonBlockingHashtable extends Dictionary implements ConcurrentMap, Cloneable, Serializable {
   ...
   private static final class CHM {
      ...
      private final AtomicReferenceFieldUpdater _newkvsUpdater = AtomicReferenceFieldUpdater.newUpdater(CHM.class, Object[].class, "_newkvs");
      ...
      private boolean copy_slot(NonBlockingHashtable var1, int var2, Object[] var3, Object[] var4) {
         ...
         Object var6;
         for(var6 = NonBlockingHashtable.val(var3, var2); !(var6 instanceof Prime); var6 = NonBlockingHashtable.val(var3, var2)) {
            Prime var7 = var6 != null && var6 != NonBlockingHashtable.TOMBSTONE ? new Prime(var6) : NonBlockingHashtable.TOMBPRIME;
   ...
   private class SnapshotK implements Iterator, Enumeration {
      final SnapshotV _ss = NonBlockingHashtable.this.new SnapshotV();
