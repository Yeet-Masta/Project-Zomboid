...
public class ConcurrentAutoTable implements Serializable {
   private volatile CAT _cat = new CAT((CAT)null, 4, 0L);
   private static final AtomicReferenceFieldUpdater _catUpdater = AtomicReferenceFieldUpdater.newUpdater(ConcurrentAutoTable.class, CAT.class, "_cat");
   ...
   public void set(long var1) {
      CAT var3 = new CAT((CAT)null, 4, var1);
   ...
   private static class CAT implements Serializable {
      ...
      CAT(CAT var1, int var2, long var3) {
         this._next = var1;
         ...
         if (var11) {
            ...
            while(true) {
               ...
               if (CAS(var7, var8, var9, var9 + var1)) {
                  ...
                  CAT var16 = new CAT(this, var7.length * 2, 0L);
