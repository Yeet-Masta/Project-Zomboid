...
public class NonBlockingHashMapLong extends AbstractMap implements ConcurrentMap, Serializable {
   ...
   private static final class CHM implements Serializable {
      ...
      private static final AtomicReferenceFieldUpdater _newchmUpdater = AtomicReferenceFieldUpdater.newUpdater(CHM.class, CHM.class, "_newchm");
      volatile long _resizers;
      private static final AtomicLongFieldUpdater _resizerUpdater = AtomicLongFieldUpdater.newUpdater(CHM.class, "_resizers");
      final long[] _keys;
      final Object[] _vals;
      volatile long _copyIdx = 0L;
      private static final AtomicLongFieldUpdater _copyIdxUpdater = AtomicLongFieldUpdater.newUpdater(CHM.class, "_copyIdx");
      volatile long _copyDone = 0L;
      private static final AtomicLongFieldUpdater _copyDoneUpdater = AtomicLongFieldUpdater.newUpdater(CHM.class, "_copyDone");
      ...
      private final Object get_impl(long var1) {
         ...
         while(true) {
            ...
            if (var1 == var6) {
               if (!(var8 instanceof Prime)) {
                  if (var8 == NonBlockingHashMapLong.TOMBSTONE) {
                     return null;
                  }

                  CHM var9 = this._newchm;
                  return var8;
               }
      ...
      private final Object putIfMatch(long var1, Object var3, Object var4) {
         ...
         if (var3 == var10) {
            return var10;
         } else if ((var10 != null || !this.tableFull(var7, var5)) && !(var10 instanceof Prime)) {
            do {
               assert !(var10 instanceof Prime);
      ...
      private final CHM resize() {
         ...
         if (var1 != null) {
            ...
            if (var1 != null) {
               ...
               var1 = new CHM(this._nbhml, this._size, var9);
      ...
      private final CHM copy_slot_and_check(int var1, Object var2) {
      ...
      private boolean copy_slot(int var1) {
         ...
         Object var4;
         for(var4 = this._vals[var1]; !(var4 instanceof Prime); var4 = this._vals[var1]) {
            Prime var5 = var4 != null && var4 != NonBlockingHashMapLong.TOMBSTONE ? new Prime(var4) : NonBlockingHashMapLong.TOMBPRIME;
   ...
   private static final class Prime {
      ...
      static Object unbox(Object var0) {
         return var0 instanceof Prime ? ((Prime)var0)._V : var0;
      }
   }
   ...
   private class SnapshotV implements Iterator, Enumeration {
      ...
      public SnapshotV() {
         while(true) {
            CHM var2 = NonBlockingHashMapLong.this._chm;
   ...
   public class IteratorLong implements Iterator, Enumeration {
      private final SnapshotV _ss = NonBlockingHashMapLong.this.new SnapshotV();
   ...
   private class SnapshotE implements Iterator {
      final SnapshotV _ss = NonBlockingHashMapLong.this.new SnapshotV();
