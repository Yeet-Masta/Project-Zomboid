...
public class NonBlockingHashMap extends AbstractMap implements ConcurrentMap, Cloneable, Serializable {
   ...
   private static final class CHM {
      ...
      private boolean copy_slot(NonBlockingHashMap var1, int var2, Object[] var3, Object[] var4) {
         ...
         Object var6;
         for(var6 = NonBlockingHashMap.val(var3, var2); !(var6 instanceof Prime); var6 = NonBlockingHashMap.val(var3, var2)) {
            Prime var7 = var6 != null && var6 != NonBlockingHashMap.TOMBSTONE ? new Prime(var6) : NonBlockingHashMap.TOMBPRIME;
   ...
   private class SnapshotK implements Iterator, Enumeration {
      final SnapshotV _ss = NonBlockingHashMap.this.new SnapshotV();
