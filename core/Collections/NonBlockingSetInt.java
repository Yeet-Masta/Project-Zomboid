...
public class NonBlockingSetInt extends AbstractSet implements Serializable {
   ...
   private final boolean CAS_nbsi(NBSI var1, NBSI var2) {
   ...
   private NonBlockingSetInt(NonBlockingSetInt var1, NonBlockingSetInt var2) {
      this._nbsi = new NBSI(var1._nbsi, var2._nbsi, new Counter(), this);
   }
   ...
   public void clear() {
      NBSI var1 = new NBSI(63, new Counter(), this);
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this._nbsi = new NBSI(var2, new Counter(), this);
   ...
   private static final class NBSI {
      ...
      private final boolean CAS_new(NBSI var1) {
      ...
      private NBSI(int var1, Counter var2, NonBlockingSetInt var3) {
         ...
         this._nbsi64 = var1 + 1 >>> 6 == 0 ? null : new NBSI(var1 + 1 >>> 6, (Counter)null, (NonBlockingSetInt)null);
         this._sum_bits_length = this._bits.length + (this._nbsi64 == null ? 0 : this._nbsi64._sum_bits_length);
      }

      private NBSI(NBSI var1, NBSI var2, Counter var3, NonBlockingSetInt var4) {
         ...
         if (!has_bits(var1) && !has_bits(var2)) {
            ...
            if (!has_bits(var1)) {
               ...
               this._nbsi64 = new NBSI((NBSI)null, var2._nbsi64, (Counter)null, (NonBlockingSetInt)null);
            } else if (!has_bits(var2)) {
               this._bits = new long[var1._bits.length];
               this._nbsi64 = new NBSI((NBSI)null, var1._nbsi64, (Counter)null, (NonBlockingSetInt)null);
            } else {
               int var5 = var1._bits.length > var2._bits.length ? var1._bits.length : var2._bits.length;
               this._bits = new long[var5];
               this._nbsi64 = new NBSI(var1._nbsi64, var2._nbsi64, (Counter)null, (NonBlockingSetInt)null);
            }
      ...
      private static boolean has_bits(NBSI var0) {
      ...
      public boolean intersect(NBSI var1, NBSI var2, NBSI var3) {
      ...
      public boolean union(NBSI var1, NBSI var2, NBSI var3) {
         if (!has_bits(var2) && !has_bits(var3)) {
            return true;
         } else {
            if (has_bits(var2) || has_bits(var3)) {
      ...
      private NBSI install_larger_new_bits(int var1) {
         if (this._new == null) {
            int var2 = this._bits.length << 6 << 1;
            this.CAS_new(new NBSI(var2, this._size, this._non_blocking_set_int));
         }
      ...
      private NBSI help_copy() {
         NBSI var1 = this._non_blocking_set_int._nbsi;
      ...
      private NBSI help_copy_impl(int var1) {
         NBSI var2 = this;
         NBSI var3 = this._new;
         if (var3 == null) {
            return this;
      ...
      static {
         ...
         try {
            var0 = NBSI.class.getDeclaredField("_new");
         } catch (NoSuchFieldException var2) {
         }
   ...
   private class iter implements Iterator {
      NBSIIntIterator intIterator = NonBlockingSetInt.this.new NBSIIntIterator();
