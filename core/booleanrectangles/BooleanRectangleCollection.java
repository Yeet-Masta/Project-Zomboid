...
public class BooleanRectangleCollection extends ArrayList {
   ...
   public ArrayList doIt(Rectangle var1, Rectangle var2) {
      ...
      var9.add(new Line(new Point(var1.getX(), var1.getY()), new Point(var1.getX() + var1.getWidth(), var1.getY())));
      var9.add(new Line(new Point(var1.getX() + var1.getWidth(), var1.getY()), new Point(var1.getX() + var1.getWidth(), var1.getY() + var1.getHeight())));
      var9.add(new Line(new Point(var1.getX() + var1.getWidth(), var1.getY() + var1.getHeight()), new Point(var1.getX(), var1.getY() + var1.getHeight())));
      var9.add(new Line(new Point(var1.getX(), var1.getY() + var1.getHeight()), new Point(var1.getX(), var1.getY())));
      var10.add(new Line(new Point(var2.getX(), var2.getY()), new Point(var2.getX() + var2.getWidth(), var2.getY())));
      var10.add(new Line(new Point(var2.getX() + var2.getWidth(), var2.getY()), new Point(var2.getX() + var2.getWidth(), var2.getY() + var2.getHeight())));
      var10.add(new Line(new Point(var2.getX() + var2.getWidth(), var2.getY() + var2.getHeight()), new Point(var2.getX(), var2.getY() + var2.getHeight())));
      var10.add(new Line(new Point(var2.getX(), var2.getY() + var2.getHeight()), new Point(var2.getX(), var2.getY())));
      ...
      var11 = ((Point)var4.get(0)).X;
      var12 = ((Point)var4.get(0)).Y;
      var5.add(var11);
      var6.add(var12);
   ...
   public class Line {
      ...
      public Line(Point var2, Point var3) {
         this.Start.X = var2.X;
         this.Start.Y = var2.Y;
         this.End.X = var3.X;
         this.End.Y = var3.Y;
