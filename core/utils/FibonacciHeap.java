...
public final class FibonacciHeap {
   ...
   public Entry enqueue(Object var1, double var2) {
   ...
   public void decreaseKey(Entry var1, double var2) {
      this.checkPriority(var2);
   ...
   private static Entry mergeLists(Entry var0, Entry var1) {
   ...
   private void decreaseKeyUnchecked(Entry var1, double var2) {
      var1.mPriority = var2;
   ...
   private void decreaseKeyUncheckedNode(Entry var1, double var2) {
      var1.mPriority = var2;
      if (var1.mParent != null && var1.mPriority <= var1.mParent.mPriority) {
   ...
   private void cutNode(Entry var1) {
   ...
   private void cutNodeNode(Entry var1) {
      var1.mIsMarked = false;
      if (var1.mParent != null) {
         if (var1.mNext != var1) {
            var1.mNext.mPrev = var1.mPrev;
