...
public final class BufferUtils {
   ...
   private static void onBufferAllocated(Buffer var0) {
      if (trackDirectMemory) {
         ...
         if (var0 instanceof ByteBuffer) {
            var1 = new BufferInfo(ByteBuffer.class, var0.capacity(), var0, removeCollected);
            trackedBuffers.put(var1, var1);
         } else if (var0 instanceof FloatBuffer) {
            var1 = new BufferInfo(FloatBuffer.class, var0.capacity() * 4, var0, removeCollected);
            trackedBuffers.put(var1, var1);
         } else if (var0 instanceof IntBuffer) {
            var1 = new BufferInfo(IntBuffer.class, var0.capacity() * 4, var0, removeCollected);
            trackedBuffers.put(var1, var1);
         } else if (var0 instanceof ShortBuffer) {
            var1 = new BufferInfo(ShortBuffer.class, var0.capacity() * 2, var0, removeCollected);
            trackedBuffers.put(var1, var1);
         } else if (var0 instanceof DoubleBuffer) {
            var1 = new BufferInfo(DoubleBuffer.class, var0.capacity() * 8, var0, removeCollected);
            trackedBuffers.put(var1, var1);
         }
      }
   ...
   public static void printCurrentDirectMemory(StringBuilder var0) {
      ...
      if (trackDirectMemory) {
         ...
         while(var16.hasNext()) {
            BufferInfo var17 = (BufferInfo)var16.next();
