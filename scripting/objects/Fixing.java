...
public final class Fixing extends BaseScriptObject {
         ...
         if (!var2[var3].trim().isEmpty() && var2[var3].contains(":")) {
            ...
            if (var5.equals("Require")) {
               ...
               if (var5.equals("GlobalItem")) {
                  if (var6.contains("=")) {
                     this.setGlobalItem(new Fixer(var6.split("=")[0], (LinkedList)null, Integer.parseInt(var6.split("=")[1])));
                  } else {
                     this.setGlobalItem(new Fixer(var6, (LinkedList)null, 1));
                  }
               ...
               if (var6.contains("=")) {
                  this.fixers.add(new Fixer(var6.split("=")[0], (LinkedList)null, Integer.parseInt(var6.split("=")[1])));
               } else {
                  this.fixers.add(new Fixer(var6, (LinkedList)null, 1));
               }
            } else {
   ...
   public Fixer usedInFixer(InventoryItem var1, IsoGameCharacter var2) {
      for(int var3 = 0; var3 < this.getFixers().size(); ++var3) {
         Fixer var4 = (Fixer)this.getFixers().get(var3);
   ...
   public ArrayList getRequiredFixerItems(IsoGameCharacter var1, Fixer var2, InventoryItem var3, ArrayList var4) {
      if (var2 == null) {
         return null;
      } else {
   ...
   public ArrayList getRequiredItems(IsoGameCharacter var1, Fixer var2, InventoryItem var3) {
