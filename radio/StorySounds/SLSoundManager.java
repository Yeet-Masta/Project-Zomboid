...
public final class SLSoundManager {
   ...
   private void renderLine(UIFont var1, String var2, int var3, int var4) {
      TextManager.instance.DrawString(var1, (double)(var3 + 1), (double)(var4 + 1), var2, 0.0, 0.0, 0.0, 1.0);
      TextManager.instance.DrawString(var1, (double)(var3 - 1), (double)(var4 - 1), var2, 0.0, 0.0, 0.0, 1.0);
      TextManager.instance.DrawString(var1, (double)(var3 + 1), (double)(var4 - 1), var2, 0.0, 0.0, 0.0, 1.0);
      TextManager.instance.DrawString(var1, (double)(var3 - 1), (double)(var4 + 1), var2, 0.0, 0.0, 0.0, 1.0);
      TextManager.instance.DrawString(var1, (double)var3, (double)var4, var2, 1.0, 1.0, 1.0, 1.0);
   }
