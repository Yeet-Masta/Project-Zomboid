   ...
   public static void renderUI() {
      if (DebugOptions.instance.ModRenderLoaded.getValue()) {
         if (!GameWindow.DrawReloadingLua) {
            ...
            TextManager.instance.DrawString(var0, (double)(var11 + var10), (double)(var6 = var12 + var10), var2, 1.0, 1.0, 1.0, 1.0);

            for(int var8 = 0; var8 < s_loaded.mods.size(); ++var8) {
               String var9 = (String)s_loaded.mods.get(var8);
               TextManager.instance.DrawString(var0, (double)(var11 + var10), (double)(var6 += var1), var9, 1.0, 1.0, 1.0, 1.0);
            }
