...
public final class LineDrawer {
   ...
   public static void addLine(float var0, float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8, float var9) {
      DrawableLine var10 = pool.isEmpty() ? new DrawableLine() : (DrawableLine)pool.pop();
   ...
   public static void addLine(float var0, float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8, String var9, boolean var10) {
      DrawableLine var11 = pool.isEmpty() ? new DrawableLine() : (DrawableLine)pool.pop();
   ...
   public static void addRect(float var0, float var1, float var2, float var3, float var4, float var5, float var6, float var7) {
      DrawableLine var8 = pool.isEmpty() ? new DrawableLine() : (DrawableLine)pool.pop();
   ...
   public static void addRectYOffset(float var0, float var1, float var2, float var3, float var4, int var5, float var6, float var7, float var8) {
      DrawableLine var9 = pool.isEmpty() ? new DrawableLine() : (DrawableLine)pool.pop();
   ...
   public static void clear() {
      if (!lines.isEmpty()) {
         for(int var0 = 0; var0 < lines.size(); ++var0) {
            pool.push((DrawableLine)lines.get(var0));
         }
   ...
   public void removeLine(String var1) {
      for(int var2 = 0; var2 < lines.size(); ++var2) {
         if (((DrawableLine)lines.get(var2)).name.equals(var1)) {
   ...
   static class DrawableLine {
      ...
      public DrawableLine init(float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8, float var9, String var10) {
         this.xstart = var1;
         this.ystart = var2;
         this.zstart = var3;
         this.xend = var4;
      ...
      public DrawableLine init(float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8, float var9, String var10, boolean var11) {
         this.xstart = var1;
         this.ystart = var2;
         this.zstart = var3;
         this.xend = var4;
      ...
      public DrawableLine init(float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8, float var9, float var10) {
         this.xstart = var1;
         this.ystart = var2;
         this.zstart = var3;
         this.xend = var4;
      ...
      public boolean equals(Object var1) {
         return var1 instanceof DrawableLine ? ((DrawableLine)var1).name.equals(this.name) : var1.equals(this);
      }
   }
}
