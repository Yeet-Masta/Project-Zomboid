...
public final class UI3DScene extends UIElement {
   ...
   private static final ObjectPool s_SetModelCameraPool = new ObjectPool(SetModelCamera::new);
   ...
   private static final ObjectPool s_posRotPool = new ObjectPool(PositionRotation::new);
   private final ArrayList m_aabb;
   private static final ObjectPool s_aabbPool = new ObjectPool(AABB::new);
   private final ArrayList m_box3D;
   private static final ObjectPool s_box3DPool = new ObjectPool(Box3D::new);
   ...
   private static final ThreadLocal TL_Ray_pool = ThreadLocal.withInitial(RayObjectPool::new);
   private static final ThreadLocal TL_Plane_pool = ThreadLocal.withInitial(PlaneObjectPool::new);
   ...
   private static enum View {
      ...
      private static View[] $values() {
         return new View[]{Left, Right, Top, Bottom, Front, Back, UserDefined};
      }
   }
   ...
   private static enum TransformMode {
      ...
      // $FF: synthetic method
      private static TransformMode[] $values() {
         return new TransformMode[]{Global, Local};
      }
   }
   ...
   private static enum GridPlane {
      ...
      // $FF: synthetic method
      private static GridPlane[] $values() {
         return new GridPlane[]{XY, XZ, YZ};
      }
   }
   ...
   private final class RotateGizmo extends Gizmo {
      ...
      private float hitTestCircle(Ray var1, ArrayList var2, Vector2 var3) {
   ...
   private static class SceneObjectRenderData {
      ...
      private static final ObjectPool s_pool = new ObjectPool(SceneObjectRenderData::new);
   ...
   private static class VehicleRenderData extends SceneObjectRenderData {
      ...
      private static final ObjectPool s_pool = new ObjectPool(VehicleRenderData::new);
   ...
   private static class ModelRenderData extends SceneObjectRenderData {
      ...
      private static final ObjectPool s_pool = new ObjectPool(ModelRenderData::new);
   ...
   private static class CharacterRenderData extends SceneObjectRenderData {
      ...
      private static final ObjectPool s_pool = new ObjectPool(CharacterRenderData::new);
