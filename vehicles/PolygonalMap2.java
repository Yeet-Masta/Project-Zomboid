...
public final class PolygonalMap2 {
   ...
   private void createVehicleCluster(VehicleRect var1, ArrayList var2, ArrayList var3) {
      for(int var4 = 0; var4 < var2.size(); ++var4) {
         ...
         if (var1 != var5 && var1.z == var5.z && (var1.cluster == null || var1.cluster != var5.cluster) && var1.isAdjacent(var5)) {
            if (var1.cluster != null) {
               ...
               VehicleCluster var6 = PolygonalMap2.VehicleCluster.alloc().init();
               var1.cluster = var6;
               var5.cluster = var6;
               var6.rects.add(var1);
               var6.rects.add(var5);
      ...
      if (var1.cluster == null) {
         VehicleCluster var7 = PolygonalMap2.VehicleCluster.alloc().init();
         var1.cluster = var7;
         var7.rects.add(var1);
         var3.add(var7);
      }
   ...
   private void createVehicleClusters() {
      ...
      for(var2 = 0; var2 < this.vehicles.size(); ++var2) {
         ...
         VehicleRect var4 = PolygonalMap2.VehicleRect.alloc();
   ...
   private VisibilityGraph getVisGraphAt(float var1, float var2, int var3) {
      for(int var4 = 0; var4 < this.graphs.size(); ++var4) {
         VisibilityGraph var5 = (VisibilityGraph)this.graphs.get(var4);
   ...
   private VisibilityGraph getVisGraphAt(float var1, float var2, int var3, int var4) {
      for(int var5 = 0; var5 < this.graphs.size(); ++var5) {
         VisibilityGraph var6 = (VisibilityGraph)this.graphs.get(var5);
   ...
   private Connection connectTwoNodes(Node var1, Node var2, int var3) {
      Connection var4 = PolygonalMap2.Connection.alloc().init(var1, var2, var3);
   ...
   private void addStairNodes() {
      ...
      for(var2 = 0; var2 < var1.size(); ++var2) {
         Square var15 = (Square)var1.get(var2);
         Square var4 = null;
         Square var5 = null;
         Square var6 = null;
         Square var7 = null;
         ...
         if (var4 != null && var5 != null && var6 != null && var7 != null && var8 != null) {
            ...
            if (var9 != null && var10 != null) {
               Node var16 = this.getNodeForSquare(var5);
               Node var17 = this.getNodeForSquare(var6);
   ...
   private void createVisibilityGraph(VehicleCluster var1) {
      VisibilityGraph var2 = PolygonalMap2.VisibilityGraph.alloc().init(var1);
   ...
   private boolean findPath(PathFindRequest var1, boolean var2) {
      ...
      if ((int)var1.startZ == (int)var1.targetZ && !this.lcc.isNotClear(this, var1.startX, var1.startY, var1.targetX, var1.targetY, (int)var1.startZ, var3)) {
         ...
         if (var2) {
            ...
            while(var26.hasNext()) {
               var24 = (VisibilityGraph)var26.next();
               var24.render();
            }
         }
         ...
         label1511: {
            ...
            int var37;
            Iterator var43;
            VisibilityGraph var46;
            Edge var47;
            label1512: {
               boolean var14;
               VisibilityGraph var16;
               Iterator var41;
               int var44;
               Edge var45;
               label1513: {
                  label1514: {
                     label1515: {
                        label1516: {
                           ...
                           label1517: {
                              ...
                              try {
                                    ...
                                    if (var10.has(504)) {
                                       ...
                                       if (var11 != null) {
                                          ...
                                          for(var37 = 0; var37 < this.graphs.size(); ++var37) {
                                             var11 = (VisibilityGraph)this.graphs.get(var37);
                                             if (var11.contains(var10, 1)) {
                                                Node var31 = this.getPointOutsideObjects(var10, var1.targetX, var1.targetY);
                                                var11.addNode(var31);
                                 ...
                                 if (var21) {
                                    if (var2) {
                                       ...
                                       while(var18.hasNext()) {
                                          VisibilityGraph var19 = (VisibilityGraph)var18.next();
                                          var19.render();
                                       }
                                    }
                                    ...
                                    for(var48 = 0; var48 < this.astar.searchNodes.size(); ++var48) {
                                       ((SearchNode)this.astar.searchNodes.get(var48)).release();
                                    }

                                    Edge var49;
                                    if (var8 && this.adjustStartData.isNodeNew) {
                                       for(var48 = 0; var48 < this.adjustStartData.node.edges.size(); ++var48) {
                                          var49 = (Edge)this.adjustStartData.node.edges.get(var48);
                                    ...
                                    if (var9 && this.adjustGoalData.isNodeNew) {
                                       for(var48 = 0; var48 < this.adjustGoalData.node.edges.size(); ++var48) {
                                          var49 = (Edge)this.adjustGoalData.node.edges.get(var48);
                              ...
                              if (var2) {
                                 ...
                                 while(var34.hasNext()) {
                                    VisibilityGraph var35 = (VisibilityGraph)var34.next();
                                    var35.render();
                                 }
                              }
                              ...
                              for(var13 = 0; var13 < this.astar.searchNodes.size(); ++var13) {
                                 ((SearchNode)this.astar.searchNodes.get(var13)).release();
                              }

                              Edge var36;
                              if (var8 && this.adjustStartData.isNodeNew) {
                                 for(var13 = 0; var13 < this.adjustStartData.node.edges.size(); ++var13) {
                                    var36 = (Edge)this.adjustStartData.node.edges.get(var13);
                              ...
                              if (var9 && this.adjustGoalData.isNodeNew) {
                                 for(var13 = 0; var13 < this.adjustGoalData.node.edges.size(); ++var13) {
                                    var36 = (Edge)this.adjustGoalData.node.edges.get(var13);
                           ...
                           if (var2) {
                              ...
                              while(var27.hasNext()) {
                                 var11 = (VisibilityGraph)var27.next();
                                 var11.render();
                              }
                           }
                           ...
                           for(var28 = 0; var28 < this.astar.searchNodes.size(); ++var28) {
                              ((SearchNode)this.astar.searchNodes.get(var28)).release();
                           }

                           Edge var32;
                           if (var8 && this.adjustStartData.isNodeNew) {
                              for(var28 = 0; var28 < this.adjustStartData.node.edges.size(); ++var28) {
                                 var32 = (Edge)this.adjustStartData.node.edges.get(var28);
                           ...
                           if (var9 && this.adjustGoalData.isNodeNew) {
                              for(var28 = 0; var28 < this.adjustGoalData.node.edges.size(); ++var28) {
                                 var32 = (Edge)this.adjustGoalData.node.edges.get(var28);
                        ...
                        if (var2) {
                           ...
                           while(var43.hasNext()) {
                              var46 = (VisibilityGraph)var43.next();
                              var46.render();
                           }
                        }
                        ...
                        for(var37 = 0; var37 < this.astar.searchNodes.size(); ++var37) {
                           ((SearchNode)this.astar.searchNodes.get(var37)).release();
                        }

                        if (var8 && this.adjustStartData.isNodeNew) {
                           for(var37 = 0; var37 < this.adjustStartData.node.edges.size(); ++var37) {
                              var47 = (Edge)this.adjustStartData.node.edges.get(var37);
                        ...
                        if (var9 && this.adjustGoalData.isNodeNew) {
                           for(var37 = 0; var37 < this.adjustGoalData.node.edges.size(); ++var37) {
                              var47 = (Edge)this.adjustGoalData.node.edges.get(var37);
                     ...
                     if (var2) {
                        ...
                        while(var41.hasNext()) {
                           var16 = (VisibilityGraph)var41.next();
                           var16.render();
                        }
                     }
                     ...
                     for(var44 = 0; var44 < this.astar.searchNodes.size(); ++var44) {
                        ((SearchNode)this.astar.searchNodes.get(var44)).release();
                     }

                     if (var8 && this.adjustStartData.isNodeNew) {
                        for(var44 = 0; var44 < this.adjustStartData.node.edges.size(); ++var44) {
                           var45 = (Edge)this.adjustStartData.node.edges.get(var44);
                     ...
                     if (var9 && this.adjustGoalData.isNodeNew) {
                        for(var44 = 0; var44 < this.adjustGoalData.node.edges.size(); ++var44) {
                           var45 = (Edge)this.adjustGoalData.node.edges.get(var44);
         ...
         if (var2) {
            ...
            while(var39.hasNext()) {
               VisibilityGraph var15 = (VisibilityGraph)var39.next();
               var15.render();
            }
         }
         ...
         if (var8 && this.adjustStartData.isNodeNew) {
            for(var42 = 0; var42 < this.adjustStartData.node.edges.size(); ++var42) {
               var38 = (Edge)this.adjustStartData.node.edges.get(var42);
         ...
         if (var9 && this.adjustGoalData.isNodeNew) {
            for(var42 = 0; var42 < this.adjustGoalData.node.edges.size(); ++var42) {
               var38 = (Edge)this.adjustGoalData.node.edges.get(var42);
   ...
   private void cleanPath(ArrayList var1, PathFindRequest var2, boolean var3, boolean var4, SearchNode var5) {
   ...
   public void render() {
      if (Core.bDebug) {
         ...
         if (DebugOptions.instance.PolymapRenderClusters.getValue()) {
            synchronized(this.renderLock) {
               ...
               if (!var1) {
                  ...
                  while(var3.hasNext()) {
                     VisibilityGraph var26 = (VisibilityGraph)var3.next();
                     var26.render();
                  }
               }
            }
         ...
         if (DebugOptions.instance.PolymapRenderLineClearCollide.getValue()) {
            ...
            int var7 = 9;
            var7 |= 2;
            if (this.lccMain.isNotClear(this, IsoPlayer.getInstance().x, IsoPlayer.getInstance().y, var31, var32, var28, (BaseVehicle)null, var7)) {
         ...
         if (var1) {
            ...
            int var34;
            for(var34 = -1; var34 <= 2; ++var34) {
               LineDrawer.addLine((float)((int)var31 - 1), (float)((int)var32 + var34), (float)((int)var33), (float)((int)var31 + 2), (float)((int)var32 + var34), (float)((int)var33), 0.3F, 0.3F, 0.3F, (String)null, false);
            }

            for(var34 = -1; var34 <= 2; ++var34) {
               LineDrawer.addLine((float)((int)var31 + var34), (float)((int)var32 - 1), (float)((int)var33), (float)((int)var31 + var34), (float)((int)var32 + 2), (float)((int)var33), 0.3F, 0.3F, 0.3F, (String)null, false);
            }

            IsoGridSquare var13;
            for(var34 = -1; var34 <= 1; ++var34) {
               for(int var9 = -1; var9 <= 1; ++var9) {
                  float var10 = 0.3F;
                  float var11 = 0.0F;
                  float var12 = 0.0F;
                  var13 = IsoWorld.instance.CurrentCell.getGridSquare((int)var31 + var9, (int)var32 + var34, (int)var33);
                  if (var13 == null || var13.isSolid() || var13.isSolidTrans() || var13.HasStairs()) {
                     LineDrawer.addLine((float)((int)var31 + var9), (float)((int)var32 + var34), (float)((int)var33), (float)((int)var31 + var9 + 1), (float)((int)var32 + var34 + 1), (float)((int)var33), var10, var11, var12, (String)null, false);
                  }
               }
            }

            if (var28 < (int)IsoPlayer.getInstance().getZ()) {
               LineDrawer.addLine((float)((int)var31), (float)((int)var32), (float)((int)var33), (float)((int)var31), (float)((int)var32), (float)((int)IsoPlayer.getInstance().getZ()), 0.3F, 0.3F, 0.3F, (String)null, true);
            } else if (var28 > (int)IsoPlayer.getInstance().getZ()) {
               LineDrawer.addLine((float)((int)var31), (float)((int)var32), (float)((int)var33), (float)((int)var31), (float)((int)var32), (float)((int)IsoPlayer.getInstance().getZ()), 0.3F, 0.3F, 0.3F, (String)null, true);
            }

            PathFindRequest var37 = PolygonalMap2.PathFindRequest.alloc().init(this.testRequest, IsoPlayer.getInstance(), IsoPlayer.getInstance().x, IsoPlayer.getInstance().y, IsoPlayer.getInstance().z, var31, var32, var33);
            if (DebugOptions.instance.PathfindPathToMouseAllowCrawl.getValue()) {
               var37.bCanCrawl = true;
               if (DebugOptions.instance.PathfindPathToMouseIgnoreCrawlCost.getValue()) {
                  var37.bIgnoreCrawlCost = true;
               }
            }

            if (DebugOptions.instance.PathfindPathToMouseAllowThump.getValue()) {
               var37.bCanThump = true;
            }

            this.testRequest.done = false;
            synchronized(this.renderLock) {
               boolean var38 = DebugOptions.instance.PolymapRenderClusters.getValue();
               if (this.findPath(var37, var38) && !var37.path.isEmpty()) {
                  IsoGridSquare var14;
                  float var16;
                  float var17;
                  PathNode var43;
                  for(int var41 = 0; var41 < var37.path.nodes.size() - 1; ++var41) {
                     var43 = (PathNode)var37.path.nodes.get(var41);
                     PathNode var46 = (PathNode)var37.path.nodes.get(var41 + 1);
                     var14 = IsoWorld.instance.CurrentCell.getGridSquare((double)var43.x, (double)var43.y, (double)var43.z);
                     IsoGridSquare var15 = IsoWorld.instance.CurrentCell.getGridSquare((double)var46.x, (double)var46.y, (double)var46.z);
                     var16 = var14 == null ? var43.z : this.getApparentZ(var14);
                     var17 = var15 == null ? var46.z : this.getApparentZ(var15);
                     float var18 = 1.0F;
                     float var19 = 1.0F;
                     float var20 = 0.0F;
                     ...
                     LineDrawer.addLine(var43.x, var43.y, var16, var46.x, var46.y, var17, var18, var19, var20, (String)null, true);
                     LineDrawer.addRect(var43.x - 0.05F, var43.y - 0.05F, var16, 0.1F, 0.1F, var18, var19, var20);
                  }

                  PathFindBehavior2.closestPointOnPath(IsoPlayer.getInstance().x, IsoPlayer.getInstance().y, IsoPlayer.getInstance().z, IsoPlayer.getInstance(), var37.path, this.pointOnPath);
                  PathNode var42 = (PathNode)var37.path.nodes.get(this.pointOnPath.pathIndex);
                  var43 = (PathNode)var37.path.nodes.get(this.pointOnPath.pathIndex + 1);
                  var13 = IsoWorld.instance.CurrentCell.getGridSquare((double)var42.x, (double)var42.y, (double)var42.z);
                  var14 = IsoWorld.instance.CurrentCell.getGridSquare((double)var43.x, (double)var43.y, (double)var43.z);
                  float var47 = var13 == null ? var42.z : this.getApparentZ(var13);
                  var16 = var14 == null ? var43.z : this.getApparentZ(var14);
                  var17 = var47 + (var16 - var47) * this.pointOnPath.dist;
                  ...
                  if (GameKeyboard.isKeyDown(207) && !GameKeyboard.wasKeyDown(207)) {
                     Object var44 = LuaManager.env.rawget("ISPathFindAction_pathToLocationF");
                     if (var44 != null) {
                        LuaManager.caller.pcall(LuaManager.thread, var44, new Object[]{var31, var32, var33});
                     }
                  }
               }
            ...
            for(int var24 = 0; var24 < this.testRequest.path.nodes.size() - 1; ++var24) {
               PathNode var27 = (PathNode)this.testRequest.path.nodes.get(var24);
               PathNode var30 = (PathNode)this.testRequest.path.nodes.get(var24 + 1);
               var31 = 1.0F;
               var32 = 1.0F;
               var33 = 0.0F;
               ...
               LineDrawer.addLine(var27.x, var27.y, var27.z, var30.x, var30.y, var30.z, var31, var32, var33, (String)null, true);
            }
         ...
         if (DebugOptions.instance.PolymapRenderConnections.getValue()) {
            ...
            var31 = IsoUtils.XToIso(var2, var25, (float)var28);
            var32 = IsoUtils.YToIso(var2, var25, (float)var28);
            VisibilityGraph var35 = this.getVisGraphAt(var31, var32, var28, 1);
            if (var35 != null) {
               Node var39 = var35.getClosestNodeTo(var31, var32);
               if (var39 != null) {
                  Iterator var36 = var39.visible.iterator();

                  while(var36.hasNext()) {
                     Connection var40 = (Connection)var36.next();
                     Node var45 = var40.otherNode(var39);
                     LineDrawer.addLine(var39.x, var39.y, (float)var28, var45.x, var45.y, (float)var28, 1.0F, 0.0F, 0.0F, (String)null, true);
                  }
               }
            }
         }
   ...
   public void squareChanged(IsoGridSquare var1) {
      SquareUpdateTask var2 = PolygonalMap2.SquareUpdateTask.alloc().init(this, var1);
      this.squareTaskQueue.add(var2);
      this.thread.wake();
   }

   public void addChunkToWorld(IsoChunk var1) {
      ChunkUpdateTask var2 = PolygonalMap2.ChunkUpdateTask.alloc().init(this, var1);
   ...
   public void removeChunkFromWorld(IsoChunk var1) {
      if (this.thread != null) {
         ChunkRemoveTask var2 = PolygonalMap2.ChunkRemoveTask.alloc().init(this, var1);
         this.chunkTaskQueue.add(var2);
         this.thread.wake();
      }
   }
   ...
   public void addVehicleToWorld(BaseVehicle var1) {
      VehicleAddTask var2 = PolygonalMap2.VehicleAddTask.alloc();
      var2.init(this, var1);
      this.vehicleTaskQueue.add(var2);
      VehicleState var3 = PolygonalMap2.VehicleState.alloc().init(var1);
      this.vehicleState.put(var1, var3);
      this.thread.wake();
   }

   public void updateVehicle(BaseVehicle var1) {
      VehicleUpdateTask var2 = PolygonalMap2.VehicleUpdateTask.alloc();
      var2.init(this, var1);
      this.vehicleTaskQueue.add(var2);
      this.thread.wake();
   }
   ...
   public void removeVehicleFromWorld(BaseVehicle var1) {
      if (this.thread != null) {
         VehicleRemoveTask var2 = PolygonalMap2.VehicleRemoveTask.alloc();
         var2.init(this, var1);
         this.vehicleTaskQueue.add(var2);
   ...
   public PathFindRequest addRequest(IPathfinder var1, Mover var2, float var3, float var4, float var5, float var6, float var7, float var8) {
      ...
      PathFindRequest var9 = PolygonalMap2.PathFindRequest.alloc().init(var1, var2, var3, var4, var5, var6, var7, var8);
      this.requestMap.put(var2, var9);
      PathRequestTask var10 = PolygonalMap2.PathRequestTask.alloc().init(this, var9);
   ...
   private void supercover(float var1, float var2, float var3, float var4, int var5, PointPool var6, ArrayList var7) {
      ...
      if (var8 == 0.0) {
         ...
         var17 = (Math.floor((double)var1) + 1.0 - (double)var1) * var10;
      } else {
         var15 = -1;
      ...
      if (var10 == 0.0) {
         ...
         var17 -= (Math.floor((double)var2) + 1.0 - (double)var2) * var8;
      } else {
         var16 = -1;
   ...
   private static final class LineClearCollide {
      ...
      boolean canStandAt(PolygonalMap2 var1, float var2, float var3, float var4, float var5, float var6, Vehicle var7) {
         if (((int)var2 != (int)var4 || (int)var3 != (int)var5) && var1.isBlockedInAllDirections((int)var4, (int)var5, (int)var6)) {
            ...
            for(var12 = 0; var12 < var1.vehicles.size(); ++var12) {
               Vehicle var17 = (Vehicle)var1.vehicles.get(var12);
      ...
      boolean isNotClearOld(PolygonalMap2 var1, float var2, float var3, float var4, float var5, int var6, int var7) {
         ...
         if (var9 != null && var9.has(504)) {
            return true;
         } else if (!this.canStandAt(var1, var2, var3, var4, var5, (float)var6, (Vehicle)null)) {
            return true;
         } else {
            ...
            for(int var30 = 0; var30 < var1.vehicles.size(); ++var30) {
               Vehicle var26 = (Vehicle)var1.vehicles.get(var30);
      ...
      boolean isNotClearClipper(PolygonalMap2 var1, float var2, float var3, float var4, float var5, int var6, int var7) {
         ...
         if (var9 != null && var9.has(504)) {
            ...
            if (var14 == 0.0) {
               ...
               var23 = (Math.floor((double)var10) + 1.0 - (double)var10) * var16;
            } else {
               var21 = -1;
            ...
            if (var16 == 0.0) {
               ...
               var23 -= (Math.floor((double)var11) + 1.0 - (double)var11) * var14;
            } else {
               var22 = -1;
   ...
   private static final class VGAStar extends AStar {
      ...
      VGAStar init(ArrayList var1, TIntObjectHashMap var2) {
      ...
      SearchNode getSearchNode(int var1, int var2) {
         SearchNode var3 = PolygonalMap2.SearchNode.alloc().init(this, var1, var2);
         this.searchNodes.add(var3);
         return var3;
      }

      ArrayList shortestPath(PathFindRequest var1, SearchNode var2, SearchNode var3) {
      ...
      final class InitProc implements TIntObjectProcedure {
         public boolean execute(int var1, Node var2) {
            SearchNode var3 = PolygonalMap2.SearchNode.alloc().init(VGAStar.this, (Node)var2);
   ...
   public static final class VehiclePoly {
      ...
      VehiclePoly init(VehiclePoly var1) {
         this.x1 = var1.x1;
         this.y1 = var1.y1;
         this.x2 = var1.x2;
         this.y2 = var1.y2;
      ...
      VehiclePoly init(BaseVehicle var1, float var2) {
      ...
      VehicleRect getAABB(VehicleRect var1) {
         ...
         return var1.init((Vehicle)null, (int)var2, (int)var3, (int)Math.ceil((double)var4) - (int)var2, (int)Math.ceil((double)var5) - (int)var3, (int)this.z);
      }
      ...
      boolean isAdjacentToWindow() {
         if (!this.has(2048) && !this.has(4096)) {
            ...
            if (var1 != null && var1.has(4096)) {
               ...
               Square var2 = PolygonalMap2.instance.getSquare(this.x + 1, this.y, this.z);
   ...
   private static final class Node {
      ...
      Node init(float var1, float var2, int var3) {
         this.x = var1;
         this.y = var2;
         this.z = var3;
         this.ignore = false;
   ...
   private static final class VisibilityGraph {
      ...
      void addEdgesForVehicle(Vehicle var1) {
         ...
         int var3 = (int)var2.z;
         Node var4 = PolygonalMap2.Node.alloc().init(var2.x1, var2.y1, var3);
         Node var5 = PolygonalMap2.Node.alloc().init(var2.x2, var2.y2, var3);
         Node var6 = PolygonalMap2.Node.alloc().init(var2.x3, var2.y3, var3);
         Node var7 = PolygonalMap2.Node.alloc().init(var2.x4, var2.y4, var3);
         Obstacle var8 = PolygonalMap2.Obstacle.alloc().init(var1);
         this.obstacles.add(var8);
         Edge var9 = PolygonalMap2.Edge.alloc().init(var4, var5, var8, var8.outer);
         Edge var10 = PolygonalMap2.Edge.alloc().init(var5, var6, var8, var8.outer);
         Edge var11 = PolygonalMap2.Edge.alloc().init(var6, var7, var8, var8.outer);
         Edge var12 = PolygonalMap2.Edge.alloc().init(var7, var4, var8, var8.outer);
         var8.outer.add(var9);
         ...
         if (!(var1.upVectorDot < 0.95F)) {
            ...
            for(int var18 = 0; var18 < var1.crawlOffsets.size(); ++var18) {
               ...
               Node var20 = PolygonalMap2.Node.alloc().init(var17.x, var17.y, var3);
               var20.flags |= 1;
               var16.set(var7.x, var7.y);
               var17.set(var4.x, var4.y);
               var17.sub(var16).mul(var19).add(var16);
               Node var21 = PolygonalMap2.Node.alloc().init(var17.x, var17.y, var3);
               var21.flags |= 1;
               Node var22 = PolygonalMap2.Node.alloc().init((var20.x + var21.x) / 2.0F, (var20.y + var21.y) / 2.0F, var3);
               var22.flags |= 3;
      ...
      void addWorldObstacles() {
         ...
         for(var4 = 0; var4 < var1.h; ++var4) {
            for(var5 = 0; var5 < var1.w; ++var5) {
               ObjectOutline var12 = PolygonalMap2.ObjectOutline.get(var5, var4, var3, var2);
               if (var12 != null && var12.nw && var12.nw_w && var12.nw_n) {
                  var12.trace(var2, this.obstacleTraceNodes);
                  if (!var12.nodes.isEmpty()) {
                     Obstacle var7 = PolygonalMap2.Obstacle.alloc().init((IsoGridSquare)null);
                     ...
                     for(int var8 = 0; var8 < var12.nodes.size() - 1; ++var8) {
                        ...
                        Edge var11 = PolygonalMap2.Edge.alloc().init(var9, var10, var7, var7.outer);
      ...
      void getEdgesFromBuffer(ByteBuffer var1, Obstacle var2, boolean var3, int var4) {
         ...
         if (var5 < 3) {
            ...
            for(var8 = var5 - 1; var8 >= 0; --var8) {
               ...
               Node var11 = PolygonalMap2.Node.alloc().init(var9, var10, var4);
            ...
            for(var8 = var7; var8 < this.nodes.size() - 1; ++var8) {
               ...
               Edge var16 = PolygonalMap2.Edge.alloc().init(var13, var14, var2, var6);
               var6.add(var16);
            }

            Node var12 = (Node)this.nodes.get(this.nodes.size() - 1);
            var13 = (Node)this.nodes.get(var7);
            Edge var15 = PolygonalMap2.Edge.alloc().init(var12, var13, var2, var6);
            var6.add(var15);
         }
      }
                                 ...
                                 for(int var16 = 0; var16 < var2.outer.size(); ++var16) {
                                    ...
                                    if (var26 != 0.0) {
                                       ...
                                       if (var28 >= 0.0 && var28 <= 1.0 && var30 >= 0.0 && var30 <= 1.0) {
                                          ...
                                          Node var34 = PolygonalMap2.Node.alloc().init(var32, var33, this.cluster.z);
                                          var34.flags |= 1;
               ...
               if (var13 != null && var13.n && var13.w && var13.inner && !(var13.tw | var13.tn | var13.te | var13.ts)) {
                  ...
                  if (!var15.isEmpty()) {
                     for(int var16 = 0; var16 < var15.size() - 1; ++var16) {
                        ...
                        var9.x += (float)var1.left();
                        var9.y += (float)var1.top();
                        Edge var11 = PolygonalMap2.Edge.alloc().init(var9, var10, (Obstacle)null, (EdgeRing)null);
         ...
         while(true) {
            ...
            do {
               if (!var2.hasNext()) {
                  ...
                  Node var16;
                  while(var2.hasNext()) {
                     var10 = (Node)var2.next();
                     if (DebugOptions.instance.PolymapRenderConnections.getValue()) {
                        var4 = var10.visible.iterator();

                        while(var4.hasNext()) {
                           var14 = (Connection)var4.next();
               ...
               while(var4.hasNext()) {
                  EdgeRing var11 = (EdgeRing)var4.next();
            ...
            while(var4.hasNext()) {
               ...
               while(var6.hasNext()) {
                  Connection var18 = (Connection)var6.next();
                  Node var8 = var18.otherNode(var13);
                  if (var8.hasFlag(1)) {
   ...
   private static final class Obstacle {
      ...
      void unsplit(Node var1, ArrayList var2) {
         for(int var3 = 0; var3 < var2.size(); ++var3) {
   ...
   private static final class SearchNode extends ASearchNode {
      ...
      public void getSuccessors(ArrayList var1) {
         ...
         if (this.vgNode != null) {
            ...
            for(var3 = 0; var3 < this.vgNode.visible.size(); ++var3) {
               Connection var8 = (Connection)this.vgNode.visible.get(var3);
               Node var5 = var8.otherNode(this.vgNode);
         ...
         if (this.square != null) {
            for(var3 = -1; var3 <= 1; ++var3) {
               for(int var9 = -1; var9 <= 1; ++var9) {
                  if (var9 != 0 || var3 != 0) {
                     Square var12 = PolygonalMap2.instance.getSquare(this.square.x + var9, this.square.y + var3, this.square.z);
      ...
      public double dist(SearchNode var1) {
         if (this.square != null && var1.square != null && Math.abs(this.square.x - var1.square.x) <= 1 && Math.abs(this.square.y - var1.square.y) <= 1) {
            ...
            return Math.sqrt(Math.pow((double)(var2 - var4), 2.0) + Math.pow((double)(var3 - var5), 2.0));
         }
      }
   ...
   private static final class VehicleAddTask implements IVehicleTask {
      ...
      public void execute() {
         Vehicle var1 = PolygonalMap2.Vehicle.alloc();
   ...
   private static final class ChunkDataZ {
      ...
      short epoch;
      public static final ObjectPool pool = new ObjectPool(ChunkDataZ::new);
      ...
      public void init(Chunk var1, int var2) {
         ...
         for(var22 = 0; var22 < var7; ++var22) {
            ...
            Obstacle var23 = PolygonalMap2.Obstacle.alloc().init((IsoGridSquare)null);
         ...
         var10 += 2;
         var11 += 2;
         ImmutableRectF var12 = PolygonalMap2.ImmutableRectF.alloc();
         var12.init((float)var22, (float)var24, (float)(var10 - var22), (float)(var11 - var24));
         ImmutableRectF var13 = PolygonalMap2.ImmutableRectF.alloc();
      ...
      private void getEdgesFromBuffer(ByteBuffer var1, Obstacle var2, boolean var3) {
         ...
         if (var4 < 3) {
            ...
            for(var7 = 0; var7 < var4; ++var7) {
               ...
               float var9 = var1.getFloat();
               Node var10 = PolygonalMap2.Node.alloc().init(var8, var9, this.z);
               var10.flags |= 4;
            ...
            for(var7 = var6; var7 < this.nodes.size() - 1; ++var7) {
               ...
               Edge var15 = PolygonalMap2.Edge.alloc().init(var12, var13, var2, var5);
               var5.add(var15);
            }

            Node var11 = (Node)this.nodes.get(this.nodes.size() - 1);
            var12 = (Node)this.nodes.get(var6);
            Edge var14 = PolygonalMap2.Edge.alloc().init(var11, var12, var2, var5);
            var5.add(var14);
         }
      }
   ...
   private static final class ChunkData {
      ...
      public ChunkDataZ init(Chunk var1, int var2) {
         if (this.data[var2] == null) {
            this.data[var2] = (ChunkDataZ)PolygonalMap2.ChunkDataZ.pool.alloc();
   ...
   private static final class ClusterOutlineGrid {
      ...
      void trace_W(ClusterOutline var1, ArrayList var2, Node var3) {
         int var4 = var1.x;
         int var5 = var1.y;
         int var6 = var1.z;
         if (var3 != null) {
            ...
            Node var7 = PolygonalMap2.Node.alloc().init((float)var4, (float)var5, var6);
            var2.add(var7);
         }
      ...
      void trace_N(ClusterOutline var1, ArrayList var2, Node var3) {
         int var4 = var1.x;
         int var5 = var1.y;
         int var6 = var1.z;
         if (var3 != null) {
            ...
            Node var7 = PolygonalMap2.Node.alloc().init((float)(var4 + 1), (float)var5, var6);
            var2.add(var7);
         }
      ...
      void trace_E(ClusterOutline var1, ArrayList var2, Node var3) {
         int var4 = var1.x;
         int var5 = var1.y;
         int var6 = var1.z;
         if (var3 != null) {
            ...
            Node var7 = PolygonalMap2.Node.alloc().init((float)(var4 + 1), (float)(var5 + 1), var6);
            var2.add(var7);
         }
      ...
      void trace_S(ClusterOutline var1, ArrayList var2, Node var3) {
         int var4 = var1.x;
         int var5 = var1.y;
         int var6 = var1.z;
         if (var3 != null) {
            ...
            Node var7 = PolygonalMap2.Node.alloc().init((float)var4, (float)(var5 + 1), var6);
            var2.add(var7);
         }
      ...
      ArrayList trace(ClusterOutline var1) {
         int var2 = var1.x;
         int var3 = var1.y;
         int var4 = var1.z;
         ArrayList var5 = new ArrayList();
         Node var6 = PolygonalMap2.Node.alloc().init((float)var2, (float)var3, var4);
         var5.add(var6);
         var1.start = true;
   ...
   private static final class ObjectOutline {
      ...
      void trace_NW_N(ObjectOutline[][] var1, Node var2) {
         if (var2 != null) {
            ...
            Node var3 = PolygonalMap2.Node.alloc().init((float)this.x + 0.3F, (float)this.y - 0.3F, this.z);
            this.nodes.add(var3);
         }
      ...
      void trace(ObjectOutline[][] var1, ArrayList var2) {
         var2.clear();
         this.nodes = var2;
         Node var3 = PolygonalMap2.Node.alloc().init((float)this.x - 0.3F, (float)this.y - 0.3F, this.z);
         var2.add(var3);
   ...
   private static enum EdgeRingHit {
      ...
      // $FF: synthetic method
      private static EdgeRingHit[] $values() {
         return new EdgeRingHit[]{OnEdge, Inside, Outside};
      }
   }
