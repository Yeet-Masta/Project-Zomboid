...
public class CollideWithObstaclesPoly {
   ...
   public Vector2f resolveCollision(IsoGameCharacter var1, float var2, float var3, Vector2f var4) {
      ...
      if (var6 == var2 && var7 == var3) {
         ...
         if (var16 == null) {
            ...
            for(var12 = 0; var12 < this.obstacles.size(); ++var12) {
               CCObstacle var13 = (CCObstacle)this.obstacles.get(var12);
         ...
         if (var17 != null) {
            ...
            for(int var14 = 0; var14 < var17.edges.size(); ++var14) {
               ...
               if (var15 != var16 && (var19.node1.x != var15.node1.x || var19.node1.y != var15.node1.y || var19.node2.x != var15.node2.x || var19.node2.y != var15.node2.y) && (var19.node1.x != var15.node2.x || var19.node1.y != var15.node2.y || var19.node2.x != var15.node1.x || var19.node2.y != var15.node1.y) && (!var19.hasNode(var15.node1) || !var19.hasNode(var15.node2))) {
                  var20 = var15;
               }
            }
            ...
            if (var19 != null && var20 != null) {
               CCNode var22;
               if (var16 == var19) {
                  var22 = var17 == var20.node1 ? var20.node2 : var20.node1;
                  edgeVec.set(var22.x - var17.x, var22.y - var17.y);
                  edgeVec.normalize();
                  if (move.dot(edgeVec) >= 0.0F) {
                     var16 = var20;
                  }
               } else if (var16 == var20) {
                  var22 = var17 == var19.node1 ? var19.node2 : var19.node1;
                  edgeVec.set(var22.x - var17.x, var22.y - var17.y);
                  edgeVec.normalize();
                  if (move.dot(edgeVec) >= 0.0F) {
                     var16 = var19;
         ...
         if (var16 != null) {
            if (var5) {
               var18 = var16.node1.x;
               float var21 = var16.node1.y;
               float var23 = var16.node2.x;
               float var24 = var16.node2.y;
               LineDrawer.addLine(var18, var21, (float)var16.node1.z, var23, var24, (float)var16.node1.z, 0.0F, 1.0F, 1.0F, (String)null, true);
            }
   ...
   public boolean isNotClear(float var1, float var2, float var3, float var4, int var5, boolean var6, BaseVehicle var7, boolean var8, boolean var9) {
      ...
      if (var14 == 0.0) {
         ...
         var23 = (Math.floor((double)var1) + 1.0 - (double)var1) * var16;
      } else {
         var21 = -1;
      ...
      if (var16 == 0.0) {
         ...
         var23 -= (Math.floor((double)var2) + 1.0 - (double)var2) * var14;
      } else {
         var22 = -1;
   ...
   public void render() {
      ...
      if (var1) {
         ...
         while(var3.hasNext()) {
            CCObstacle var5 = (CCObstacle)var3.next();
            var5.render();
         }
      }
   ...
   public static final class ChunkData {
      ...
      public ChunkDataZ init(IsoChunk var1, int var2, CollideWithObstaclesPoly var3) {
         ...
         if (this.data[var2] == null) {
            this.data[var2] = (ChunkDataZ)CollideWithObstaclesPoly.ChunkDataZ.pool.alloc();
   ...
   public static final class ChunkDataZ {
      ...
      public void init(IsoChunk var1, int var2, CollideWithObstaclesPoly var3) {
         ...
         var32 += 2;
         var33 += 2;
         ImmutableRectF var35 = var3.moveBounds.init((float)var9, (float)var31, (float)(var32 - var9), (float)(var33 - var31));
         ...
         for(int var37 = 0; var37 < var3.vehicles.size(); ++var37) {
            ...
            if (var35.intersects(var3.vehicleBounds)) {
               ...
               CCNode var21 = CollideWithObstaclesPoly.CCNode.alloc().init(var16.x1, var16.y1, var2);
               CCNode var22 = CollideWithObstaclesPoly.CCNode.alloc().init(var16.x2, var16.y2, var2);
               CCNode var23 = CollideWithObstaclesPoly.CCNode.alloc().init(var16.x3, var16.y3, var2);
               CCNode var24 = CollideWithObstaclesPoly.CCNode.alloc().init(var16.x4, var16.y4, var2);
               CCObstacle var25 = CollideWithObstaclesPoly.CCObstacle.alloc().init();
               var25.vehicle = var38;
               CCEdge var26 = CollideWithObstaclesPoly.CCEdge.alloc().init(var21, var22, var25);
               CCEdge var27 = CollideWithObstaclesPoly.CCEdge.alloc().init(var22, var23, var25);
               CCEdge var28 = CollideWithObstaclesPoly.CCEdge.alloc().init(var23, var24, var25);
               CCEdge var29 = CollideWithObstaclesPoly.CCEdge.alloc().init(var24, var21, var25);
      ...
      private void getEdgesFromBuffer(ByteBuffer var1, CCObstacle var2, boolean var3) {
         ...
         if (var4 < 3) {
            ...
            if (!var3) {
               var5 = (CCEdgeRing)CollideWithObstaclesPoly.CCEdgeRing.pool.alloc();
               var5.clear();
               var2.inner.add(var5);
            }
            ...
            for(var7 = 0; var7 < var4; ++var7) {
               ...
               CCNode var10 = CollideWithObstaclesPoly.CCNode.alloc().init(var8, var9, this.z);
               this.nodes.add(var6, var10);
            }

            CCNode var12;
            for(var7 = var6; var7 < this.nodes.size() - 1; ++var7) {
               var12 = (CCNode)this.nodes.get(var7);
               CCNode var13 = (CCNode)this.nodes.get(var7 + 1);
               CCEdge var14 = CollideWithObstaclesPoly.CCEdge.alloc().init(var12, var13, var2);
               var5.add(var14);
            }

            CCNode var11 = (CCNode)this.nodes.get(this.nodes.size() - 1);
            var12 = (CCNode)this.nodes.get(var6);
      ...
      private void clipperToObstacles(Clipper var1, ByteBuffer var2, ArrayList var3) {
         ...
         for(int var5 = 0; var5 < var4; ++var5) {
            ...
            CCObstacle var6 = CollideWithObstaclesPoly.CCObstacle.alloc().init();
   ...
   private static final class CCObstacle {
      ...
      static final ObjectPool pool = new ObjectPool(CCObstacle::new) {
      ...
      boolean isPointInside(float var1, float var2, int var3) {
         if (this.outer.isPointInPolygon_WindingNumber(var1, var2, var3) != CollideWithObstaclesPoly.EdgeRingHit.Inside) {
            ...
            for(int var4 = 0; var4 < this.inner.size(); ++var4) {
               CCEdgeRing var5 = (CCEdgeRing)this.inner.get(var4);
      ...
      boolean lineSegmentIntersects(float var1, float var2, float var3, float var4, boolean var5) {
         if (this.outer.lineSegmentIntersects(var1, var2, var3, var4, var5, true)) {
            ...
            for(int var6 = 0; var6 < this.inner.size(); ++var6) {
               CCEdgeRing var7 = (CCEdgeRing)this.inner.get(var6);
      ...
      void lineSegmentIntersect(float var1, float var2, float var3, float var4, ClosestPointOnEdge var5, boolean var6) {
         ...
         for(int var7 = 0; var7 < this.inner.size(); ++var7) {
            CCEdgeRing var8 = (CCEdgeRing)this.inner.get(var7);
      ...
      void render() {
         ...
         for(int var1 = 0; var1 < this.inner.size(); ++var1) {
            ((CCEdgeRing)this.inner.get(var1)).render(false);
         }
   ...
   private static final class CCEdge {
      ...
      static final ObjectPool pool = new ObjectPool(CCEdge::new);
   ...
   private static final class CCNode {
      ...
      static final ObjectPool pool = new ObjectPool(CCNode::new);
   ...
   private static final class CCEdgeRing extends ArrayList {
      static final ObjectPool pool = new ObjectPool(CCEdgeRing::new) {
      ...
      EdgeRingHit isPointInPolygon_WindingNumber(float var1, float var2, int var3) {
         ...
         for(int var5 = 0; var5 < this.size(); ++var5) {
            CCEdge var6 = (CCEdge)this.get(var5);
      ...
      boolean lineSegmentIntersects(float var1, float var2, float var3, float var4, boolean var5, boolean var6) {
         ...
         for(int var10 = 0; var10 < this.size(); ++var10) {
            CCEdge var11 = (CCEdge)this.get(var10);
      ...
      void lineSegmentIntersect(float var1, float var2, float var3, float var4, ClosestPointOnEdge var5, boolean var6) {
         ...
         for(int var7 = 0; var7 < this.size(); ++var7) {
            CCEdge var8 = (CCEdge)this.get(var7);
      ...
      void getClosestPointOnEdge(float var1, float var2, ClosestPointOnEdge var3) {
         for(int var4 = 0; var4 < this.size(); ++var4) {
            CCEdge var5 = (CCEdge)this.get(var4);
            var5.getClosestPointOnEdge(var1, var2, var3);
         }
      ...
      void render(boolean var1) {
         if (!this.isEmpty()) {
            ...
            CCNode var13 = ((CCEdge)this.get(0)).node1;
