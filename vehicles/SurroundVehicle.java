...
public final class SurroundVehicle {
   private static final ObjectPool s_positionPool = new ObjectPool(Position::new);
   ...
   private void calcPositionsWorld() {
      for(int var1 = 0; var1 < this.m_positions.size(); ++var1) {
         Position var2 = (Position)this.m_positions.get(var1);
      ...
      if (var1 - this.m_updateMS >= 1000L) {
         ...
         if (this.m_bMoved) {
            ...
            for(int var3 = 0; var3 < this.m_positions.size(); ++var3) {
               Position var4 = (Position)this.m_positions.get(var3);
               var4.zombie = null;
            }
         }
         ...
         for(int var9 = 0; var9 < this.m_positions.size(); ++var9) {
            Position var5 = (Position)this.m_positions.get(var9);
            if (!var8) {
   ...
   private static enum PositionSide {
      ...
      // $FF: synthetic method
      private static PositionSide[] $values() {
         return new PositionSide[]{Front, Rear, Left, Right};
      }
   }
