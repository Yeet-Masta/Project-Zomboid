...
public final class QuadranglesIntersection {
   ...
   private static boolean between(float var0, float var1, double var2) {
      return (double)Math.min(var0, var1) <= var2 + 0.0010000000474974513 && var2 <= (double)(Math.max(var0, var1) + 0.001F);
   }
   ...
   public static boolean lineIntersection(Vector2 var0, Vector2 var1, Vector2 var2, Vector2 var3) {
      ...
      if (var10 != 0.0F) {
         double var11 = (double)(-det(var6, var5, var9, var8)) * 1.0 / (double)var10;
         double var13 = (double)(-det(var4, var6, var7, var9)) * 1.0 / (double)var10;
