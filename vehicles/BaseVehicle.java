...
public final class BaseVehicle extends IsoMovingObject implements Thumpable, IFMODParameterUpdater {
   ...
   public static final ThreadLocal TL_vector2_pool = ThreadLocal.withInitial(Vector2ObjectPool::new);
   public static final ThreadLocal TL_vector2f_pool = ThreadLocal.withInitial(Vector2fObjectPool::new);
   public static final ThreadLocal TL_vector3f_pool = ThreadLocal.withInitial(Vector3fObjectPool::new);
   public static final ThreadLocal TL_matrix4f_pool = ThreadLocal.withInitial(Matrix4fObjectPool::new);
   public static final ThreadLocal TL_quaternionf_pool = ThreadLocal.withInitial(QuaternionfObjectPool::new);
   ...
   public static enum Authorization {
      ...
      // $FF: synthetic method
      private static Authorization[] $values() {
         return new Authorization[]{Server, LocalCollide, RemoteCollide, Local, Remote};
      }
   ...
   public static enum engineStateTypes {
      ...
      // $FF: synthetic method
      private static engineStateTypes[] $values() {
         return new engineStateTypes[]{Idle, Starting, RetryingStarting, StartingSuccess, StartingFailed, Running, Stalling, ShutingDown, StartingFailedNoPower};
      }
   }
