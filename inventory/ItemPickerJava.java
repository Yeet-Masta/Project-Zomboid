...
public final class ItemPickerJava {
                  ...
                  if (var3 != null && rooms.containsKey(var3.getName())) {
                     ...
                     if (var7 == null) {
                        ...
                        if (rooms.containsKey(var3.getName())) {
                           var8 = (ItemPickerRoom)rooms.get(var3.getName());
                        }
                  ...
                  for(int var5 = 0; var5 < var0.getItems().size(); ++var5) {
                     if (var0.getItems().get(var5) instanceof InventoryContainer) {
                        ...
                        if (var6 != null && Rand.Next(var6.fillRand) == 0) {
                           rollContainerItem((InventoryContainer)var0.getItems().get(var5), (IsoGameCharacter)null, (ItemPickerContainer)containers.get(((InventoryItem)var0.getItems().get(var5)).getType()));
                        }
                     }
                  }

                  var9 = (ItemPickerContainer)((ItemPickerRoom)rooms.get("all")).Containers.get("Outfit_" + var4);
                  if (var9 == null) {
                     var9 = (ItemPickerContainer)((ItemPickerRoom)rooms.get("all")).Containers.get(var0.getType());
                  }

                  rollItem(var9, var0, true, var1, (ItemPickerRoom)null);
               }
            }
         }
      }
   ...
   private static void rollProceduralItem(ArrayList var0, ItemContainer var1, float var2, IsoGameCharacter var3, ItemPickerRoom var4) {
   ...
   public static void doRollItem(ItemPickerContainer var0, ItemContainer var1, float var2, IsoGameCharacter var3, boolean var4, boolean var5, ItemPickerRoom var6) {
      boolean var7 = false;
      boolean var8 = false;
      String var9 = "";
         ...
         for(int var12 = 0; var12 < var11.length; ++var12) {
            ...
            if ((float)Rand.Next(10000) <= var14 * 100.0F * var15 + var2 * 10.0F) {
               ...
               if (var16 instanceof InventoryContainer && containers.containsKey(var16.getType())) {
                  ItemPickerContainer var27 = (ItemPickerContainer)containers.get(var16.getType());
