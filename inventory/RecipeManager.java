...
public final class RecipeManager {
   ...
   private static SourceItems getAvailableItems(Recipe var0, IsoGameCharacter var1, ArrayList var2, InventoryItem var3, ArrayList var4, boolean var5) {
      ...
      if (var3 != null && !RecipeContainsItem(var0, var3)) {
         ...
         RMRecipe var7 = RecipeManager.RMRecipe.alloc(var0);
   ...
   public static int getNumberOfTimesRecipeCanBeDone(Recipe var0, IsoGameCharacter var1, ArrayList var2, InventoryItem var3) {
      int var4 = 0;
      RMRecipe var5 = RecipeManager.RMRecipe.alloc(var0);
      if (var2 == null) {
         var2 = new ArrayList();
         var2.add(var1.getInventory());
      }
   ...
   public static InventoryItem GetMovableRecipeTool(boolean var0, Recipe var1, InventoryItem var2, IsoGameCharacter var3, ArrayList var4) {
      if (!(var1 instanceof MovableRecipe var5)) {
         ...
         if (var6 != null && var6.getItems() != null && var6.getItems().size() != 0) {
            SourceItems var7 = getAvailableItems(var1, var3, var4, var2, (ArrayList)null, false);
   ...
   public static InventoryItem PerformMakeItem(Recipe var0, InventoryItem var1, IsoGameCharacter var2, ArrayList var3) {
      ...
      SourceItems var6 = getAvailableItems(var0, var2, var3, var1, (ArrayList)null, false);
      ...
      if (var7.isEmpty()) {
         ...
         if ((double)var9.getOffAgeMax() != 1.0E9) {
            if (var14) {
   ...
   private static boolean ReduceUses(InventoryItem var0, float var1, IsoGameCharacter var2) {
      ...
      if (var0 instanceof Food var6) {
         if (var6.getHungerChange() < 0.0F) {
            ...
            if ((double)var6.getHungerChange() > -0.01) {
   ...
   private static int AvailableUses(InventoryItem var0) {
      ...
      } else if (var0 instanceof Food var1) {
   ...
   public static ArrayList getEvolvedRecipe(InventoryItem var0, IsoGameCharacter var1, ArrayList var2, boolean var3) {
      ...
      if (var0 instanceof Food && ((Food)var0).isRotten() && var1.getPerkLevel(PerkFactory.Perks.Cooking) < 7) {
         ...
         for(int var6 = 0; var6 < var5.size(); ++var6) {
            ...
            if ((var0.isCooked() && var7.addIngredientIfCooked || !var0.isCooked()) && (var0.getType().equals(var7.baseItem) || var0.getType().equals(var7.getResultItem())) && (!var0.getType().equals("WaterPot") || !((double)((Drainable)var0).getUsedDelta() < 0.75))) {
               if (var3) {
   ...
   private static final class SourceItems {
      ...
      SourceItems(Recipe var1, IsoGameCharacter var2, InventoryItem var3, ArrayList var4) {
         ...
         this.typePerSource = new RMRecipeItemList.Type[var1.getSource().size()];
   ...
   private static final class RMRecipe {
      ...
      RMRecipe init(Recipe var1) {
         ...
         for(int var2 = 0; var2 < var1.getSource().size(); ++var2) {
            RMRecipeSource var3 = RecipeManager.RMRecipeSource.alloc(this, var2);
            if (var3.usesWater) {
               this.usesWater = true;
            }
      ...
      RMRecipe reset() {
         ...
         for(var1 = 0; var1 < this.allItems.size(); ++var1) {
            RecipeManager.RMRecipeItem.release((RMRecipeItem)this.allItems.get(var1));
         }

         this.allItems.clear();

         for(var1 = 0; var1 < this.sources.size(); ++var1) {
            RecipeManager.RMRecipeSource.release((RMRecipeSource)this.sources.get(var1));
         }
      ...
      void getItemsFromContainers(IsoGameCharacter var1, ArrayList var2, InventoryItem var3) {
         ...
         if (this.Test(var3)) {
            for(var4 = 0; var4 < this.sources.size(); ++var4) {
               RMRecipeSource var5 = (RMRecipeSource)this.sources.get(var4);
      ...
      boolean hasItems() {
         for(int var1 = 0; var1 < this.sources.size(); ++var1) {
            RMRecipeSource var2 = (RMRecipeSource)this.sources.get(var1);
            if (!var2.hasItems()) {
               return false;
            }
         }
      ...
      boolean isKeep(String var1) {
         for(int var2 = 0; var2 < this.sources.size(); ++var2) {
            RMRecipeSource var3 = (RMRecipeSource)this.sources.get(var2);
            if (var3.isKeep(var1)) {
               return true;
            }
         }
      ...
      void getAvailableItems(SourceItems var1, boolean var2) {
         ...
         for(int var3 = 0; var3 < this.sources.size(); ++var3) {
            RMRecipeSource var4 = (RMRecipeSource)this.sources.get(var3);
      ...
      static RMRecipe alloc(Recipe var0) {
         return pool.isEmpty() ? (new RMRecipe()).init(var0) : ((RMRecipe)pool.pop()).init(var0);
      }

      static void release(RMRecipe var0) {
   ...
   private static final class RMRecipeItemList {
      ...
      RMRecipeItemList init(RMRecipeSource var1, int var2) {
      ...
      void getItemsFrom(ArrayList var1, RMRecipe var2) {
      ...
      boolean hasItems() {
         ...
         for(int var3 = 0; var3 < this.items.size(); ++var3) {
            if ("Water".equals(var1)) {
               var2 += ((RMRecipeItem)this.items.get(var3)).water;
            } else {
               var2 += ((RMRecipeItem)this.items.get(var3)).uses;
            }
         }
      ...
      int indexOf(InventoryItem var1) {
         for(int var2 = 0; var2 < this.items.size(); ++var2) {
            RMRecipeItem var3 = (RMRecipeItem)this.items.get(var2);
            if (var3.item == var1) {
               return var2;
            }
         }
      ...
      void getAvailableItems(SourceItems var1, boolean var2) {
         if (var2) {
            ...
            if (var1.selectedItem != null) {
               ...
               if (var3 != -1) {
                  RMRecipeItem var4 = (RMRecipeItem)this.items.remove(var3);
      ...
      void Use(ArrayList var1) {
         ...
         for(int var4 = 0; var4 < this.items.size(); ++var4) {
            RMRecipeItem var5 = (RMRecipeItem)this.items.get(var4);
      ...
      static RMRecipeItemList alloc(RMRecipeSource var0, int var1) {
         return pool.isEmpty() ? (new RMRecipeItemList()).init(var0, var1) : ((RMRecipeItemList)pool.pop()).init(var0, var1);
      }

      static void release(RMRecipeItemList var0) {
         assert !pool.contains(var0);
      ...
      static enum Type {
         ...
         private static Type[] $values() {
            return new Type[]{NONE, WATER, DRAINABLE, FOOD, OTHER, DESTROY};
         }
      }
   }
   ...
   private static final class RMRecipeItem {
      ...
      RMRecipeItem init(InventoryItem var1) {
         this.item = var1;
         return this;
      }
      ...
      static RMRecipeItem alloc(InventoryItem var0) {
         return pool.isEmpty() ? (new RMRecipeItem()).init(var0) : ((RMRecipeItem)pool.pop()).init(var0);
      }

      static void release(RMRecipeItem var0) {
         assert !pool.contains(var0);
   ...
   private static final class RMRecipeSource {
      ...
      RMRecipeSource init(RMRecipe var1, int var2) {
         this.recipe = var1;
      ...
      RMRecipeSource reset() {
         for(int var1 = 0; var1 < this.itemLists.size(); ++var1) {
            RecipeManager.RMRecipeItemList.release((RMRecipeItemList)this.itemLists.get(var1));
         }
      ...
      void getItemsFrom(ArrayList var1, RMRecipe var2) {
         for(int var3 = 0; var3 < this.itemLists.size(); ++var3) {
            RMRecipeItemList var4 = (RMRecipeItemList)this.itemLists.get(var3);
      ...
      boolean hasItems() {
         for(int var1 = 0; var1 < this.itemLists.size(); ++var1) {
            RMRecipeItemList var2 = (RMRecipeItemList)this.itemLists.get(var1);
            if (var2.hasItems()) {
               return true;
            }
         }
      ...
      void getAvailableItems(SourceItems var1, boolean var2) {
         ...
         if (var2) {
            for(var3 = 0; var3 < this.itemLists.size(); ++var3) {
               RMRecipeItemList var7 = (RMRecipeItemList)this.itemLists.get(var3);
            ...
            for(int var4 = 0; var4 < this.itemLists.size(); ++var4) {
               RMRecipeItemList var5 = (RMRecipeItemList)this.itemLists.get(var4);
               if (var5.hasItems()) {
            ...
            if (var3 != -1) {
               ((RMRecipeItemList)this.itemLists.get(var3)).getAvailableItems(var1, var2);
            }
         }
      }
      ...
      void Use(ArrayList var1) {
         ...
         for(int var2 = 0; var2 < this.itemLists.size(); ++var2) {
            RMRecipeItemList var3 = (RMRecipeItemList)this.itemLists.get(var2);
            if (var3.hasItems()) {
               var3.Use(var1);
               return;
            }
      ...
      static RMRecipeSource alloc(RMRecipe var0, int var1) {
         return pool.isEmpty() ? (new RMRecipeSource()).init(var0, var1) : ((RMRecipeSource)pool.pop()).init(var0, var1);
      }

      static void release(RMRecipeSource var0) {
         assert !pool.contains(var0);
