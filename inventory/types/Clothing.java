...
public class Clothing extends InventoryItem {
   ...
   private static enum WetDryState {
      ...
      // $FF: synthetic method
      private static WetDryState[] $values() {
         return new WetDryState[]{Invalid, Dryer, Wetter};
      }
   }
   ...
   public static enum ClothingPatchFabricType {
      ...
      // $FF: synthetic method
      private static ClothingPatchFabricType[] $values() {
         return new ClothingPatchFabricType[]{Cotton, Denim, Leather};
      }
   }
}
