...
public final class HandWeapon extends InventoryItem {
   ...
   public void DoTooltip(ObjectTooltip var1, ObjectTooltip.Layout var2) {
      ...
      float var5 = 0.8F;
      float var6 = 1.0F;
      ColorInfo var7 = new ColorInfo();
      ObjectTooltip.LayoutItem var8 = var2.addItem();
      var8.setLabel(Translator.getText("Tooltip_weapon_Condition") + ":", var3, var4, var5, var6);
      float var9 = (float)this.Condition / (float)this.ConditionMax;
      Core.getInstance().getBadHighlitedColor().interp(Core.getInstance().getGoodHighlitedColor(), var9, var7);
      var8.setProgress(var9, var7.getR(), var7.getG(), var7.getB(), 1.0F);
      float var10;
      float var11;
      if (this.getMaxDamage() > 0.0F) {
         var8 = var2.addItem();
         var8.setLabel(Translator.getText("Tooltip_weapon_Damage") + ":", var3, var4, var5, var6);
         var9 = this.getMaxDamage() + this.getMinDamage();
         var10 = 5.0F;
         var11 = var9 / var10;
         Core.getInstance().getBadHighlitedColor().interp(Core.getInstance().getGoodHighlitedColor(), var11, var7);
         var8.setProgress(var11, var7.getR(), var7.getG(), var7.getB(), 1.0F);
      }

      if (this.isRanged()) {
         var8 = var2.addItem();
         var8.setLabel(Translator.getText("Tooltip_weapon_Range") + ":", var3, var4, var5, 1.0F);
      ...
      if (this.isTwoHandWeapon() && !this.isRequiresEquippedBothHands()) {
         var8 = var2.addItem();
         var8.setLabel(Translator.getText("Tooltip_item_TwoHandWeapon"), var3, var4, var5, var6);
      }

      if (!StringUtils.isNullOrEmpty(this.getFireMode())) {
         var8 = var2.addItem();
         var8.setLabel(Translator.getText("Tooltip_item_FireMode") + ":", var3, var4, var5, var6);
         var8.setValue(Translator.getText("ContextMenu_FireMode_" + this.getFireMode()), 1.0F, 1.0F, 1.0F, 1.0F);
      }

      if (this.CantAttackWithLowestEndurance) {
         var8 = var2.addItem();
         var8.setLabel(Translator.getText("Tooltip_weapon_Unusable_at_max_exertion"), Core.getInstance().getBadHighlitedColor().getR(), Core.getInstance().getBadHighlitedColor().getG(), Core.getInstance().getBadHighlitedColor().getB(), 1.0F);
      }

      String var12 = this.getAmmoType();
      if (Core.getInstance().isNewReloading()) {
         String var13;
         if (this.getMaxAmmo() > 0) {
            var13 = String.valueOf(this.getCurrentAmmoCount());
            ...
            var8.setLabel(this.bulletName + ":", 1.0F, 1.0F, 0.8F, 1.0F);
            var8.setValue(var13 + " / " + this.getMaxAmmo(), 1.0F, 1.0F, 1.0F, 1.0F);
         }

         if (this.isJammed()) {
            var8 = var2.addItem();
            var8.setLabel(Translator.getText("Tooltip_weapon_Jammed"), Core.getInstance().getBadHighlitedColor().getR(), Core.getInstance().getBadHighlitedColor().getG(), Core.getInstance().getBadHighlitedColor().getB(), 1.0F);
         } else if (this.haveChamber() && !this.isRoundChambered() && this.getCurrentAmmoCount() > 0) {
            var8 = var2.addItem();
            var13 = this.isSpentRoundChambered() ? "Tooltip_weapon_SpentRoundChambered" : "Tooltip_weapon_NoRoundChambered";
            var8.setLabel(Translator.getText(var13), Core.getInstance().getBadHighlitedColor().getR(), Core.getInstance().getBadHighlitedColor().getG(), Core.getInstance().getBadHighlitedColor().getB(), 1.0F);
         } else if (this.getSpentRoundCount() > 0) {
            var8 = var2.addItem();
            var8.setLabel(Translator.getText("Tooltip_weapon_SpentRounds") + ":", Core.getInstance().getBadHighlitedColor().getR(), Core.getInstance().getBadHighlitedColor().getG(), Core.getInstance().getBadHighlitedColor().getB(), 1.0F);
            var8.setValue(this.getSpentRoundCount() + " / " + this.getMaxAmmo(), 1.0F, 1.0F, 1.0F, 1.0F);
         }

         if (!StringUtils.isNullOrEmpty(this.getMagazineType())) {
            if (this.isContainsClip()) {
               var8 = var2.addItem();
               var8.setLabel(Translator.getText("Tooltip_weapon_ContainsClip"), 1.0F, 1.0F, 0.8F, 1.0F);
            } else {
               var8 = var2.addItem();
               var8.setLabel(Translator.getText("Tooltip_weapon_NoClip"), 1.0F, 1.0F, 0.8F, 1.0F);
            }
         }
      } else {
         if (var12 == null && this.hasModData()) {
         ...
         if (var12 != null) {
            Item var22 = ScriptManager.instance.FindItem(var12);
            if (var22 == null) {
               ScriptManager var14 = ScriptManager.instance;
               String var15 = this.getModule();
               var22 = var14.FindItem(var15 + "." + var12);
            }

            if (var22 != null) {
               var8 = var2.addItem();
               var8.setLabel(Translator.getText("Tooltip_weapon_Ammo") + ":", var3, var4, var5, var6);
               var8.setValue(var22.getDisplayName(), 1.0F, 1.0F, 1.0F, 1.0F);
            }

            Object var21 = this.getModData().rawget("currentCapacity");
            Object var23 = this.getModData().rawget("maxCapacity");
            if (var21 instanceof Double && var23 instanceof Double) {
               int var16 = ((Double)var21).intValue();
               String var17 = "" + var16 + " / " + ((Double)var23).intValue();
               Object var18 = this.getModData().rawget("roundChambered");
               if (var18 instanceof Double && ((Double)var18).intValue() == 1) {
                  var16 = ((Double)var21).intValue();
                  var17 = "" + var16 + "+1 / " + ((Double)var23).intValue();
               } else {
                  Object var19 = this.getModData().rawget("emptyShellChambered");
                  if (var19 instanceof Double && ((Double)var19).intValue() == 1) {
                     var16 = ((Double)var21).intValue();
                     var17 = "" + var16 + "+x / " + ((Double)var23).intValue();
                  }
               }

               var8 = var2.addItem();
               var8.setLabel(Translator.getText("Tooltip_weapon_AmmoCount") + ":", 1.0F, 1.0F, 0.8F, 1.0F);
               var8.setValue(var17, 1.0F, 1.0F, 1.0F, 1.0F);
            }
         }
      }
      ...
      if (this.getStock() != null) {
         var8 = var24.addItem();
         var8.setLabel(Translator.getText("Tooltip_weapon_Stock") + ":", var3, var4, var5, var6);
         var8.setValue(this.getStock().getName(), 1.0F, 1.0F, 1.0F, 1.0F);
      }

      if (this.getSling() != null) {
         var8 = var24.addItem();
         var8.setLabel(Translator.getText("Tooltip_weapon_Sling") + ":", var3, var4, var5, var6);
         var8.setValue(this.getSling().getName(), 1.0F, 1.0F, 1.0F, 1.0F);
      }

      if (this.getScope() != null) {
         var8 = var24.addItem();
         var8.setLabel(Translator.getText("Tooltip_weapon_Scope") + ":", var3, var4, var5, var6);
         var8.setValue(this.getScope().getName(), 1.0F, 1.0F, 1.0F, 1.0F);
      }

      if (this.getCanon() != null) {
         var8 = var24.addItem();
         var8.setLabel(Translator.getText("Tooltip_weapon_Canon") + ":", var3, var4, var5, var6);
         var8.setValue(this.getCanon().getName(), 1.0F, 1.0F, 1.0F, 1.0F);
      }

      if (this.getClip() != null) {
         var8 = var24.addItem();
         var8.setLabel(Translator.getText("Tooltip_weapon_Clip") + ":", var3, var4, var5, var6);
         var8.setValue(this.getClip().getName(), 1.0F, 1.0F, 1.0F, 1.0F);
      }

      if (this.getRecoilpad() != null) {
         var8 = var24.addItem();
         var8.setLabel(Translator.getText("Tooltip_weapon_RecoilPad") + ":", var3, var4, var5, var6);
         var8.setValue(this.getRecoilpad().getName(), 1.0F, 1.0F, 1.0F, 1.0F);
      }
