...
public final class ItemContainer {
   ...
   private static final ThreadLocal TL_comparators = ThreadLocal.withInitial(Comparators::new);
   private static final ThreadLocal TL_itemListPool = ThreadLocal.withInitial(InventoryItemListPool::new);
   private static final ThreadLocal TL_predicates = ThreadLocal.withInitial(Predicates::new);
   ...
   public boolean contains(String var1, boolean var2, boolean var3) {
      ...
      if (var1.contains("Type:")) {
         ...
         for(int var10 = 0; var10 < var9; ++var10) {
            ...
            for(int var12 = 0; var12 < this.Items.size(); ++var12) {
               InventoryItem var13 = (InventoryItem)this.Items.get(var12);
               if (compareType(var11.trim(), var13) && this.testBroken(var3, var13)) {
                  ((InventoryItemListPool)TL_itemListPool.get()).release(var4);
                  return true;
               }

               if (var2 && var13 instanceof InventoryContainer && ((InventoryContainer)var13).getInventory() != null && !var4.contains(var13)) {
                  var4.add(var13);
               }
            }
         }
   ...
   private static InventoryItem getBestOf(InventoryItemList var0, Comparator var1) {
   ...
   public void RemoveAll(String var1) {
      ...
      InventoryItem var3;
      for(int var4 = 0; var4 < this.Items.size(); ++var4) {
         var3 = (InventoryItem)this.Items.get(var4);
         if (var3.type.equals(var1)) {
            var3.container = null;
            var2.add(var3);
            this.dirty = true;
   ...
   private static final class Predicates {
      final ObjectPool category = new ObjectPool(CategoryPredicate::new);
      final ObjectPool eval = new ObjectPool(EvalPredicate::new);
      final ObjectPool evalArg = new ObjectPool(EvalArgPredicate::new);
      final ObjectPool tag = new ObjectPool(TagPredicate::new);
      final ObjectPool tagEval = new ObjectPool(TagEvalPredicate::new);
      final ObjectPool tagEvalArg = new ObjectPool(TagEvalArgPredicate::new);
      final ObjectPool type = new ObjectPool(TypePredicate::new);
      final ObjectPool typeEval = new ObjectPool(TypeEvalPredicate::new);
      final ObjectPool typeEvalArg = new ObjectPool(TypeEvalArgPredicate::new);
   }
   ...
   private static final class Comparators {
      ObjectPool condition = new ObjectPool(ConditionComparator::new);
      ObjectPool eval = new ObjectPool(EvalComparator::new);
      ObjectPool evalArg = new ObjectPool(EvalArgComparator::new);
   }
