...
public class Noise2D {
   ...
   private float noise(float var1, float var2, int[] var3) {
      int var4 = (int)Math.floor((double)var1 - Math.floor((double)(var1 / 255.0F)) * 255.0);
      int var5 = (int)Math.floor((double)var2 - Math.floor((double)(var2 / 255.0F)) * 255.0);
   ...
   public float layeredNoise(float var1, float var2) {
      ...
      for(int var5 = 0; var5 < this.layers.size(); ++var5) {
         Layer var6 = (Layer)this.layers.get(var5);
         var4 += var6.amp;
   ...
   public void addLayer(int var1, float var2, float var3) {
      int var4 = (int)Math.floor((double)var1 - Math.floor((double)((float)var1 / 256.0F)) * 256.0);
      Layer var5 = new Layer();
      var5.freq = var2;
      var5.amp = var3;

      for(int var6 = 0; var6 < 256; ++var6) {
         int var7 = (int)Math.floor((double)(var4 + var6) - Math.floor((double)((float)(var4 + var6) / 256.0F)) * 256.0);
