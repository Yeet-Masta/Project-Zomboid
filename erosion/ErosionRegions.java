...
public final class ErosionRegions {
   ...
   public static ErosionCategory getCategory(int var0, int var1) {
      return (ErosionCategory)((Region)regions.get(var0)).categories.get(var1);
   }
   ...
   public static void init() {
      ...
      addRegion((new Region(2, (String)null, false, false, true)).addCategory(0, new WallVines()).addCategory(1, new WallCracks()));
      addRegion((new Region(3, (String)null, true, true, false)).addCategory(0, new Flowerbed()));

      for(int var0 = 0; var0 < regions.size(); ++var0) {
         ((Region)regions.get(var0)).init();
      }
   ...
   public static final class Region {
      ...
      public Region addCategory(int var1, ErosionCategory var2) {
         var2.ID = var1;
         var2.region = this;
