...
public abstract class ErosionCategory {
   ...
   public ErosionCategory() {
      for(int var1 = 0; var1 < 6; ++var1) {
         this.seasonDisp[var1] = new SeasonDisplay();
      }

   }

   protected Data getCatModData(ErosionData.Square var1) {
   ...
   protected Data setCatModData(ErosionData.Square var1) {
   ...
   protected float clerp(float var1, float var2, float var3) {
      float var4 = (float)(1.0 - Math.cos((double)var1 * Math.PI)) / 2.0F;
   ...
   public void updateObj(ErosionData.Square var1, Data var2, IsoGridSquare var3, ErosionObj var4, boolean var5, int var6, int var7, boolean var8) {
      if (!var2.hasSpawned) {
