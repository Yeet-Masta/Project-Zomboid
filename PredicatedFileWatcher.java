...
public final class PredicatedFileWatcher {
   ...
   public PredicatedFileWatcher(Predicate var1, IPredicatedFileWatcherCallback var2) {
   ...
   public PredicatedFileWatcher(String var1, Class var2, IPredicatedDataPacketFileWatcherCallback var3) {
      this(var1, (Predicate)null, (IPredicatedFileWatcherCallback)(new GenericPredicatedFileWatcherCallback(var2, var3)));
   }

   public PredicatedFileWatcher(String var1, Predicate var2, IPredicatedFileWatcherCallback var3) {
   ...
   public static class GenericPredicatedFileWatcherCallback implements IPredicatedFileWatcherCallback {
      private final Class m_class;
      private final IPredicatedDataPacketFileWatcherCallback m_callback;

      public GenericPredicatedFileWatcherCallback(Class var1, IPredicatedDataPacketFileWatcherCallback var2) {
         this.m_class = var1;
