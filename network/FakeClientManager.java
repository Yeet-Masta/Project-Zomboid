...
public class FakeClientManager {
   ...
   private static final ThreadLocal stringUTF = ThreadLocal.withInitial(StringUTF::new);
   ...
   public static long getConnectedGUID() {
      return players.isEmpty() ? -1L : ((Player)players.iterator().next()).client.connectionGUID;
   }

   public static long getOnlineID() {
      return players.isEmpty() ? -1L : (long)((Player)players.iterator().next()).OnlineID;
   }
   ...
   public static void main(String[] var0) {
      ...
      if (var4.isStarted()) {
         ...
         if (var2 != -1) {
            ...
            while(var7.hasNext()) {
               Movement var8 = (Movement)var7.next();
   ...
   private static class Movement {
      ...
      private static enum Motion {
         ...
         // $FF: synthetic method
         private static Motion[] $values() {
            return new Motion[]{Aim, Sneak, Walk, SneakRun, Run, Sprint, Pedestrian, Vehicle};
         }
      }
      ...
      private static enum Type {
         ...
         private static Type[] $values() {
            return new Type[]{Stay, Line, Circle, AIAttackZombies, AIRunAwayFromZombies, AIRunToAnotherPlayers, AINormal};
         }
      }
   }
   ...
   private static class Client {
      ...
      private static enum State {
         ...
         private static State[] $values() {
            return new State[]{CONNECT, LOGIN, CHECKSUM, PLAYER_CONNECT, PLAYER_EXTRA_INFO, LOAD, RUN, WAIT, DISCONNECT, QUIT};
         }
      }
   ...
   private static class ZombieSimulator {
      ...
      private static enum Behaviour {
         ...
         private static Behaviour[] $values() {
            return new Behaviour[]{Stay, Normal, Attack};
         }
      }
   }
   ...
   private static class Player {
      ...
      private Player(Movement var1, Network var2, int var3, int var4) {
      ...
      private void teleportMovement() {
         ...
         FakeClientManager.info(this.movement.id, String.format("Player %3d teleport (%9.3f,%9.3f) => (%9.3f,%9.3f) / %9.3f, next in %.3fs", this.OnlineID, this.x, this.y, var1, var2, Math.sqrt(Math.pow((double)(var1 - this.x), 2.0) + Math.pow((double)(var2 - this.y), 2.0)), (float)this.movement.teleportDelay / 1000.0F));
         this.x = var1;
         this.y = var2;
         this.angle = 0.0F;
      ...
      private Zombie getNearestZombie(PlayerManager.RemotePlayer var1) {
         Zombie var2 = null;
         float var3 = Float.POSITIVE_INFINITY;
         Iterator var4 = this.simulator.zombies.values().iterator();

         while(var4.hasNext()) {
            Zombie var5 = (Zombie)var4.next();
      ...
      private PlayerManager.RemotePlayer getNearestPlayer() {
         PlayerManager.RemotePlayer var1 = null;
         float var2 = Float.POSITIVE_INFINITY;
         synchronized(this.playerManager.players) {
            Iterator var4 = this.playerManager.players.values().iterator();

            while(var4.hasNext()) {
               PlayerManager.RemotePlayer var5 = (PlayerManager.RemotePlayer)var4.next();
      ...
      private void aiRunToAnotherPlayersMovement() {
         PlayerManager.RemotePlayer var1 = this.getNearestPlayer();
         float var2 = this.getDistance(this.movement.speed);
         float var3 = this.x + var2 * this.direction.x;
         float var4 = this.y + var2 * this.direction.y;
         if (var1 != null) {
      ...
      private void aiNormalMovement() {
         ...
         PlayerManager.RemotePlayer var2 = this.getNearestPlayer();
         if (var2 == null) {
      ...
      private void decode(ByteBuffer var1) {
         ...
         switch (var2) {
            ...
            case 16:
               ...
               var6 = (Client)this.createdClients.get(var3);
               if (var6 != null) {
            ...
            case 21:
               var3 = var1.get() & 255;
               var4 = this.peer.getGuidOfPacket();
               var6 = (Client)this.connectedClients.get(var4);
               if (var6 != null) {
   ...
   private static class PlayerManager {
      ...
      public PlayerManager(Player var1) {
         this.player = var1;
      }
