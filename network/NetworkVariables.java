...
public class NetworkVariables {
   ...
   public static enum ThumpType {
      ...
      // $FF: synthetic method
      private static ThumpType[] $values() {
         return new ThumpType[]{TTNone, TTDoor, TTClaw, TTBang};
      }
   }
   ...
   public static enum WalkType {
      ...
      // $FF: synthetic method
      private static WalkType[] $values() {
         return new WalkType[]{WT1, WT2, WT3, WT4, WT5, WTSprint1, WTSprint2, WTSprint3, WTSprint4, WTSprint5, WTSlow1, WTSlow2, WTSlow3};
      }
   }
   ...
   public static enum PredictionTypes {
      ...
      // $FF: synthetic method
      private static PredictionTypes[] $values() {
         return new PredictionTypes[]{None, Moving, Static, Thump, Climb, Lunge, LungeHalf, Walk, WalkHalf, PathFind};
      }
   }
}
