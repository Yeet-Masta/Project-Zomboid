...
public class CoopMaster {
   ...
   public synchronized void invokeServer(String var1, String var2, ICoopServerMessageListener var3) {
      ...
      this.addListener(var3, new ListenerOptions(var1, var4, true));
   ...
   public void addListener(ICoopServerMessageListener var1, ListenerOptions var2) {
      synchronized(this.listeners) {
         this.listeners.add(new Pair(var1, var2));
      }
   }

   public void addListener(ICoopServerMessageListener var1) {
      this.addListener(var1, (ListenerOptions)null);
   }

   public void removeListener(ICoopServerMessageListener var1) {
      synchronized(this.listeners) {
         int var3;
         for(var3 = 0; var3 < this.listeners.size() && ((Pair)this.listeners.get(var3)).first != var1; ++var3) {
         }
         ...
         while(true) {
            while(true) {
               ...
               do {
                  ...
                  var8 = (ListenerOptions)var6.second;
               } while(var7 == null);
   ...
   public static enum TerminationReason {
      ...
      // $FF: synthetic method
      private static TerminationReason[] $values() {
         return new TerminationReason[]{NormalTermination, Timeout};
      }
   }
