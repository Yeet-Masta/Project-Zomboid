...
public class GameServerWorkshopItems {
            ...
            if (var8.isCompleted()) {
               ...
               while(true) {
                  while(var9.hasNext()) {
                     ...
                     while(var5.hasNext()) {
                        WorkshopItem var6 = (WorkshopItem)var5.next();
   ...
   private static enum WorkshopInstallState {
      ...
      // $FF: synthetic method
      private static WorkshopInstallState[] $values() {
         return new WorkshopInstallState[]{CheckItemState, DownloadPending, Ready, Fail};
      }
   }
