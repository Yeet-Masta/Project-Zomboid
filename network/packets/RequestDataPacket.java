...
public class RequestDataPacket implements INetworkPacket {
   ...
   static enum RequestType {
      ...
      private static RequestType[] $values() {
         return new RequestType[]{None, Request, FullData, PartData, PartDataACK};
      }
   }
   ...
   public static enum RequestID {
      ...
      // $FF: synthetic method
      private static RequestID[] $values() {
         return new RequestID[]{ConnectionDetails, Descriptors, MetaGrid, MapZone, PlayerZombieDescriptors, RadioData};
      }
   }
}
