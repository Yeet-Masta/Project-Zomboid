...
public abstract class HitCharacterPacket implements INetworkPacket {
   ...
   public static enum HitType {
      ...
      // $FF: synthetic method
      private static HitType[] $values() {
         return new HitType[]{Min, PlayerHitSquare, PlayerHitVehicle, PlayerHitZombie, PlayerHitPlayer, ZombieHitPlayer, VehicleHitZombie, VehicleHitPlayer, Max};
      }
   }
}
