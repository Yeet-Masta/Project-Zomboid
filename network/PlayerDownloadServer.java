...
public final class PlayerDownloadServer {
   ...
   private final class WorkerThread extends Thread {
      ...
      private void runInner() throws InterruptedException, IOException {
         ...
         WorkerThreadCommand var1 = (WorkerThreadCommand)this.commandQ.take();
   ...
   private static enum EThreadCommand {
      ...
      // $FF: synthetic method
      private static EThreadCommand[] $values() {
         return new EThreadCommand[]{RequestLargeArea, RequestZipArray, Quit};
      }
   }
