...
public class RCONServer {
   ...
   private void updateMain() {
      for(ExecCommand var1 = (ExecCommand)this.toMain.poll(); var1 != null; var1 = (ExecCommand)this.toMain.poll()) {
         var1.update();
      }
   ...
   private class ServerThread extends Thread {
      ...
      private void runInner() {
         try {
            ...
            for(int var2 = 0; var2 < this.connections.size(); ++var2) {
               ClientThread var3 = (ClientThread)this.connections.get(var2);
               if (!var3.isAlive()) {
      ...
      public void quit() {
         ...
         for(int var1 = 0; var1 < this.connections.size(); ++var1) {
            ClientThread var2 = (ClientThread)this.connections.get(var1);
            var2.quit();
         }
   ...
   private static class ExecCommand {
      ...
      public ExecCommand(int var1, String var2, ClientThread var3) {
         this.ID = var1;
         this.command = var2;
         this.thread = var3;
      }
            ...
            case 2:
               ...
               while(true) {
                  while(this.pendingCommands > 0) {
                     var5 = (ExecCommand)this.toThread.poll();
                     if (var5 != null) {
                        --this.pendingCommands;
