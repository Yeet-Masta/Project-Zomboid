...
public class Userlog {
   ...
   public static enum UserlogType {
      ...
      // $FF: synthetic method
      private static UserlogType[] $values() {
         return new UserlogType[]{AdminLog, Kicked, Banned, DupeItem, LuaChecksum, WarningPoint, UnauthorizedPacket, SuspiciousActivity};
      }
   }
}
