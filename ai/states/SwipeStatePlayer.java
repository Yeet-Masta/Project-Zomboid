...
public final class SwipeStatePlayer extends State {
   ...
   public int CalcHitChance(IsoGameCharacter var1, HandWeapon var2, HitInfo var3) {
      ...
      if (var4 == null) {
         ...
         } else if ((double)var14 < 1.7 && var2.isRanged() && !(var4 instanceof IsoPlayer)) {
            var13 += 35;
         }
            ...
            if (!this.isWindowBetween(var1, var17)) {
               ...
               if (var21) {
                  ...
                  for(int var27 = 0; var27 < this.dotList.size(); ++var27) {
                     ...
                     if ((double)Math.abs(var26 - var28) < 1.0E-4) {
                        var25 = false;
                     }
                  }

                  float var49 = var2.getMinDamage();
                  ...
                  if (var2.isRanged() && var19 != null) {
                     Vector2 var52 = tempVector2_1.set(var1.getX(), var1.getY());
                     ...
                     var19.setHitFromBehind((double)var34 > 0.5);
                  }
                  ...
                  float var51 = var28 - var49;
                  float var50;
                  if (var51 == 0.0F) {
                     var50 = var49 + 0.0F;
                  } else {
                     var50 = var49 + (float)Rand.Next((int)(var51 * 1000.0F)) / 1000.0F;
                  }

                  if (!var2.isRanged()) {
                     var50 *= var2.getDamageMod(var1) * var1.getHittingMod();
                  }

                  if (!var53 && !var2.isRanged() && var28 > var49) {
                     var50 -= var49;
                  }
                  ...
                  if (var1.isAimAtFloor() && var4.bDoShove) {
                     ...
                     if (var34 > 10.0F) {
                        var50 /= PZMath.clamp(var34 / 10.0F, 1.0F, 30.0F);
                  ...
                  if (var19 != null) {
                     ...
                     int var56;
                     if (var14 > 0) {
                        var56 = Rand.Next(BodyPartType.ToIndex(BodyPartType.Head), BodyPartType.ToIndex(BodyPartType.Neck) + 1);
                     } else if (var15) {
                        var56 = Rand.Next(BodyPartType.ToIndex(BodyPartType.Groin), BodyPartType.ToIndex(BodyPartType.Foot_R) + 1);
                     } else {
                        var56 = Rand.Next(BodyPartType.ToIndex(BodyPartType.Hand_L), BodyPartType.ToIndex(BodyPartType.Neck) + 1);
                     }

                     float var40 = var19.getBodyPartClothingDefense(var56, false, var2.isRanged()) / 2.0F;
                     var40 += var19.getBodyPartClothingDefense(var56, true, var2.isRanged());
                     if (var40 > 70.0F) {
                        var40 = 70.0F;
                     }
                  ...
                  float var57 = 0.0F;
                  boolean var58 = var1.isCriticalHit();
                  if (var18 == null && var17.getSquare() != null && var1.getSquare() != null) {
                     ...
                     if (((IsoPlayer)var1).isLocalPlayer() || var1.isNPC()) {
                        var57 = var17.Hit(var2, var1, var34, var6, var38);
                     ...
                     VehiclePart var59 = var18.getNearestBodyworkPart(var1);
                     if (var59 != null) {
                        VehicleWindow var60 = var59.getWindow();

                        for(var43 = 0; var43 < var59.getChildCount(); ++var43) {
                           VehiclePart var61 = var59.getChild(var43);
                           if (var61.getWindow() != null) {
                              var60 = var61.getWindow();
                              break;
                           }
                        }

                        if (var60 != null && var60.isHittable()) {
                           ...
                           var59.setCondition(var59.getCondition() - var43);
                  ...
                  if (GameClient.bClient && var1.isLocal()) {
                     ...
                     var46 = GameClient.sendHitCharacter(var1, var17, var2, var57, var6, var38, var58, var8, var14 > 0);
                  }
               }
            }
         }
