...
public final class CollisionManager {
   ...
   public void initUpdate() {
      ...
      for(var1 = 0; var1 < this.ContactMap.size(); ++var1) {
         ((Contact)this.ContactMap.get(var1)).a = null;
         ((Contact)this.ContactMap.get(var1)).b = null;
         this.contacts.push((Contact)this.ContactMap.get(var1));
      }
   ...
   Contact contact(IsoMovingObject var1, IsoMovingObject var2) {
      if (this.contacts.isEmpty()) {
         for(int var3 = 0; var3 < 50; ++var3) {
            this.contacts.push(new Contact((IsoMovingObject)null, (IsoMovingObject)null));
         }
      }

      Contact var4 = (Contact)this.contacts.pop();
      var4.a = var1;
      var4.b = var2;
      return var4;
   }
