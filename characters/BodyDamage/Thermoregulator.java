...
public final class Thermoregulator {
   ...
   private void initNodes() {
      ...
      for(var2 = 0; var2 < this.bodyDamage.getBodyParts().size(); ++var2) {
         ...
         switch (var3.getType()) {
            case Torso_Upper:
               var4 = new ThermalNode(true, 37.0F, var3, 0.25F);
               this.core = var4;
               break;
            case Head:
               var4 = new ThermalNode(37.0F, var3, 1.0F);
               break;
            case Neck:
               var4 = new ThermalNode(37.0F, var3, 0.5F);
               break;
            case Torso_Lower:
               var4 = new ThermalNode(37.0F, var3, 0.25F);
               break;
            case Groin:
               var4 = new ThermalNode(37.0F, var3, 0.5F);
               break;
      ...
      for(var2 = 0; var2 < this.nodes.length; ++var2) {
         ThermalNode var7 = this.nodes[var2];
         ...
         if (var5 != null && var5.length > 0) {
            var7.downstream = new ThermalNode[var5.length];
   ...
   private void updateNodesHeatDelta() {
      float var1 = PZMath.clamp_01((float)((this.player.getNutrition().getWeight() / 75.0 - 0.5) * 0.6660000085830688));
      var1 = (var1 - 0.5F) * 2.0F;
   ...
   private void updateHeatDeltas() {
      ...
      ThermalNode var10000 = this.core;
            ...
            if (var4 instanceof Clothing) {
               ...
               if (var5.getInsulation() > 0.0F || var5.getWindresistance() > 0.0F) {
                  ...
                  if (!var6 && var5.getBodyLocation() != null) {
                     switch (var5.getBodyLocation().toLowerCase()) {
                        case "hat":
                        case "mask":
   ...
   private static enum Multiplier {
      ...
      // $FF: synthetic method
      private static Multiplier[] $values() {
         return new Multiplier[]{Default, MetabolicRateInc, MetabolicRateDec, BodyHeat, CoreHeatExpand, CoreHeatContract, SkinCelcius, SkinCelciusContract, SkinCelciusExpand, PrimaryDelta, SecondaryDelta};
      }
   }
}
