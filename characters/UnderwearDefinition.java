   ...
   private void init() {
      ...
      if (var1 != null) {
         ...
         while(true) {
            ...
            OutfitUnderwearDefinition var8 = new OutfitUnderwearDefinition(var3, var4.rawgetStr("bottom"), var4.rawgetInt("chanceToSpawn"), var4.rawgetStr("gender"));
      ...
      public OutfitUnderwearDefinition(ArrayList var1, String var2, int var3, String var4) {
         ...
         if (var1 != null) {
            for(int var5 = 0; var5 < var1.size(); ++var5) {
               this.topTotalChance = (int)((float)this.topTotalChance + ((StringChance)var1.get(var5)).chance);
            }
         }
