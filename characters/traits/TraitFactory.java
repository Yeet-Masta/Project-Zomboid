...
public final class TraitFactory {
   ...
   public static void setMutualExclusive(String var0, String var1) {
      ((Trait)TraitMap.get(var0)).MutuallyExclusive.add(var1);
      ((Trait)TraitMap.get(var1)).MutuallyExclusive.add(var0);
   }

   public static void sortList() {
      LinkedList var0 = new LinkedList(TraitMap.entrySet());
      Collections.sort(var0, new Comparator() {
         public int compare(Map.Entry var1, Map.Entry var2) {
   ...
   public static Trait getTrait(String var0) {
      return TraitMap.containsKey(var0) ? (Trait)TraitMap.get(var0) : null;
   }
