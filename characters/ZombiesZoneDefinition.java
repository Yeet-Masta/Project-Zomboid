...
public final class ZombiesZoneDefinition {
   ...
   public static PickDefinition pickDefinition(int var0, int var1, int var2, boolean var3) {
      ...
      if (var4 == null) {
         ...
         if (var6 == null) {
            ...
            ZZDZone var8 = (ZZDZone)s_zoneMap.get(var7);
            if (var8 == null) {
               return null;
            } else {
               ...
               if (var6 == null) {
                  ...
                  ZZDOutfit var23;
                  if (!var20.isEmpty()) {
                     var23 = (ZZDOutfit)PZArrayUtil.pickRandom((List)var20);
                  } else {
   ...
   public static Outfit getRandomDefaultOutfit(boolean var0, String var1) {
      ...
      ZZDZone var5 = (ZZDZone)s_zoneMap.get("Default");

      ZZDOutfit var3;
      for(int var6 = 0; var6 < var5.outfits.size(); ++var6) {
         var3 = (ZZDOutfit)var5.outfits.get(var6);
   ...
   public static ZZDOutfit getRandomOutfitInSetList(ArrayList var0, boolean var1) {
      float var2 = 0.0F;
   ...
   public static void registerCustomOutfits() {
      ...
      while(var0.hasNext()) {
         ZZDZone var1 = (ZZDZone)var0.next();
         Iterator var2 = var1.outfits.iterator();

         while(var2.hasNext()) {
            ZZDOutfit var3 = (ZZDOutfit)var2.next();
   ...
   private static void ApplyCustomOutfit(int var0, String var1, IsoGameCharacter var2) {
      ZZDOutfit var3 = (ZZDOutfit)s_customOutfitMap.get(var1);
