...
public final class Faction {
   ...
   public static boolean canCreateFaction(IsoPlayer var0) {
      ...
      if (var1 && ServerOptions.instance.FactionDaySurvivedToCreate.getValue() > 0 && var0.getHoursSurvived() / 24.0 < (double)ServerOptions.instance.FactionDaySurvivedToCreate.getValue()) {
         var1 = false;
      }
