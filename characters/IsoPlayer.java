...
public final class IsoPlayer extends IsoLivingCharacter implements IHumanVisual {
   ...
   public float getTurnDelta() {
      return DebugOptions.instance.CheatPlayerInvisibleSprint.getValue() && this.isGhostMode() && (this.isRunning() || this.isSprinting()) ? 10.0F : super.getTurnDelta();
   }
   ...
   public void load(ByteBuffer var1, int var2, boolean var3) throws IOException {
      ...
      for(int var10 = 0; var10 < var8; ++var10) {
         ...
         var9 = var1.getShort();
         if (var9 >= 0 && var9 < var7.size() && this.wornItems.getBodyLocationGroup().getLocation(var11) != null) {
            this.wornItems.setItem(var11, (InventoryItem)var7.get(var9));
         }
      }

      short var17 = var1.getShort();
      if (var17 >= 0 && var17 < var7.size()) {
         this.leftHandItem = (InventoryItem)var7.get(var17);
      }

      var17 = var1.getShort();
      if (var17 >= 0 && var17 < var7.size()) {
         this.rightHandItem = (InventoryItem)var7.get(var17);
      }
      ...
      if (var2 >= 184) {
         ...
         for(var12 = 0; var12 < var13; ++var12) {
            ...
            String var15 = WorldDictionary.getItemTypeFromID(var14);
            if (var15 != null) {
               this.alreadyReadBook.add(var15);
            }
         }
      } else if (var2 >= 182) {
         var9 = var1.getInt();
   ...
   private void updateCursorVisibility() {
      if (this.isAiming() && this.PlayerIndex == 0 && this.JoypadBind == -1 && !this.isDead() && !Core.getInstance().getOptionShowCursorWhileAiming() && Core.getInstance().getIsoCursorVisibility() != 0 && !UIManager.isForceCursorVisible()) {
         int var1 = Mouse.getXA();
         int var2 = Mouse.getYA();
         if (var1 >= IsoCamera.getScreenLeft(0) && var1 <= IsoCamera.getScreenLeft(0) + IsoCamera.getScreenWidth(0) && var2 >= IsoCamera.getScreenTop(0) && var2 <= IsoCamera.getScreenTop(0) + IsoCamera.getScreenHeight(0)) {
   ...
   private void updateMovementFromInput(MoveVars var1) {
      ...
      if (!TutorialManager.instance.StealControl && !this.isBlockMovement() && !this.isNPC && !MPDebugAI.updateMovementFromInput(this, var1) && !(this.fallTime > 2.0F)) {
         if (GameWindow.ActivatedJoyPad != null && this.JoypadBind != -1) {
   ...
   private void updateMovementFromJoypad(MoveVars var1) {
      ...
      if (var2 == 0.0F && var3 == 0.0F) {
         ...
         Vector2 var8 = tempVector2.set(var2, var3);
         var8.normalize();
         var1.NewFacing = IsoDirections.fromAngle(var8);
      }

      PathFindBehavior2 var10 = this.getPathFindBehavior2();
      if (this.playerMoveDir.x == 0.0F && this.playerMoveDir.y == 0.0F && this.getPath2() != null && var10.isStrafing() && !var10.bStopping) {
      ...
      if (this.playerMoveDir.x != 0.0F || this.playerMoveDir.y != 0.0F) {
         if (this.isStrafing()) {
            ...
            tempo.normalize();
            float var9 = this.legsSprite.modelSlot.model.AnimPlayer.getRenderedAngle();
            if ((double)var9 > 6.283185307179586) {
               var9 = (float)((double)var9 - 6.283185307179586);
            }
   ...
   protected void updateStats_Sleeping() {
      ...
      var2.endurance = (float)((double)var2.endurance + ZomboidGlobals.ImobileEnduranceReduce * SandboxOptions.instance.getEnduranceRegenMultiplier() * (double)this.getRecoveryMod() * (double)GameTime.instance.getMultiplier() * (double)var1);
      ...
      if (this.stats.fatigue > 0.0F) {
         ...
         float var5 = 1.0F / GameTime.instance.getMinutesPerDay() / 60.0F * GameTime.instance.getMultiplier() / 2.0F;
         this.timeOfSleep += var5;
         if (this.timeOfSleep > this.delayToActuallySleep) {
            ...
            if (this.stats.fatigue <= 0.3F) {
               var7 = 7.0F * var6;
               var2 = this.stats;
               var2.fatigue -= var5 / var7 * 0.3F * var3 * var4;
            } else {
               var7 = 5.0F * var6;
               var2 = this.stats;
               var2.fatigue -= var5 / var7 * 0.7F * var3 * var4;
            }
         }
      ...
      if (this.Moodles.getMoodleLevel(MoodleType.FoodEaten) == 0) {
         var3 = this.getAppetiteMultiplier();
         var2 = this.stats;
         var2.hunger = (float)((double)var2.hunger + ZomboidGlobals.HungerIncreaseWhileAsleep * SandboxOptions.instance.getStatsDecreaseMultiplier() * (double)var3 * (double)GameTime.instance.getMultiplier() * (double)GameTime.instance.getDeltaMinutesPerDay() * this.getHungerMultiplier());
      } else {
         var2 = this.stats;
         var2.hunger += (float)(ZomboidGlobals.HungerIncreaseWhenWellFed * SandboxOptions.instance.getStatsDecreaseMultiplier() * ZomboidGlobals.HungerIncreaseWhileAsleep * SandboxOptions.instance.getStatsDecreaseMultiplier() * (double)GameTime.instance.getMultiplier() * this.getHungerMultiplier() * (double)GameTime.instance.getDeltaMinutesPerDay());
      }
      ...
      var3 = GameTime.getInstance().getTimeOfDay();
      var4 = GameTime.getInstance().getLastTimeOfDay();
      if (var4 > var3) {
         if (var4 < this.ForceWakeUpTime) {
            var3 += 24.0F;
         } else {
            var4 -= 24.0F;
         }
      ...
      boolean var8 = var3 >= this.ForceWakeUpTime && var4 < this.ForceWakeUpTime;
      if (this.getAsleepTime() > 16.0F) {
         var8 = true;
      }

      if (GameClient.bClient || numPlayers > 1) {
         var8 = var8 || this.pressedAim() || this.pressedMovement(false);
      }
   ...
   public void updateEnduranceWhileSitting() {
      ...
      Stats var2 = this.stats;
      var2.endurance = (float)((double)var2.endurance + ZomboidGlobals.ImobileEnduranceReduce * SandboxOptions.instance.getEnduranceRegenMultiplier() * (double)this.getRecoveryMod() * (double)var1);
      this.stats.endurance = PZMath.clamp(this.stats.endurance, 0.0F, 1.0F);
   }
      ...
      if (this.isSitOnGround()) {
         ...
         if (!(this.CurrentSpeed > 0.0F) || !this.isRunning() && !this.isSprinting()) {
            if (this.CurrentSpeed > 0.0F && this.Moodles.getMoodleLevel(MoodleType.HeavyLoad) > 2) {
               ...
               var10 *= 3.0F;
               var10 *= this.getPacingMod();
               var10 *= this.getHyperthermiaMod();
               var4 = 2.8F;
               ...
               var3 = this.stats;
               var3.endurance = (float)((double)var3.endurance - ZomboidGlobals.RunningEnduranceReduce * (double)var10 * 0.5 * (double)var5 * (double)var2 * (double)GameTime.instance.getMultiplier() * (double)var4 / 2.0);
            }
         } else {
            double var6 = ZomboidGlobals.RunningEnduranceReduce;
            if (this.isSprinting()) {
               var6 = ZomboidGlobals.SprintingEnduranceReduce;
            }
            ...
            if (this.Moodles.getMoodleLevel(MoodleType.HeavyLoad) == 0) {
               var3 = this.stats;
               var3.endurance = (float)((double)var3.endurance - var6 * (double)var4 * 0.5 * (double)var8 * (double)GameTime.instance.getMultiplier() * (double)var2);
            } else {
               float var9 = 2.8F;
               switch (this.Moodles.getMoodleLevel(MoodleType.HeavyLoad)) {
                  case 1:
               ...
               var3 = this.stats;
               var3.endurance = (float)((double)var3.endurance - var6 * (double)var4 * 0.5 * (double)var8 * (double)GameTime.instance.getMultiplier() * (double)var9 * (double)var2);
            }
         }
         ...
         if (!this.isPlayerMoving()) {
            var5 = 1.0F;
            var5 *= 1.0F - this.stats.fatigue;
            var5 *= GameTime.instance.getMultiplier();
            if (this.Moodles.getMoodleLevel(MoodleType.HeavyLoad) <= 1) {
               var3 = this.stats;
               var3.endurance = (float)((double)var3.endurance + ZomboidGlobals.ImobileEnduranceReduce * SandboxOptions.instance.getEnduranceRegenMultiplier() * (double)this.getRecoveryMod() * (double)var5);
            }
         }
         ...
         if (!this.isSprinting() && !this.isRunning() && this.CurrentSpeed > 0.0F) {
            ...
            if (this.getMoodles().getMoodleLevel(MoodleType.Endurance) < 2) {
               if (this.Moodles.getMoodleLevel(MoodleType.HeavyLoad) <= 1) {
                  var3 = this.stats;
                  var3.endurance = (float)((double)var3.endurance + ZomboidGlobals.ImobileEnduranceReduce / 4.0 * SandboxOptions.instance.getEnduranceRegenMultiplier() * (double)this.getRecoveryMod() * (double)var5);
               }
            } else {
               var3 = this.stats;
               var3.endurance = (float)((double)var3.endurance - ZomboidGlobals.RunningEnduranceReduce / 7.0 * (double)var2);
            }
         }
      }
   ...
   private void updateSneakKey() {
      ...
      } else if (!this.isBlockMovement() && GameKeyboard.isKeyDown(Core.getInstance().getKey("Crouch"))) {
      ...
      if (Core.bDebug) {
         if (this.PlayerIndex == 0 && GameKeyboard.isKeyDown(22)) {
            if (!this.bChangeCharacterDebounce) {
               ...
               for(int var1 = 0; var1 < this.getCell().getObjectList().size(); ++var1) {
                  IsoMovingObject var2 = (IsoMovingObject)this.getCell().getObjectList().get(var1);
                  if (var2 instanceof IsoSurvivor) {
                     this.FollowCamStack.add((IsoSurvivor)var2);
                  }
               }
   ...
   private void updateDeathDragDown() {
      if (!this.isDead() && this.isDeathDragDown()) {
         if (this.isGodMod()) {
   ...
   private void highlightRangedTargets() {
      if (this.isLocalPlayer() && !this.isNPC && this.isAiming() && Core.getInstance().getOptionAimOutline() != 1) {
   ...
   public boolean isPushedByForSeparate(IsoMovingObject var1) {
      if (!this.isPlayerMoving() && var1.isZombie() && ((IsoZombie)var1).isAttacking()) {
         ...
         return GameClient.bClient && (!this.isLocalPlayer() || !this.isJustMoved()) ? false : super.isPushedByForSeparate(var1);
      }
   }
   ...
   private void updateExt() {
      if (!this.isSneaking()) {
         ...
         if (!(this.extUpdateCount <= 5000.0F)) {
            this.extUpdateCount = 0.0F;
            if (this.stats.NumVisibleZombies == 0 && this.stats.NumChasingZombies == 0 && Rand.NextBool(3) && (this.getAdvancedAnimator().containsAnyIdleNodes() || this.isSitOnGround())) {
      ...
      if (var1.getMoodleLevel(MoodleType.Hypothermia) > 0 && Rand.NextBool(7)) {
         ...
         if (var1.getMoodleLevel(MoodleType.Sick) > 0 && Rand.NextBool(7)) {
            if (Rand.NextBool(4)) {
               ...
               var3 = Rand.Next(2);
               this.setVariable("Ext", "PainStomach" + (var3 + 1));
            }
            ...
            if (var2.areBodyPartsBleeding(BodyPartType.Head, BodyPartType.Neck) && Rand.NextBool(2)) {
               ...
               var3 = Rand.Next(2);
               this.setVariable("Ext", "PainHead" + (var3 + 1));
            }
   ...
   private void updateHitByVehicle() {
      if (!GameServer.bServer && this.isLocalPlayer() && this.vehicle4testCollision != null && this.ulBeatenVehicle.Check() && SandboxOptions.instance.DamageToPlayerFromHitByACar.getValue() > 1) {
   ...
   public void pressedAttack(boolean var1) {
      ...
      this.setSprinting(false);
      this.setForceSprint(false);
      if (!this.attackStarted && !this.isCurrentState(PlayerHitReactionState.instance()) && (!GameClient.bClient || !this.isCurrentState(PlayerHitReactionPVPState.instance()) || ServerOptions.instance.PVPMeleeWhileHitReaction.getValue())) {
   ...
   private void UpdateInputState(InputState var1) {
      ...
      if (!MPDebugAI.updateInputState(this, var1)) {
         ...
         if (GameWindow.ActivatedJoyPad != null && this.JoypadBind != -1) {
            ...
            Vector2 var10 = this.getJoypadAimVector(tempVector2);
            if (var10.x == 0.0F && var10.y == 0.0F) {
               ...
               if (var11.x != 0.0F || var11.y != 0.0F) {
                  ...
                  var1.isCharging = false;
                  var8 = JoypadManager.instance.isBPressed(this.JoypadBind);
                  if (var1.bRunning && var8 && !this.bJoypadBDown) {
                     this.bJoypadSprint = !this.bJoypadSprint;
                  }

                  this.bJoypadBDown = var8;
            ...
            int var9 = Core.getInstance().getKey("Run");
            int var4 = Core.getInstance().getKey("Sprint");
            if (this.isAllowRun()) {
               var1.bRunning = GameKeyboard.isKeyDown(var9);
            }

            if (this.isAllowSprint()) {
               if (!Core.OptiondblTapJogToSprint) {
                  if (GameKeyboard.isKeyDown(var4)) {
                  ...
                  if (!GameKeyboard.wasKeyDown(var9) && GameKeyboard.isKeyDown(var9) && this.pressedRunTimer < 30.0F && this.pressedRun) {
                     var1.bSprinting = true;
                  }

                  if (GameKeyboard.wasKeyDown(var9) && !GameKeyboard.isKeyDown(var9)) {
                     var1.bSprinting = false;
            ...
            if (this.PlayerIndex == 0 && Core.getInstance().isToggleToRun()) {
               var8 = GameKeyboard.isKeyDown(var9);
               var5 = GameKeyboard.wasKeyDown(var9);
               var6 = System.currentTimeMillis();
               if (var8 && !var5) {
                  this.runKeyDownMS = var6;
               } else if (!var8 && var5 && var6 - this.runKeyDownMS < 500L) {
                  this.toggleForceRun();
               }
            }

            if (this.PlayerIndex == 0 && Core.getInstance().isToggleToSprint()) {
               var8 = GameKeyboard.isKeyDown(var4);
               var5 = GameKeyboard.wasKeyDown(var4);
               var6 = System.currentTimeMillis();
               if (var8 && !var5) {
                  this.sprintKeyDownMS = var6;
               } else if (!var8 && var5 && var6 - this.sprintKeyDownMS < 500L) {
   ...
   private void updateWhileInVehicle() {
      ...
      if (GameClient.bClient && this.getVehicle().getSeat(this) == -1) {
         ...
         if (!this.Asleep) {
            ...
            Stats var11 = this.stats;
            var11.endurance = (float)((double)var11.endurance + ZomboidGlobals.ImobileEnduranceReduce * SandboxOptions.instance.getEnduranceRegenMultiplier() * (double)this.getRecoveryMod() * (double)var12);
            this.stats.endurance = PZMath.clamp(this.stats.endurance, 0.0F, 1.0F);
         }
         ...
         if (this.vehicle != null) {
            ...
            boolean var13 = this.isAimControlActive();
            if (this.PlayerIndex == 0) {
               if (Mouse.isButtonDown(1)) {
                  this.TimeRightPressed += GameTime.getInstance().getRealworldSecondsSinceLastUpdate();
               } else {
               ...
               var13 |= Mouse.isButtonDownUICheck(1) && this.TimeRightPressed >= 0.15F;
            }

            if (!var13 && this.isCurrentState(IdleState.instance())) {
      ...
      if (this.current != null && var1 != null) {
         ...
         switch (var1) {
            ...
            case S:
               ...
               if (var2 != null) {
                  var4 = this.current.isBlockedTo(var2);
            ...
            case E:
               ...
               if (var2 != null) {
                  var4 = this.current.isBlockedTo(var2);
                  var3 = var2.getDoorOrWindowOrWindowFrame(IsoDirections.W, var4);
                  if (var3 != null) {
                     return var3;
                  }
   ...
   private void doContextDoorOrWindowOrWindowFrame(IsoDirections var1, IsoObject var2) {
      ...
      if (var2 instanceof IsoDoor var5) {
         ...
         if (var2 instanceof IsoThumpable var6) {
            if (((IsoThumpable)var2).isDoor()) {
               if (this.timePressedContext >= 0.5F) {
                  if (var6.isHoppable() && !this.isIgnoreAutoVault()) {
                     this.climbOverFence(var1);
                  } else {
         ...
         IsoCurtain var7;
         if (var2 instanceof IsoWindow var8) {
            if (!var2.getSquare().getProperties().Is(IsoFlagType.makeWindowInvincible)) {
               if (GameKeyboard.isKeyDown(42)) {
                  var7 = var8.HasCurtains();
                  ...
                  } else if (!var8.PermaLocked && !var8.isBarricaded() && !var8.IsOpen() && !var8.isDestroyed()) {
                  ...
                  IsoBarricade var11 = var8.getBarricadeForCharacter(this);
                  if (!var8.open && var11 == null) {
                     this.openWindow(var8);
                  } else if (var11 == null) {
         ...
         if (var2 instanceof IsoThumpable var9) {
            if (!var2.getSquare().getProperties().Is(IsoFlagType.makeWindowInvincible)) {
               if (GameKeyboard.isKeyDown(42)) {
                  var7 = var9.HasCurtains();
                  if (var7 != null && this.current != null && !var7.getSquare().isBlockedTo(this.current)) {
                     var7.ToggleDoor(this);
                     return;
                  }
         ...
         if (IsoWindowFrame.isWindowFrame(var2)) {
            if (GameKeyboard.isKeyDown(42)) {
               IsoCurtain var10 = IsoWindowFrame.getCurtain(var2);
               if (var10 != null && this.current != null && !var10.getSquare().isBlockedTo(this.current)) {
   ...
   public boolean hopFence(IsoDirections var1, boolean var2) {
      float var3 = this.x - (float)((int)this.x);
      float var4 = this.y - (float)((int)this.y);
      if (var1 == IsoDirections.NW) {
         if (var4 < var3) {
         ...
         IsoGridSquare var5 = this.current.nav[var1.index()];
         if (var5 != null && !var5.Is(IsoFlagType.water)) {
   ...
   public void updateLOS() {
      ...
      if (this.getCurrentSquare() != null) {
                           ...
                           if (!this.isAsleep() && (var23 || var16 < var21 && var22)) {
                              ...
                              if (var18 != null && var18.IsVisibleToPlayer[var3]) {
                                 ...
                                 if (var16 < var24 && var18 instanceof IsoZombie && (int)var15 == (int)var7 && !this.LastSpotted.contains(var18)) {
                                    Stats var25 = this.stats;
                                    var25.NumVisibleZombies += 2;
                                 }
                              }
                           } else {
                              if (var12 != instance) {
         ...
         if (this.isAlive() && var9 > 0 && this.stats.LastVeryCloseZombies == 0 && this.stats.NumVisibleZombies > 0 && this.stats.LastNumVisibleZombies == 0 && this.timeSinceLastStab >= 600.0F) {
            this.timeSinceLastStab = 0.0F;
            long var26 = this.getEmitter().playSoundImpl("ZombieSurprisedPlayer", (IsoObject)null);
            this.getEmitter().setVolume(var26, (float)Core.getInstance().getOptionJumpScareVolume() / 10.0F);
         }
         ...
         float var27 = (float)var8 / 20.0F;
         if (var27 > 1.0F) {
            var27 = 1.0F;
         }

         var27 *= 0.6F;
         SoundManager.instance.BlendVolume(MainScreenState.ambient, var27);
         int var28 = 0;

         for(int var29 = 0; var29 < this.spottedList.size(); ++var29) {
            if (!this.LastSpotted.contains(this.spottedList.get(var29))) {
               this.LastSpotted.add((IsoMovingObject)this.spottedList.get(var29));
            }
               ...
               if (!var7.bCouldSee()) {
                  ...
                  if (var1.spottedByPlayer) {
                     ...
                     for(int var20 = 0; var20 < var14.size(); ++var20) {
                        PolygonalMap2.Point var21 = (PolygonalMap2.Point)var14.get(var20);
                        var15 = IsoCell.getInstance().getGridSquare((double)var21.x, (double)var21.y, (double)this.getZ());
                        if (var15 != null) {
                           var19 = var15.getGridSneakModifier(false);
                           if (var19 > 1.0F) {
                              var18 = true;
                              break;
                           }
                     ...
                     var19 = var10 * var8 * var11 * var9 * var12 * var13 * var24 * var25;
                     if (var19 >= 1.0F) {
                        var1.spottedByPlayer = true;
                        return true;
                     } else {
                        var19 = (float)(1.0 - Math.pow((double)(1.0F - var19), (double)GameTime.getInstance().getMultiplier()));
                        var19 *= 0.5F;
                        boolean var26 = Rand.Next(0.0F, 1.0F) < var19;
   ...
   public String getUsername(Boolean var1) {
      ...
      if (var1 && GameClient.bClient && ServerOptions.instance.ShowFirstAndLastName.getValue() && this.isAccessLevel("None")) {
         String var3 = this.getDescriptor().getForename();
         var2 = var3 + " " + this.getDescriptor().getSurname();
   ...
   public void updateUsername() {
      if (!GameClient.bClient && !GameServer.bServer) {
         String var1 = this.getDescriptor().getForename();
         this.username = var1 + this.getDescriptor().getSurname();
      }
         ...
         if (GameClient.bClient) {
            ...
            if (!this.networkAI.needToMovingUsingPathFinder && !this.networkAI.forcePathFinder) {
               ...
               if (this.getCurrentState() != ClimbOverWallState.instance() && this.getCurrentState() != ClimbOverFenceState.instance()) {
                  var10 = IsoUtils.DistanceTo(this.x, this.y, this.networkAI.targetX, this.networkAI.targetY) / IsoUtils.DistanceTo(this.realx, this.realy, this.networkAI.targetX, this.networkAI.targetY);
                  float var12 = 0.8F + 0.4F * IsoUtils.smoothstep(0.8F, 1.2F, var10);
                  var4.moveToPoint(var1, var2, var12);
               } else {
               ...
               PathFindBehavior2.BehaviorResult var11 = var4.update();
               if (var11 == PathFindBehavior2.BehaviorResult.Failed) {
               ...
               } else if (var11 == PathFindBehavior2.BehaviorResult.Succeeded) {
                  int var8 = (int)var4.getTargetX();
                  int var9 = (int)var4.getTargetY();
                  if (GameServer.bServer) {
                     ServerMap.instance.getChunk(var8 / 10, var9 / 10);
                  } else {
                     IsoWorld.instance.CurrentCell.getChunkForGridSquare(var8, var9, 0);
                  }
            ...
            if (!this.m_isPlayerMoving || this.isAiming()) {
               ...
               tempo.normalize();
               var10 = this.legsSprite.modelSlot.model.AnimPlayer.getRenderedAngle();
               if ((double)var10 > 6.283185307179586) {
                  var10 = (float)((double)var10 - 6.283185307179586);
               }
   ...
   private void updateWorldAmbiance() {
      if (!GameServer.bServer && this.isLocalPlayer() && this.getPlayerNum() == 0 && (this.worldAmbianceInstance == 0L || !this.getEmitter().isPlaying(this.worldAmbianceInstance))) {
   ...
   public void setAccessLevel(String var1) {
      ...
      if (var2 == 1) {
         ...
         GameClient.SendCommandToServer("/setaccesslevel \"" + var3 + "\" \"" + PlayerType.toString(var2) + "\"");
      }
   ...
   private void updateFootInjuries() {
      ...
      if ((var1 == null || var1.getCondition() <= 0) && this.getCurrentSquare() != null) {
   ...
   public void becomeCorpse() {
      if (!this.isOnDeathDone() && (this.shouldBecomeCorpse() || this.isLocalPlayer())) {
         super.becomeCorpse();
