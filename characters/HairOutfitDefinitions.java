...
public final class HairOutfitDefinitions {
      ...
      if (var1 != null) {
         ...
         if (var2 != null) {
            ...
            while(var3.advance()) {
               ...
               if (var4 != null) {
                  HaircutDefinition var5 = new HaircutDefinition(var4.rawgetStr("name"), var4.rawgetInt("minWorldAge"), new ArrayList(Arrays.asList(var4.rawgetStr("onlyFor").split(","))));
   ...
   public boolean isHaircutValid(String var1, String var2) {
      ...
      if (StringUtils.isNullOrEmpty(var1)) {
         ...
         for(int var3 = 0; var3 < instance.m_haircutDefinition.size(); ++var3) {
            HaircutDefinition var4 = (HaircutDefinition)instance.m_haircutDefinition.get(var3);
   ...
   public ImmutableColor getRandomHaircutColor(String var1) {
      ...
      for(int var5 = 0; var5 < instance.m_outfitDefinition.size() && !var4; ++var5) {
         HaircutOutfitDefinition var6 = (HaircutOutfitDefinition)instance.m_outfitDefinition.get(var5);
