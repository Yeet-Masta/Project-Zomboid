...
public final class GameProfiler {
   ...
   public ProfileArea start(ProfileArea var1, long var2) {
      ...
      if (!this.m_stack.isEmpty()) {
         ProfileArea var4 = (ProfileArea)this.m_stack.peek();
   ...
   private void renderPercent(String var1, long var2, int var4, int var5, float var6, float var7, float var8) {
      ...
      TextManager.instance.DrawString((double)var4, (double)var5, var1, (double)var6, (double)var7, (double)var8, 1.0);
      TextManager.instance.DrawString((double)(var4 + 300), (double)var5, String.valueOf(var9) + "%", (double)var6, (double)var7, (double)var8, 1.0);
   }
   ...
   public static class RecordingFrame {
      ...
      public void transferFrom(RecordingFrame var1) {
         this.clear();
   ...
   public static class ProfileArea extends PooledObject {
      ...
      private static final Pool s_pool = new Pool(ProfileArea::new);
