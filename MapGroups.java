...
public final class MapGroups {
   ...
   private void getDirsRecursively(MapDirectory var1, ArrayList var2) {
      if (!var2.contains(var1)) {
         ...
         while(true) {
            while(var3.hasNext()) {
               ...
               while(var5.hasNext()) {
                  MapDirectory var6 = (MapDirectory)var5.next();
   ...
   public ArrayList getMapDirectoriesInGroup(int var1) {
      if (var1 >= 0 && var1 < this.groups.size()) {
         ...
         Iterator var3 = ((MapGroup)this.groups.get(var1)).directories.iterator();

         while(var3.hasNext()) {
            MapDirectory var4 = (MapDirectory)var3.next();
            var2.add(var4.name);
         }
   ...
   private void handleMapDirectory(String var1, String var2) {
      ...
      if (var3 != null) {
         MapDirectory var4 = new MapDirectory(var1, var2, var3);
   ...
   private MapGroup findGroupWithAnyOfTheseDirectories(ArrayList var1) {
   ...
   public ArrayList getAllMapsInOrder() {
      ...
      while(var2.hasNext()) {
         MapGroup var3 = (MapGroup)var2.next();
         Iterator var4 = var3.directories.iterator();

         while(var4.hasNext()) {
            MapDirectory var5 = (MapDirectory)var4.next();
            var1.add(var5.name);
         }
      }
   ...
   private class MapGroup {
      ...
      void addDirectory(String var1, String var2) {
         ...
         MapDirectory var3 = MapGroups.this.new MapDirectory(var1, var2);
      ...
      void addDirectory(String var1, String var2, ArrayList var3) {
         ...
         MapDirectory var4 = MapGroups.this.new MapDirectory(var1, var2, var3);
      ...
      void getDirsRecursively(MapDirectory var1, ArrayList var2) {
      ...
      void setPriority() {
         ...
         while(var2.hasNext()) {
            MapDirectory var3 = (MapDirectory)var2.next();
      ...
      void setPriority(List var1) {
         ...
         for(int var5 = 0; var5 < this.directories.size(); ++var5) {
            MapDirectory var6 = (MapDirectory)this.directories.get(var5);
