...
public class StrokeGeometry {
   ...
   static ArrayList getStrokeGeometry(Point[] var0, Attrs var1) {
      if (var0.length < 2) {
         return null;
      } else {
   ...
   static void createSquareCap(Point var0, Point var1, Point var2, ArrayList var3) {
      var3.add(var0);
   ...
   static void createRoundCap(Point var0, Point var1, Point var2, Point var3, ArrayList var4) {
   ...
   static void createTriangles(Point var0, Point var1, Point var2, ArrayList var3, float var4, String var5, float var6) {
