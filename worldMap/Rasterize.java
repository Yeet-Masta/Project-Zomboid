...
public final class Rasterize {
   ...
   void scanSpan(Edge var1, Edge var2, int var3, int var4, BiConsumer var5) {
      ...
      for(int var16 = var6; var16 < var7; ++var16) {
         double var17 = var21 * Math.max(0.0, Math.min((double)var1.dy, (double)var16 + var12 - (double)var1.y0)) + (double)var1.x0;
         double var19 = var10 * Math.max(0.0, Math.min((double)var2.dy, (double)var16 + var14 - (double)var2.y0)) + (double)var2.x0;
   ...
   private static final class Edge {
      ...
      Edge init(float var1, float var2, float var3, float var4) {
         if (var2 > var4) {
            this.x0 = var3;
            this.y0 = var4;
            this.x1 = var1;
