...
public final class VBOLinesUV {
   ...
   private final ObjectPool m_runPool = new ObjectPool(Run::new);
   private final ArrayList m_runs = new ArrayList();

   private Run currentRun() {
      return this.m_runs.isEmpty() ? null : (Run)this.m_runs.get(this.m_runs.size() - 1);
   }
   ...
   public void flush() {
      if (this.m_elements != null && this.m_elements.position() != 0) {
         ...
         for(int var1 = 0; var1 < this.m_runs.size(); ++var1) {
            Run var2 = (Run)this.m_runs.get(var1);
            int var3 = var2.start;
            int var4 = var2.count;
            int var5 = var2.start;
