...
public abstract class WorldMapStyleLayer {
   ...
   protected RGBAf evalColor(RenderArgs var1, ArrayList var2) {
      if (var2.isEmpty()) {
   ...
   protected float evalFloat(RenderArgs var1, ArrayList var2) {
      if (var2.isEmpty()) {
         return 1.0F;
      } else {
         float var3 = var1.drawer.m_zoomF;
   ...
   protected Texture evalTexture(RenderArgs var1, ArrayList var2) {
      if (var2.isEmpty()) {
         return null;
      } else {
         float var3 = var1.drawer.m_zoomF;
   ...
   public static final class RGBAf {
      ...
      public float b;
      public float a;
      public static final ObjectPool s_pool = new ObjectPool(RGBAf::new);
