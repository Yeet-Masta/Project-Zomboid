...
public final class JoypadManager {
   ...
   public boolean isLBPressed(int var1) {
      if (var1 < 0) {
         for(int var2 = 0; var2 < this.JoypadList.size(); ++var2) {
            if (((Joypad)this.JoypadList.get(var2)).isLBPressed()) {
               return true;
            }
         }
   ...
   public boolean isRBPressed(int var1) {
      if (var1 < 0) {
         for(int var2 = 0; var2 < this.JoypadList.size(); ++var2) {
            if (((Joypad)this.JoypadList.get(var2)).isRBPressed()) {
               return true;
            }
         }
   ...
   public boolean isL3Pressed(int var1) {
      if (var1 < 0) {
         for(int var2 = 0; var2 < this.JoypadList.size(); ++var2) {
            if (((Joypad)this.JoypadList.get(var2)).isL3Pressed()) {
               return true;
            }
         }
   ...
   public boolean isR3Pressed(int var1) {
      if (var1 < 0) {
         for(int var2 = 0; var2 < this.JoypadList.size(); ++var2) {
            if (((Joypad)this.JoypadList.get(var2)).isR3Pressed()) {
               return true;
            }
         }
   ...
   public boolean isRTPressed(int var1) {
      if (var1 < 0) {
         for(int var2 = 0; var2 < this.JoypadList.size(); ++var2) {
            if (((Joypad)this.JoypadList.get(var2)).isRTPressed()) {
               return true;
            }
         }
   ...
   public boolean isLTPressed(int var1) {
      if (var1 < 0) {
         for(int var2 = 0; var2 < this.JoypadList.size(); ++var2) {
            if (((Joypad)this.JoypadList.get(var2)).isLTPressed()) {
               return true;
            }
         }
   ...
   public boolean isAPressed(int var1) {
      if (var1 < 0) {
         for(int var2 = 0; var2 < this.JoypadList.size(); ++var2) {
            if (((Joypad)this.JoypadList.get(var2)).isAPressed()) {
               return true;
            }
         }
   ...
   public boolean isBPressed(int var1) {
      if (var1 < 0) {
         for(int var2 = 0; var2 < this.JoypadList.size(); ++var2) {
            if (((Joypad)this.JoypadList.get(var2)).isBPressed()) {
               return true;
            }
         }
   ...
   public boolean isXPressed(int var1) {
      if (var1 < 0) {
         for(int var2 = 0; var2 < this.JoypadList.size(); ++var2) {
            if (((Joypad)this.JoypadList.get(var2)).isXPressed()) {
               return true;
            }
         }
   ...
   public boolean isYPressed(int var1) {
      if (var1 < 0) {
         for(int var2 = 0; var2 < this.JoypadList.size(); ++var2) {
            if (((Joypad)this.JoypadList.get(var2)).isYPressed()) {
               return true;
            }
         }
   ...
   public void revertToKeyboardAndMouse() {
      for(int var1 = 0; var1 < this.JoypadList.size(); ++var1) {
         Joypad var2 = (Joypad)this.JoypadList.get(var1);
         if (var2.player == 0) {
